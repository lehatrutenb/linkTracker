package backend.academy.linktracker.bot.adapters.exceptions;

import backend.academy.linktracker.bot.usecases.dtos.models.ApiErrorResponse;
import backend.academy.linktracker.bot.usecases.exceptions.ConflictException;
import backend.academy.linktracker.bot.usecases.exceptions.DomainException;
import backend.academy.linktracker.bot.usecases.exceptions.NotFoundException;
import backend.academy.linktracker.bot.usecases.exceptions.ValidationException;
