 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_11")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf11 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf11() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf11(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf11 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf11 parameters(RepositoryRuleCommitMessagePatternParameters parameters) {
    ...
    public RepositoryRuleDetailedOneOf11 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf11 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf11 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf11 repositoryRuleDetailedOneOf11 = (RepositoryRuleDetailedOneOf11) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf11.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf11.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf11.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf11.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf11.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf11 {\n");
