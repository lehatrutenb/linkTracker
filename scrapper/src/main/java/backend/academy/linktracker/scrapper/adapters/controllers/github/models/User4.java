...
public class User4 implements PullRequestRequestedReviewersInner {
     ...
     */
    public User4(Long id, String login) {
        this.id = id;
        this.login = login;
    }

    public User4 avatarUrl(URI avatarUrl) {
    ...
    public User4 deleted(Boolean deleted) {
    ...
    public User4 email(String email) {
    ...
    public User4 eventsUrl(String eventsUrl) {
    ...
    public User4 followersUrl(URI followersUrl) {
    ...
    public User4 followingUrl(String followingUrl) {
    ...
    public User4 gistsUrl(String gistsUrl) {
    ...
    public User4 gravatarId(String gravatarId) {
    ...
    public User4 htmlUrl(URI htmlUrl) {
    ...
    public User4 login(String login) {
        this.login = login;
        return this;
    }
    ...
    public User4 nodeId(String nodeId) {
    ...
    public User4 organizationsUrl(URI organizationsUrl) {
    ...
    public User4 receivedEventsUrl(URI receivedEventsUrl) {
    ...
    public User4 reposUrl(URI reposUrl) {
    ...
    public User4 siteAdmin(Boolean siteAdmin) {
    ...
    public User4 starredUrl(String starredUrl) {
    ...
    public User4 subscriptionsUrl(URI subscriptionsUrl) {
    ...
    public User4 type(TypeEnum type) {
    ...
    public User4 userViewType(String userViewType) {
    ...
    public boolean equals(Object o) {
        ...
        User4 user4 = (User4) o;
        return Objects.equals(this.avatarUrl, user4.avatarUrl)
                && Objects.equals(this.deleted, user4.deleted)
                && equalsNullable(this.email, user4.email)
                && Objects.equals(this.eventsUrl, user4.eventsUrl)
                && Objects.equals(this.followersUrl, user4.followersUrl)
                && Objects.equals(this.followingUrl, user4.followingUrl)
                && Objects.equals(this.gistsUrl, user4.gistsUrl)
                && Objects.equals(this.gravatarId, user4.gravatarId)
                && Objects.equals(this.htmlUrl, user4.htmlUrl)
                && Objects.equals(this.id, user4.id)
                && Objects.equals(this.login, user4.login)
                && Objects.equals(this.name, user4.name)
                && Objects.equals(this.nodeId, user4.nodeId)
                && Objects.equals(this.organizationsUrl, user4.organizationsUrl)
                && Objects.equals(this.receivedEventsUrl, user4.receivedEventsUrl)
                && Objects.equals(this.reposUrl, user4.reposUrl)
                && Objects.equals(this.siteAdmin, user4.siteAdmin)
                && Objects.equals(this.starredUrl, user4.starredUrl)
                && Objects.equals(this.subscriptionsUrl, user4.subscriptionsUrl)
                && Objects.equals(this.type, user4.type)
                && Objects.equals(this.url, user4.url)
                && Objects.equals(this.userViewType, user4.userViewType);
    }
