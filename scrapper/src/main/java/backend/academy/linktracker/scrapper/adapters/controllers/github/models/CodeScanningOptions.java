 ...
 */
@Schema(name = "code-scanning-options", description = "Security Configuration feature options for code scanning")
@JsonTypeName("code-scanning-options")
@Generated(
...
public class CodeScanningOptions {
    ...
    public CodeScanningOptions allowAdvanced(Boolean allowAdvanced) {
    ...
    public boolean equals(Object o) {
        ...
        CodeScanningOptions codeScanningOptions = (CodeScanningOptions) o;
        return equalsNullable(this.allowAdvanced, codeScanningOptions.allowAdvanced);
    }
    ...
    public String toString() {
        ...
        sb.append("class CodeScanningOptions {\n");
