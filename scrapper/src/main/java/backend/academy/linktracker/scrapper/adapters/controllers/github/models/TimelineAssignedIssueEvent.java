 ...
 */
@Schema(name = "timeline-assigned-issue-event", description = "Timeline Assigned Issue Event")
...
public class TimelineAssignedIssueEvent {
    ...
    public TimelineAssignedIssueEvent id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, timelineAssignedIssueEvent.id)
                && Objects.equals(this.nodeId, timelineAssignedIssueEvent.nodeId)
                && Objects.equals(this.url, timelineAssignedIssueEvent.url)
                && Objects.equals(this.actor, timelineAssignedIssueEvent.actor)
