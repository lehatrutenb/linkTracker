 ...
 */
@Schema(
        name = "personal_access_token_request_permissions_added",
        description = "New requested permissions, categorized by type of permission.")
@JsonTypeName("personal_access_token_request_permissions_added")
@Generated(
...
public class PersonalAccessTokenRequestPermissionsAdded {
    ...
    public boolean equals(Object o) {
        ...
        PersonalAccessTokenRequestPermissionsAdded personalAccessTokenRequestPermissionsAdded =
                (PersonalAccessTokenRequestPermissionsAdded) o;
