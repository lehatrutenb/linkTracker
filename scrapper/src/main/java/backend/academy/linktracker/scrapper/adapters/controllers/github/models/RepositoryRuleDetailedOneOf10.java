 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_10")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf10 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf10() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf10(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf10 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf10 parameters(RepositoryRuleCommitMessagePatternParameters parameters) {
    ...
    public RepositoryRuleDetailedOneOf10 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf10 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf10 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf10 repositoryRuleDetailedOneOf10 = (RepositoryRuleDetailedOneOf10) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf10.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf10.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf10.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf10.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf10.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf10 {\n");
