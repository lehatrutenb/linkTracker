 ...
 */
@Schema(name = "Issue_9", description = "The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.")
@JsonTypeName("Issue_9")
@Generated(
...
public class Issue9 {
    ...
    public Issue9 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public Issue9 assignee(User assignee) {
    ...
    public Issue9 assignees(List<@Valid User> assignees) {
        this.assignees = assignees;
        return this;
    }

    public Issue9 addAssigneesItem(User assigneesItem) {
    ...
    public Issue9 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public Issue9 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public Issue9 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public Issue9 comments(Long comments) {
        this.comments = comments;
        return this;
    }
    ...
    public Issue9 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public Issue9 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Issue9 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public Issue9 eventsUrl(URI eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Issue9 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Issue9 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public Issue9 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public Issue9 labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public Issue9 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public Issue9 milestone(Milestone1 milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public Issue9 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Issue9 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public Issue9 performedViaGithubApp(App1 performedViaGithubApp) {
    ...
    public Issue9 pullRequest(WebhooksIssuePullRequest pullRequest) {
    ...
    public Issue9 reactions(Reactions reactions) {
        this.reactions = reactions;
        return this;
    }
    ...
    public Issue9 repositoryUrl(URI repositoryUrl) {
        this.repositoryUrl = repositoryUrl;
        return this;
    }
    ...
    public Issue9 pinnedComment(NullableIssueComment pinnedComment) {
    ...
    public Issue9 subIssuesSummary(SubIssuesSummary subIssuesSummary) {
    ...
    public Issue9 issueDependenciesSummary(IssueDependenciesSummary issueDependenciesSummary) {
    ...
    public Issue9 issueFieldValues(List<@Valid IssueFieldValue> issueFieldValues) {
        this.issueFieldValues = issueFieldValues;
        return this;
    }

    public Issue9 addIssueFieldValuesItem(IssueFieldValue issueFieldValuesItem) {
    ...
    public Issue9 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public Issue9 stateReason(String stateReason) {
    ...
    public Issue9 timelineUrl(URI timelineUrl) {
    ...
    public Issue9 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public Issue9 type(IssueType type) {
        this.type = type;
        return this;
    }
    ...
    public Issue9 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Issue9 issue9 = (Issue9) o;
        return Objects.equals(this.activeLockReason, issue9.activeLockReason)
                && Objects.equals(this.assignee, issue9.assignee)
                && Objects.equals(this.assignees, issue9.assignees)
                && Objects.equals(this.authorAssociation, issue9.authorAssociation)
                && Objects.equals(this.body, issue9.body)
                && Objects.equals(this.closedAt, issue9.closedAt)
                && Objects.equals(this.comments, issue9.comments)
                && Objects.equals(this.commentsUrl, issue9.commentsUrl)
                && Objects.equals(this.createdAt, issue9.createdAt)
                && Objects.equals(this.draft, issue9.draft)
                && Objects.equals(this.eventsUrl, issue9.eventsUrl)
                && Objects.equals(this.htmlUrl, issue9.htmlUrl)
                && Objects.equals(this.id, issue9.id)
                && Objects.equals(this.labels, issue9.labels)
                && Objects.equals(this.labelsUrl, issue9.labelsUrl)
                && Objects.equals(this.locked, issue9.locked)
                && Objects.equals(this.milestone, issue9.milestone)
                && Objects.equals(this.nodeId, issue9.nodeId)
                && Objects.equals(this.number, issue9.number)
                && Objects.equals(this.performedViaGithubApp, issue9.performedViaGithubApp)
                && Objects.equals(this.pullRequest, issue9.pullRequest)
                && Objects.equals(this.reactions, issue9.reactions)
                && Objects.equals(this.repositoryUrl, issue9.repositoryUrl)
                && Objects.equals(this.pinnedComment, issue9.pinnedComment)
                && Objects.equals(this.subIssuesSummary, issue9.subIssuesSummary)
                && Objects.equals(this.issueDependenciesSummary, issue9.issueDependenciesSummary)
                && Objects.equals(this.issueFieldValues, issue9.issueFieldValues)
                && Objects.equals(this.state, issue9.state)
                && Objects.equals(this.stateReason, issue9.stateReason)
                && Objects.equals(this.timelineUrl, issue9.timelineUrl)
                && Objects.equals(this.title, issue9.title)
                && Objects.equals(this.type, issue9.type)
                && Objects.equals(this.updatedAt, issue9.updatedAt)
                && Objects.equals(this.url, issue9.url)
                && Objects.equals(this.user, issue9.user);
    }
