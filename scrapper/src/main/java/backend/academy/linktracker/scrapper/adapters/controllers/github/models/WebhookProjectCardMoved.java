...
public class WebhookProjectCardMoved {
    ...
    private Optional<WebhookProjectCardMovedChanges> changes = Optional.empty();
    ...
    public Optional<WebhookProjectCardMovedChanges> getChanges() {
        return changes;
    }

    public void setChanges(Optional<WebhookProjectCardMovedChanges> changes) {
