...
public class WebhookProjectsV2StatusUpdateEdited {
    ...
    private WebhookProjectsV2StatusUpdateEditedChanges changes;
    ...
    public WebhookProjectsV2StatusUpdateEditedChanges getChanges() {
        return changes;
    }

    public void setChanges(WebhookProjectsV2StatusUpdateEditedChanges changes) {
        this.changes = changes;
    }
