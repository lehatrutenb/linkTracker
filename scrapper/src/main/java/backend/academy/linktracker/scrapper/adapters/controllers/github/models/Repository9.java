 ...
 * A git repository
 */
@Schema(name = "Repository_9", description = "A git repository")
@JsonTypeName("Repository_9")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class Repository9 {
    ...
    public Repository9 allowAutoMerge(Boolean allowAutoMerge) {
    ...
    public Repository9 allowForking(Boolean allowForking) {
    ...
    public Repository9 allowMergeCommit(Boolean allowMergeCommit) {
    ...
    public Repository9 allowRebaseMerge(Boolean allowRebaseMerge) {
    ...
    public Repository9 allowSquashMerge(Boolean allowSquashMerge) {
    ...
    public Repository9 allowUpdateBranch(Boolean allowUpdateBranch) {
    ...
    public Repository9 archiveUrl(String archiveUrl) {
        this.archiveUrl = archiveUrl;
        return this;
    }
    ...
    public Repository9 archived(Boolean archived) {
        this.archived = archived;
        return this;
    }
    ...
    public Repository9 assigneesUrl(String assigneesUrl) {
        this.assigneesUrl = assigneesUrl;
        return this;
    }
    ...
    public Repository9 blobsUrl(String blobsUrl) {
        this.blobsUrl = blobsUrl;
        return this;
    }
    ...
    public Repository9 branchesUrl(String branchesUrl) {
        this.branchesUrl = branchesUrl;
        return this;
    }
    ...
    public Repository9 cloneUrl(URI cloneUrl) {
        this.cloneUrl = cloneUrl;
        return this;
    }
    ...
    public Repository9 collaboratorsUrl(String collaboratorsUrl) {
        this.collaboratorsUrl = collaboratorsUrl;
        return this;
    }
    ...
    public Repository9 commentsUrl(String commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public Repository9 commitsUrl(String commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public Repository9 compareUrl(String compareUrl) {
        this.compareUrl = compareUrl;
        return this;
    }
    ...
    public Repository9 contentsUrl(String contentsUrl) {
        this.contentsUrl = contentsUrl;
        return this;
    }
    ...
    public Repository9 contributorsUrl(URI contributorsUrl) {
        this.contributorsUrl = contributorsUrl;
        return this;
    }
    ...
    public Repository9 createdAt(RepositoryCreatedAt createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Repository9 defaultBranch(String defaultBranch) {
        this.defaultBranch = defaultBranch;
        return this;
    }
    ...
    public Repository9 deleteBranchOnMerge(Boolean deleteBranchOnMerge) {
    ...
    public Repository9 deploymentsUrl(URI deploymentsUrl) {
        this.deploymentsUrl = deploymentsUrl;
        return this;
    }
    ...
    public Repository9 description(String description) {
        this.description = JsonNullable.of(description);
        return this;
    }
    ...
    public Repository9 disabled(Boolean disabled) {
    ...
    public Repository9 downloadsUrl(URI downloadsUrl) {
        this.downloadsUrl = downloadsUrl;
        return this;
    }
    ...
    public Repository9 eventsUrl(URI eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Repository9 fork(Boolean fork) {
        this.fork = fork;
        return this;
    }
    ...
    public Repository9 forks(Long forks) {
        this.forks = forks;
        return this;
    }
    ...
    public Repository9 forksCount(Long forksCount) {
        this.forksCount = forksCount;
        return this;
    }
    ...
    public Repository9 forksUrl(URI forksUrl) {
        this.forksUrl = forksUrl;
        return this;
    }
    ...
    public Repository9 fullName(String fullName) {
        this.fullName = fullName;
        return this;
    }
    ...
    public Repository9 gitCommitsUrl(String gitCommitsUrl) {
        this.gitCommitsUrl = gitCommitsUrl;
        return this;
    }
    ...
    public Repository9 gitRefsUrl(String gitRefsUrl) {
        this.gitRefsUrl = gitRefsUrl;
        return this;
    }
    ...
    public Repository9 gitTagsUrl(String gitTagsUrl) {
        this.gitTagsUrl = gitTagsUrl;
        return this;
    }
    ...
    public Repository9 gitUrl(URI gitUrl) {
        this.gitUrl = gitUrl;
        return this;
    }
    ...
    public Repository9 hasDownloads(Boolean hasDownloads) {
        this.hasDownloads = hasDownloads;
        return this;
    }
    ...
    public Repository9 hasIssues(Boolean hasIssues) {
        this.hasIssues = hasIssues;
        return this;
    }
    ...
    public Repository9 hasPages(Boolean hasPages) {
        this.hasPages = hasPages;
        return this;
    }
    ...
    public Repository9 hasProjects(Boolean hasProjects) {
        this.hasProjects = hasProjects;
        return this;
    }
    ...
    public Repository9 hasWiki(Boolean hasWiki) {
        this.hasWiki = hasWiki;
        return this;
    }
    ...
    public Repository9 homepage(String homepage) {
        this.homepage = JsonNullable.of(homepage);
        return this;
    }
    ...
    public Repository9 hooksUrl(URI hooksUrl) {
        this.hooksUrl = hooksUrl;
        return this;
    }
    ...
    public Repository9 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Repository9 isTemplate(Boolean isTemplate) {
    ...
    public Repository9 issueCommentUrl(String issueCommentUrl) {
        this.issueCommentUrl = issueCommentUrl;
        return this;
    }
    ...
    public Repository9 issueEventsUrl(String issueEventsUrl) {
        this.issueEventsUrl = issueEventsUrl;
        return this;
    }
    ...
    public Repository9 issuesUrl(String issuesUrl) {
        this.issuesUrl = issuesUrl;
        return this;
    }
    ...
    public Repository9 keysUrl(String keysUrl) {
        this.keysUrl = keysUrl;
        return this;
    }
    ...
    public Repository9 labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public Repository9 language(String language) {
        this.language = JsonNullable.of(language);
        return this;
    }
    ...
    public Repository9 languagesUrl(URI languagesUrl) {
        this.languagesUrl = languagesUrl;
        return this;
    }
    ...
    public Repository9 license(License license) {
        this.license = JsonNullable.of(license);
        return this;
    }
    ...
    public Repository9 masterBranch(String masterBranch) {
    ...
    public Repository9 mergesUrl(URI mergesUrl) {
        this.mergesUrl = mergesUrl;
        return this;
    }
    ...
    public Repository9 milestonesUrl(String milestonesUrl) {
        this.milestonesUrl = milestonesUrl;
        return this;
    }
    ...
    public Repository9 mirrorUrl(URI mirrorUrl) {
        this.mirrorUrl = JsonNullable.of(mirrorUrl);
        return this;
    }
    ...
    public Repository9 name(String name) {
        this.name = name;
        return this;
    }
    ...
    public Repository9 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Repository9 notificationsUrl(String notificationsUrl) {
        this.notificationsUrl = notificationsUrl;
        return this;
    }
    ...
    public Repository9 openIssues(Long openIssues) {
        this.openIssues = openIssues;
        return this;
    }
    ...
    public Repository9 openIssuesCount(Long openIssuesCount) {
        this.openIssuesCount = openIssuesCount;
        return this;
    }
    ...
    public Repository9 organization(String organization) {
    ...
    public Repository9 owner(User owner) {
        this.owner = JsonNullable.of(owner);
        return this;
    }
    ...
    public Repository9 permissions(RepositoryPermissions permissions) {
    ...
    public Repository9 _private(Boolean _private) {
        this._private = _private;
        return this;
    }
    ...
    public Repository9 _public(Boolean _public) {
    ...
    public Repository9 pullsUrl(String pullsUrl) {
        this.pullsUrl = pullsUrl;
        return this;
    }
    ...
    public Repository9 pushedAt(RepositoryPushedAt pushedAt) {
        this.pushedAt = JsonNullable.of(pushedAt);
        return this;
    }
    ...
    public Repository9 releasesUrl(String releasesUrl) {
        this.releasesUrl = releasesUrl;
        return this;
    }
    ...
    public Repository9 roleName(String roleName) {
    ...
    public Repository9 size(Long size) {
        this.size = size;
        return this;
    }
    ...
    public Repository9 sshUrl(String sshUrl) {
        this.sshUrl = sshUrl;
        return this;
    }
    ...
    public Repository9 stargazers(Long stargazers) {
    ...
    public Repository9 stargazersCount(Long stargazersCount) {
        this.stargazersCount = stargazersCount;
        return this;
    }
    ...
    public Repository9 stargazersUrl(URI stargazersUrl) {
        this.stargazersUrl = stargazersUrl;
        return this;
    }
    ...
    public Repository9 statusesUrl(String statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public Repository9 subscribersUrl(URI subscribersUrl) {
        this.subscribersUrl = subscribersUrl;
        return this;
    }
    ...
    public Repository9 subscriptionUrl(URI subscriptionUrl) {
        this.subscriptionUrl = subscriptionUrl;
        return this;
    }
    ...
    public Repository9 svnUrl(URI svnUrl) {
        this.svnUrl = svnUrl;
        return this;
    }
    ...
    public Repository9 tagsUrl(URI tagsUrl) {
        this.tagsUrl = tagsUrl;
        return this;
    }
    ...
    public Repository9 teamsUrl(URI teamsUrl) {
        this.teamsUrl = teamsUrl;
        return this;
    }
    ...
    public Repository9 topics(List<String> topics) {
        this.topics = topics;
        return this;
    }

    public Repository9 addTopicsItem(String topicsItem) {
        if (this.topics == null) {
    ...
    public Repository9 treesUrl(String treesUrl) {
        this.treesUrl = treesUrl;
        return this;
    }
    ...
    public Repository9 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Repository9 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public Repository9 visibility(VisibilityEnum visibility) {
        this.visibility = visibility;
        return this;
    }
    ...
    public Repository9 watchers(Long watchers) {
        this.watchers = watchers;
        return this;
    }
    ...
    public Repository9 watchersCount(Long watchersCount) {
        this.watchersCount = watchersCount;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Repository9 repository9 = (Repository9) o;
        return Objects.equals(this.allowAutoMerge, repository9.allowAutoMerge)
                && Objects.equals(this.allowForking, repository9.allowForking)
                && Objects.equals(this.allowMergeCommit, repository9.allowMergeCommit)
                && Objects.equals(this.allowRebaseMerge, repository9.allowRebaseMerge)
                && Objects.equals(this.allowSquashMerge, repository9.allowSquashMerge)
                && Objects.equals(this.allowUpdateBranch, repository9.allowUpdateBranch)
                && Objects.equals(this.archiveUrl, repository9.archiveUrl)
                && Objects.equals(this.archived, repository9.archived)
                && Objects.equals(this.assigneesUrl, repository9.assigneesUrl)
                && Objects.equals(this.blobsUrl, repository9.blobsUrl)
                && Objects.equals(this.branchesUrl, repository9.branchesUrl)
                && Objects.equals(this.cloneUrl, repository9.cloneUrl)
                && Objects.equals(this.collaboratorsUrl, repository9.collaboratorsUrl)
                && Objects.equals(this.commentsUrl, repository9.commentsUrl)
                && Objects.equals(this.commitsUrl, repository9.commitsUrl)
                && Objects.equals(this.compareUrl, repository9.compareUrl)
                && Objects.equals(this.contentsUrl, repository9.contentsUrl)
                && Objects.equals(this.contributorsUrl, repository9.contributorsUrl)
                && Objects.equals(this.createdAt, repository9.createdAt)
                && Objects.equals(this.defaultBranch, repository9.defaultBranch)
                && Objects.equals(this.deleteBranchOnMerge, repository9.deleteBranchOnMerge)
                && Objects.equals(this.deploymentsUrl, repository9.deploymentsUrl)
                && Objects.equals(this.description, repository9.description)
                && Objects.equals(this.disabled, repository9.disabled)
                && Objects.equals(this.downloadsUrl, repository9.downloadsUrl)
                && Objects.equals(this.eventsUrl, repository9.eventsUrl)
                && Objects.equals(this.fork, repository9.fork)
                && Objects.equals(this.forks, repository9.forks)
                && Objects.equals(this.forksCount, repository9.forksCount)
                && Objects.equals(this.forksUrl, repository9.forksUrl)
                && Objects.equals(this.fullName, repository9.fullName)
                && Objects.equals(this.gitCommitsUrl, repository9.gitCommitsUrl)
                && Objects.equals(this.gitRefsUrl, repository9.gitRefsUrl)
                && Objects.equals(this.gitTagsUrl, repository9.gitTagsUrl)
                && Objects.equals(this.gitUrl, repository9.gitUrl)
                && Objects.equals(this.hasDownloads, repository9.hasDownloads)
                && Objects.equals(this.hasIssues, repository9.hasIssues)
                && Objects.equals(this.hasPages, repository9.hasPages)
                && Objects.equals(this.hasProjects, repository9.hasProjects)
                && Objects.equals(this.hasWiki, repository9.hasWiki)
                && Objects.equals(this.homepage, repository9.homepage)
                && Objects.equals(this.hooksUrl, repository9.hooksUrl)
                && Objects.equals(this.htmlUrl, repository9.htmlUrl)
                && Objects.equals(this.id, repository9.id)
                && Objects.equals(this.isTemplate, repository9.isTemplate)
                && Objects.equals(this.issueCommentUrl, repository9.issueCommentUrl)
                && Objects.equals(this.issueEventsUrl, repository9.issueEventsUrl)
                && Objects.equals(this.issuesUrl, repository9.issuesUrl)
                && Objects.equals(this.keysUrl, repository9.keysUrl)
                && Objects.equals(this.labelsUrl, repository9.labelsUrl)
                && Objects.equals(this.language, repository9.language)
                && Objects.equals(this.languagesUrl, repository9.languagesUrl)
                && Objects.equals(this.license, repository9.license)
                && Objects.equals(this.masterBranch, repository9.masterBranch)
                && Objects.equals(this.mergesUrl, repository9.mergesUrl)
                && Objects.equals(this.milestonesUrl, repository9.milestonesUrl)
                && Objects.equals(this.mirrorUrl, repository9.mirrorUrl)
                && Objects.equals(this.name, repository9.name)
                && Objects.equals(this.nodeId, repository9.nodeId)
                && Objects.equals(this.notificationsUrl, repository9.notificationsUrl)
                && Objects.equals(this.openIssues, repository9.openIssues)
                && Objects.equals(this.openIssuesCount, repository9.openIssuesCount)
                && Objects.equals(this.organization, repository9.organization)
                && Objects.equals(this.owner, repository9.owner)
                && Objects.equals(this.permissions, repository9.permissions)
                && Objects.equals(this._private, repository9._private)
                && Objects.equals(this._public, repository9._public)
                && Objects.equals(this.pullsUrl, repository9.pullsUrl)
                && Objects.equals(this.pushedAt, repository9.pushedAt)
                && Objects.equals(this.releasesUrl, repository9.releasesUrl)
                && equalsNullable(this.roleName, repository9.roleName)
                && Objects.equals(this.size, repository9.size)
                && Objects.equals(this.sshUrl, repository9.sshUrl)
                && Objects.equals(this.stargazers, repository9.stargazers)
                && Objects.equals(this.stargazersCount, repository9.stargazersCount)
                && Objects.equals(this.stargazersUrl, repository9.stargazersUrl)
                && Objects.equals(this.statusesUrl, repository9.statusesUrl)
                && Objects.equals(this.subscribersUrl, repository9.subscribersUrl)
                && Objects.equals(this.subscriptionUrl, repository9.subscriptionUrl)
                && Objects.equals(this.svnUrl, repository9.svnUrl)
                && Objects.equals(this.tagsUrl, repository9.tagsUrl)
                && Objects.equals(this.teamsUrl, repository9.teamsUrl)
                && Objects.equals(this.topics, repository9.topics)
                && Objects.equals(this.treesUrl, repository9.treesUrl)
                && Objects.equals(this.updatedAt, repository9.updatedAt)
                && Objects.equals(this.url, repository9.url)
                && Objects.equals(this.visibility, repository9.visibility)
                && Objects.equals(this.watchers, repository9.watchers)
                && Objects.equals(this.watchersCount, repository9.watchersCount);
    }
