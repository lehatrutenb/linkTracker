 ...
 */
@JsonTypeName("copilot_add_copilot_seats_for_teams_request")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class CopilotAddCopilotSeatsForTeamsRequest {
     ...
     */
    public CopilotAddCopilotSeatsForTeamsRequest(List<String> selectedTeams) {
        this.selectedTeams = selectedTeams;
    }

    public CopilotAddCopilotSeatsForTeamsRequest selectedTeams(List<String> selectedTeams) {
        this.selectedTeams = selectedTeams;
        return this;
    }

    public CopilotAddCopilotSeatsForTeamsRequest addSelectedTeamsItem(String selectedTeamsItem) {
    ...
    public boolean equals(Object o) {
        ...
        CopilotAddCopilotSeatsForTeamsRequest copilotAddCopilotSeatsForTeamsRequest =
                (CopilotAddCopilotSeatsForTeamsRequest) o;
        return Objects.equals(this.selectedTeams, copilotAddCopilotSeatsForTeamsRequest.selectedTeams);
    }
    ...
    public String toString() {
        ...
        sb.append("class CopilotAddCopilotSeatsForTeamsRequest {\n");
