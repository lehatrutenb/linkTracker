 ...
 */
@JsonTypeName("webhooks_pull_request_5")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhooksPullRequest5 {
    ...
    private WebhooksPullRequest5Base base;
    ...
    private WebhooksPullRequest5Base head;
    ...
    @Valid
    private List<WebhooksPullRequest5RequestedReviewersInner> requestedReviewers = new ArrayList<>();
    ...
    public WebhooksPullRequest5(
            ...
            Long number,
            URI patchUrl,
            List<WebhooksPullRequest5RequestedReviewersInner> requestedReviewers,
    ...
    public WebhooksPullRequest5 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public WebhooksPullRequest5 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public WebhooksPullRequest5 additions(Long additions) {
    ...
    public WebhooksPullRequest5 assignee(User4 assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public WebhooksPullRequest5 assignees(List<@Valid User5> assignees) {
        this.assignees = assignees;
        return this;
    }

    public WebhooksPullRequest5 addAssigneesItem(User5 assigneesItem) {
    ...
    public WebhooksPullRequest5 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public WebhooksPullRequest5 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public WebhooksPullRequest5 base(WebhooksPullRequest5Base base) {
        this.base = base;
        return this;
    }
    ...
    @JsonProperty("base")
    public WebhooksPullRequest5Base getBase() {
        return base;
    }

    public void setBase(WebhooksPullRequest5Base base) {
        this.base = base;
    }

    public WebhooksPullRequest5 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public WebhooksPullRequest5 changedFiles(Long changedFiles) {
    ...
    public WebhooksPullRequest5 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public WebhooksPullRequest5 comments(Long comments) {
    ...
    public WebhooksPullRequest5 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 commits(Long commits) {
    ...
    public WebhooksPullRequest5 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public WebhooksPullRequest5 deletions(Long deletions) {
    ...
    public WebhooksPullRequest5 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public WebhooksPullRequest5 head(WebhooksPullRequest5Base head) {
        this.head = head;
        return this;
    }
    ...
    @JsonProperty("head")
    public WebhooksPullRequest5Base getHead() {
        return head;
    }

    public void setHead(WebhooksPullRequest5Base head) {
        this.head = head;
    }

    public WebhooksPullRequest5 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public WebhooksPullRequest5 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public WebhooksPullRequest5 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public WebhooksPullRequest5 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public WebhooksPullRequest5 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public WebhooksPullRequest5 mergeable(Boolean mergeable) {
    ...
    public WebhooksPullRequest5 mergeableState(String mergeableState) {
    ...
    public WebhooksPullRequest5 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public WebhooksPullRequest5 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public WebhooksPullRequest5 mergedBy(User4 mergedBy) {
    ...
    public WebhooksPullRequest5 milestone(Milestone milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public WebhooksPullRequest5 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public WebhooksPullRequest5 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public WebhooksPullRequest5 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 rebaseable(Boolean rebaseable) {
    ...
    public WebhooksPullRequest5 requestedReviewers(
            List<WebhooksPullRequest5RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public WebhooksPullRequest5 addRequestedReviewersItem(
            WebhooksPullRequest5RequestedReviewersInner requestedReviewersItem) {
    ...
    public List<WebhooksPullRequest5RequestedReviewersInner> getRequestedReviewers() {
        return requestedReviewers;
    }

    public void setRequestedReviewers(List<WebhooksPullRequest5RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }

    public WebhooksPullRequest5 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public WebhooksPullRequest5 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public WebhooksPullRequest5 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 reviewComments(Long reviewComments) {
    ...
    public WebhooksPullRequest5 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public WebhooksPullRequest5 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public WebhooksPullRequest5 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public WebhooksPullRequest5 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public WebhooksPullRequest5 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public WebhooksPullRequest5 user(User3 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhooksPullRequest5 webhooksPullRequest5 = (WebhooksPullRequest5) o;
        return Objects.equals(this.links, webhooksPullRequest5.links)
                && Objects.equals(this.activeLockReason, webhooksPullRequest5.activeLockReason)
                && Objects.equals(this.additions, webhooksPullRequest5.additions)
                && Objects.equals(this.assignee, webhooksPullRequest5.assignee)
                && Objects.equals(this.assignees, webhooksPullRequest5.assignees)
                && Objects.equals(this.authorAssociation, webhooksPullRequest5.authorAssociation)
                && Objects.equals(this.autoMerge, webhooksPullRequest5.autoMerge)
                && Objects.equals(this.base, webhooksPullRequest5.base)
                && Objects.equals(this.body, webhooksPullRequest5.body)
                && Objects.equals(this.changedFiles, webhooksPullRequest5.changedFiles)
                && Objects.equals(this.closedAt, webhooksPullRequest5.closedAt)
                && Objects.equals(this.comments, webhooksPullRequest5.comments)
                && Objects.equals(this.commentsUrl, webhooksPullRequest5.commentsUrl)
                && Objects.equals(this.commits, webhooksPullRequest5.commits)
                && Objects.equals(this.commitsUrl, webhooksPullRequest5.commitsUrl)
                && Objects.equals(this.createdAt, webhooksPullRequest5.createdAt)
                && Objects.equals(this.deletions, webhooksPullRequest5.deletions)
                && Objects.equals(this.diffUrl, webhooksPullRequest5.diffUrl)
                && Objects.equals(this.draft, webhooksPullRequest5.draft)
                && Objects.equals(this.head, webhooksPullRequest5.head)
                && Objects.equals(this.htmlUrl, webhooksPullRequest5.htmlUrl)
                && Objects.equals(this.id, webhooksPullRequest5.id)
                && Objects.equals(this.issueUrl, webhooksPullRequest5.issueUrl)
                && Objects.equals(this.labels, webhooksPullRequest5.labels)
                && Objects.equals(this.locked, webhooksPullRequest5.locked)
                && Objects.equals(this.maintainerCanModify, webhooksPullRequest5.maintainerCanModify)
                && Objects.equals(this.mergeable, webhooksPullRequest5.mergeable)
                && Objects.equals(this.mergeableState, webhooksPullRequest5.mergeableState)
                && Objects.equals(this.merged, webhooksPullRequest5.merged)
                && Objects.equals(this.mergedAt, webhooksPullRequest5.mergedAt)
                && Objects.equals(this.mergedBy, webhooksPullRequest5.mergedBy)
                && Objects.equals(this.milestone, webhooksPullRequest5.milestone)
                && Objects.equals(this.nodeId, webhooksPullRequest5.nodeId)
                && Objects.equals(this.number, webhooksPullRequest5.number)
                && Objects.equals(this.patchUrl, webhooksPullRequest5.patchUrl)
                && Objects.equals(this.rebaseable, webhooksPullRequest5.rebaseable)
                && Objects.equals(this.requestedReviewers, webhooksPullRequest5.requestedReviewers)
                && Objects.equals(this.requestedTeams, webhooksPullRequest5.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, webhooksPullRequest5.reviewCommentUrl)
                && Objects.equals(this.reviewComments, webhooksPullRequest5.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, webhooksPullRequest5.reviewCommentsUrl)
                && Objects.equals(this.state, webhooksPullRequest5.state)
                && Objects.equals(this.statusesUrl, webhooksPullRequest5.statusesUrl)
                && Objects.equals(this.title, webhooksPullRequest5.title)
                && Objects.equals(this.updatedAt, webhooksPullRequest5.updatedAt)
                && Objects.equals(this.url, webhooksPullRequest5.url)
                && Objects.equals(this.user, webhooksPullRequest5.user);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhooksPullRequest5 {\n");
