...
public class User8 {
    ...
    public User8 avatarUrl(URI avatarUrl) {
    ...
    public User8 deleted(Boolean deleted) {
    ...
    public User8 email(String email) {
    ...
    public User8 eventsUrl(String eventsUrl) {
    ...
    public User8 followersUrl(URI followersUrl) {
    ...
    public User8 followingUrl(String followingUrl) {
    ...
    public User8 gistsUrl(String gistsUrl) {
    ...
    public User8 gravatarId(String gravatarId) {
    ...
    public User8 htmlUrl(URI htmlUrl) {
    ...
    public User8 login(String login) {
    ...
    public User8 nodeId(String nodeId) {
    ...
    public User8 organizationsUrl(URI organizationsUrl) {
    ...
    public User8 receivedEventsUrl(URI receivedEventsUrl) {
    ...
    public User8 reposUrl(URI reposUrl) {
    ...
    public User8 siteAdmin(Boolean siteAdmin) {
    ...
    public User8 starredUrl(String starredUrl) {
    ...
    public User8 subscriptionsUrl(URI subscriptionsUrl) {
    ...
    public User8 type(TypeEnum type) {
    ...
    public boolean equals(Object o) {
        ...
        User8 user8 = (User8) o;
        return Objects.equals(this.avatarUrl, user8.avatarUrl)
                && Objects.equals(this.deleted, user8.deleted)
                && equalsNullable(this.email, user8.email)
                && Objects.equals(this.eventsUrl, user8.eventsUrl)
                && Objects.equals(this.followersUrl, user8.followersUrl)
                && Objects.equals(this.followingUrl, user8.followingUrl)
                && Objects.equals(this.gistsUrl, user8.gistsUrl)
                && Objects.equals(this.gravatarId, user8.gravatarId)
                && Objects.equals(this.htmlUrl, user8.htmlUrl)
                && Objects.equals(this.id, user8.id)
                && Objects.equals(this.login, user8.login)
                && Objects.equals(this.name, user8.name)
                && Objects.equals(this.nodeId, user8.nodeId)
                && Objects.equals(this.organizationsUrl, user8.organizationsUrl)
                && Objects.equals(this.receivedEventsUrl, user8.receivedEventsUrl)
                && Objects.equals(this.reposUrl, user8.reposUrl)
                && Objects.equals(this.siteAdmin, user8.siteAdmin)
                && Objects.equals(this.starredUrl, user8.starredUrl)
                && Objects.equals(this.subscriptionsUrl, user8.subscriptionsUrl)
                && Objects.equals(this.type, user8.type)
                && Objects.equals(this.url, user8.url);
    }
