 ...
 */
@JsonTypeName("webhook-repository-unarchived")
@Generated(
...
public class WebhookRepositoryUnarchived {
     ...
     */
    public WebhookRepositoryUnarchived(ActionEnum action, RepositoryWebhooks repository, SimpleUser sender) {
        this.action = action;
    ...
    public WebhookRepositoryUnarchived enterprise(EnterpriseWebhooks enterprise) {
    ...
    public WebhookRepositoryUnarchived organization(OrganizationSimpleWebhooks organization) {
    ...
    public WebhookRepositoryUnarchived repository(RepositoryWebhooks repository) {
        this.repository = repository;
        return this;
    }
