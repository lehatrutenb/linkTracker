 ...
 */
@JsonTypeName("webhook-issue-dependencies-blocking-removed")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhookIssueDependenciesBlockingRemoved {
    ...
    public WebhookIssueDependenciesBlockingRemoved action(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public WebhookIssueDependenciesBlockingRemoved blockedIssueId(BigDecimal blockedIssueId) {
    ...
    public WebhookIssueDependenciesBlockingRemoved blockedIssue(Issue blockedIssue) {
    ...
    public WebhookIssueDependenciesBlockingRemoved blockedIssueRepo(Repository blockedIssueRepo) {
        this.blockedIssueRepo = Optional.ofNullable(blockedIssueRepo);
        return this;
    }

    /**
     * Get blockedIssueRepo
    ...
    public WebhookIssueDependenciesBlockingRemoved blockingIssueId(BigDecimal blockingIssueId) {
    ...
    public WebhookIssueDependenciesBlockingRemoved blockingIssue(Issue blockingIssue) {
    ...
    public WebhookIssueDependenciesBlockingRemoved installation(SimpleInstallation installation) {
    ...
    public WebhookIssueDependenciesBlockingRemoved organization(OrganizationSimpleWebhooks organization) {
        this.organization = organization;
        return this;
    }
    ...
    public WebhookIssueDependenciesBlockingRemoved repository(RepositoryWebhooks repository) {
        this.repository = repository;
        return this;
    }
    ...
    public WebhookIssueDependenciesBlockingRemoved sender(SimpleUser sender) {
        this.sender = sender;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhookIssueDependenciesBlockingRemoved webhookIssueDependenciesBlockingRemoved =
                (WebhookIssueDependenciesBlockingRemoved) o;
        return Objects.equals(this.action, webhookIssueDependenciesBlockingRemoved.action)
                && Objects.equals(this.blockedIssueId, webhookIssueDependenciesBlockingRemoved.blockedIssueId)
                && Objects.equals(this.blockedIssue, webhookIssueDependenciesBlockingRemoved.blockedIssue)
                && Objects.equals(this.blockedIssueRepo, webhookIssueDependenciesBlockingRemoved.blockedIssueRepo)
                && Objects.equals(this.blockingIssueId, webhookIssueDependenciesBlockingRemoved.blockingIssueId)
                && Objects.equals(this.blockingIssue, webhookIssueDependenciesBlockingRemoved.blockingIssue)
                && Objects.equals(this.installation, webhookIssueDependenciesBlockingRemoved.installation)
                && Objects.equals(this.organization, webhookIssueDependenciesBlockingRemoved.organization)
                && Objects.equals(this.repository, webhookIssueDependenciesBlockingRemoved.repository)
                && Objects.equals(this.sender, webhookIssueDependenciesBlockingRemoved.sender);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhookIssueDependenciesBlockingRemoved {\n");
        ...
        sb.append("    blockedIssueRepo: ")
                .append(toIndentedString(blockedIssueRepo))
                .append("\n");
