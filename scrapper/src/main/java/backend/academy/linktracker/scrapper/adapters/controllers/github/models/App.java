...
public class App {
    ...
    public App events(List<EventsEnum> events) {
        this.events = events;
        return this;
    }

    public App addEventsItem(EventsEnum eventsItem) {
        if (this.events == null) {
    ...
    public App externalUrl(URI externalUrl) {
        this.externalUrl = externalUrl;
        return this;
    }
    ...
    public App htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public App nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
