 ...
 */
@JsonTypeName("webhook_issue_comment_created_issue_allOf_user")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhookIssueCommentCreatedIssueAllOfUser {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser avatarUrl(String avatarUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser eventsUrl(String eventsUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser followersUrl(String followersUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser followingUrl(String followingUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser gistsUrl(String gistsUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser gravatarId(String gravatarId) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser htmlUrl(String htmlUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser id(Long id) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser login(String login) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser nodeId(String nodeId) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser organizationsUrl(String organizationsUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser receivedEventsUrl(String receivedEventsUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser reposUrl(String reposUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser siteAdmin(Boolean siteAdmin) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser starredUrl(String starredUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser subscriptionsUrl(String subscriptionsUrl) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser type(String type) {
    ...
    public WebhookIssueCommentCreatedIssueAllOfUser url(String url) {
    ...
    public boolean equals(Object o) {
        ...
        WebhookIssueCommentCreatedIssueAllOfUser webhookIssueCommentCreatedIssueAllOfUser =
                (WebhookIssueCommentCreatedIssueAllOfUser) o;
        return Objects.equals(this.avatarUrl, webhookIssueCommentCreatedIssueAllOfUser.avatarUrl)
                && Objects.equals(this.eventsUrl, webhookIssueCommentCreatedIssueAllOfUser.eventsUrl)
                && Objects.equals(this.followersUrl, webhookIssueCommentCreatedIssueAllOfUser.followersUrl)
                && Objects.equals(this.followingUrl, webhookIssueCommentCreatedIssueAllOfUser.followingUrl)
                && Objects.equals(this.gistsUrl, webhookIssueCommentCreatedIssueAllOfUser.gistsUrl)
                && Objects.equals(this.gravatarId, webhookIssueCommentCreatedIssueAllOfUser.gravatarId)
                && Objects.equals(this.htmlUrl, webhookIssueCommentCreatedIssueAllOfUser.htmlUrl)
                && Objects.equals(this.id, webhookIssueCommentCreatedIssueAllOfUser.id)
                && Objects.equals(this.login, webhookIssueCommentCreatedIssueAllOfUser.login)
                && Objects.equals(this.nodeId, webhookIssueCommentCreatedIssueAllOfUser.nodeId)
                && Objects.equals(this.organizationsUrl, webhookIssueCommentCreatedIssueAllOfUser.organizationsUrl)
                && Objects.equals(this.receivedEventsUrl, webhookIssueCommentCreatedIssueAllOfUser.receivedEventsUrl)
                && Objects.equals(this.reposUrl, webhookIssueCommentCreatedIssueAllOfUser.reposUrl)
                && Objects.equals(this.siteAdmin, webhookIssueCommentCreatedIssueAllOfUser.siteAdmin)
                && Objects.equals(this.starredUrl, webhookIssueCommentCreatedIssueAllOfUser.starredUrl)
                && Objects.equals(this.subscriptionsUrl, webhookIssueCommentCreatedIssueAllOfUser.subscriptionsUrl)
                && Objects.equals(this.type, webhookIssueCommentCreatedIssueAllOfUser.type)
                && Objects.equals(this.url, webhookIssueCommentCreatedIssueAllOfUser.url);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhookIssueCommentCreatedIssueAllOfUser {\n");
