 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_5")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf5 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf5() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf5(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf5 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf5 parameters(RepositoryRuleRequiredDeploymentsParameters parameters) {
    ...
    public RepositoryRuleDetailedOneOf5 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf5 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf5 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf5 repositoryRuleDetailedOneOf5 = (RepositoryRuleDetailedOneOf5) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf5.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf5.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf5.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf5.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf5.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf5 {\n");
