...
public class WebhookInstallationCreated {
     ...
     */
    public WebhookInstallationCreated(ActionEnum action, Installation installation, SimpleUser sender) {
        this.action = action;
        this.installation = installation;
        this.sender = sender;
    }

    public WebhookInstallationCreated action(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public WebhookInstallationCreated installation(Installation installation) {
        this.installation = installation;
        return this;
    }
    ...
    public WebhookInstallationCreated repositories(List<@Valid WebhooksRepositoriesInner> repositories) {
        this.repositories = repositories;
        return this;
    }

    public WebhookInstallationCreated addRepositoriesItem(WebhooksRepositoriesInner repositoriesItem) {
    ...
    public WebhookInstallationCreated sender(SimpleUser sender) {
        this.sender = sender;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhookInstallationCreated webhookInstallationCreated = (WebhookInstallationCreated) o;
        return Objects.equals(this.action, webhookInstallationCreated.action)
                && Objects.equals(this.enterprise, webhookInstallationCreated.enterprise)
                && Objects.equals(this.installation, webhookInstallationCreated.installation)
    ...
    public String toString() {
        ...
        sb.append("class WebhookInstallationCreated {\n");
