 ...
 */
@Schema(name = "Issue_8", description = "The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.")
@JsonTypeName("Issue_8")
@Generated(
...
public class Issue8 {
    ...
    private JsonNullable<App17> performedViaGithubApp = JsonNullable.<App17>undefined();
    ...
    public Issue8 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = JsonNullable.of(activeLockReason);
        return this;
    }
    ...
    public Issue8 assignee(User2 assignee) {
    ...
    public Issue8 assignees(List<@Valid User5> assignees) {
        this.assignees = assignees;
        return this;
    }

    public Issue8 addAssigneesItem(User5 assigneesItem) {
    ...
    public Issue8 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public Issue8 body(String body) {
        this.body = JsonNullable.of(body);
        return this;
    }
    ...
    public Issue8 closedAt(OffsetDateTime closedAt) {
        this.closedAt = JsonNullable.of(closedAt);
        return this;
    }
    ...
    public Issue8 comments(Long comments) {
        this.comments = comments;
        return this;
    }
    ...
    public Issue8 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public Issue8 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Issue8 draft(Boolean draft) {
    ...
    public Issue8 eventsUrl(URI eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Issue8 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Issue8 labels(List<@Valid Label1> labels) {
        this.labels = labels;
        return this;
    }

    public Issue8 addLabelsItem(Label1 labelsItem) {
        if (this.labels == null) {
    ...
    public Issue8 labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public Issue8 locked(Boolean locked) {
    ...
    public Issue8 milestone(Milestone milestone) {
        this.milestone = JsonNullable.of(milestone);
        return this;
    }
    ...
    public Issue8 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Issue8 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public Issue8 performedViaGithubApp(App17 performedViaGithubApp) {
    ...
    public JsonNullable<App17> getPerformedViaGithubApp() {
        return performedViaGithubApp;
    }

    public void setPerformedViaGithubApp(JsonNullable<App17> performedViaGithubApp) {
        this.performedViaGithubApp = performedViaGithubApp;
    }

    public Issue8 pullRequest(WebhooksIssuePullRequest pullRequest) {
    ...
    public Issue8 reactions(Reactions reactions) {
        this.reactions = reactions;
        return this;
    }
    ...
    public Issue8 repositoryUrl(URI repositoryUrl) {
        this.repositoryUrl = repositoryUrl;
        return this;
    }
    ...
    public Issue8 pinnedComment(NullableIssueComment pinnedComment) {
    ...
    public Issue8 subIssuesSummary(SubIssuesSummary subIssuesSummary) {
    ...
    public Issue8 issueDependenciesSummary(IssueDependenciesSummary issueDependenciesSummary) {
    ...
    public Issue8 issueFieldValues(List<@Valid IssueFieldValue> issueFieldValues) {
        this.issueFieldValues = issueFieldValues;
        return this;
    }

    public Issue8 addIssueFieldValuesItem(IssueFieldValue issueFieldValuesItem) {
    ...
    public Issue8 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public Issue8 stateReason(String stateReason) {
    ...
    public Issue8 timelineUrl(URI timelineUrl) {
    ...
    public Issue8 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public Issue8 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Issue8 type(IssueType type) {
    ...
    public boolean equals(Object o) {
        ...
        Issue8 issue8 = (Issue8) o;
        return Objects.equals(this.activeLockReason, issue8.activeLockReason)
                && equalsNullable(this.assignee, issue8.assignee)
                && Objects.equals(this.assignees, issue8.assignees)
                && Objects.equals(this.authorAssociation, issue8.authorAssociation)
                && Objects.equals(this.body, issue8.body)
                && Objects.equals(this.closedAt, issue8.closedAt)
                && Objects.equals(this.comments, issue8.comments)
                && Objects.equals(this.commentsUrl, issue8.commentsUrl)
                && Objects.equals(this.createdAt, issue8.createdAt)
                && Objects.equals(this.draft, issue8.draft)
                && Objects.equals(this.eventsUrl, issue8.eventsUrl)
                && Objects.equals(this.htmlUrl, issue8.htmlUrl)
                && Objects.equals(this.id, issue8.id)
                && Objects.equals(this.labels, issue8.labels)
                && Objects.equals(this.labelsUrl, issue8.labelsUrl)
                && Objects.equals(this.locked, issue8.locked)
                && Objects.equals(this.milestone, issue8.milestone)
                && Objects.equals(this.nodeId, issue8.nodeId)
                && Objects.equals(this.number, issue8.number)
                && equalsNullable(this.performedViaGithubApp, issue8.performedViaGithubApp)
                && Objects.equals(this.pullRequest, issue8.pullRequest)
                && Objects.equals(this.reactions, issue8.reactions)
                && Objects.equals(this.repositoryUrl, issue8.repositoryUrl)
                && equalsNullable(this.pinnedComment, issue8.pinnedComment)
                && Objects.equals(this.subIssuesSummary, issue8.subIssuesSummary)
                && Objects.equals(this.issueDependenciesSummary, issue8.issueDependenciesSummary)
                && Objects.equals(this.issueFieldValues, issue8.issueFieldValues)
                && Objects.equals(this.state, issue8.state)
                && equalsNullable(this.stateReason, issue8.stateReason)
                && Objects.equals(this.timelineUrl, issue8.timelineUrl)
                && Objects.equals(this.title, issue8.title)
                && Objects.equals(this.updatedAt, issue8.updatedAt)
                && Objects.equals(this.url, issue8.url)
                && Objects.equals(this.user, issue8.user)
                && equalsNullable(this.type, issue8.type);
    }
