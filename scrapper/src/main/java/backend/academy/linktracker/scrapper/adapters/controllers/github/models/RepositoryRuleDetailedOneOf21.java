 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_21")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf21 implements RepositoryRuleDetailed {
    ...
    private Optional<RepositoryRuleCopilotCodeReviewParameters> parameters = Optional.empty();
    ...
    public RepositoryRuleDetailedOneOf21() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf21(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf21 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf21 parameters(RepositoryRuleCopilotCodeReviewParameters parameters) {
    ...
    public Optional<RepositoryRuleCopilotCodeReviewParameters> getParameters() {
        return parameters;
    }

    public void setParameters(Optional<RepositoryRuleCopilotCodeReviewParameters> parameters) {
        this.parameters = parameters;
    }

    public RepositoryRuleDetailedOneOf21 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf21 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf21 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf21 repositoryRuleDetailedOneOf21 = (RepositoryRuleDetailedOneOf21) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf21.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf21.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf21.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf21.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf21.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf21 {\n");
