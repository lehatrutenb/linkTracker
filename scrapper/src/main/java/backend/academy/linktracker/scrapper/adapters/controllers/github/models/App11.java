...
public class App11 {
    ...
    public App11 events(List<EventsEnum> events) {
        this.events = events;
        return this;
    }

    public App11 addEventsItem(EventsEnum eventsItem) {
        if (this.events == null) {
    ...
    public App11 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public App11 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        App11 app11 = (App11) o;
        return Objects.equals(this.createdAt, app11.createdAt)
                && Objects.equals(this.description, app11.description)
                && Objects.equals(this.events, app11.events)
                && Objects.equals(this.externalUrl, app11.externalUrl)
                && Objects.equals(this.htmlUrl, app11.htmlUrl)
                && Objects.equals(this.id, app11.id)
                && Objects.equals(this.name, app11.name)
                && Objects.equals(this.nodeId, app11.nodeId)
                && Objects.equals(this.owner, app11.owner)
                && Objects.equals(this.permissions, app11.permissions)
                && Objects.equals(this.slug, app11.slug)
                && Objects.equals(this.updatedAt, app11.updatedAt);
    }
