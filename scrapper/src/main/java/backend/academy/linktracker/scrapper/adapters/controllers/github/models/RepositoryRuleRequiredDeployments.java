 ...
 */
@Schema(
        name = "repository-rule-required-deployments",
        description =
                "Choose which environments must be successfully deployed to before refs can be pushed into a ref that matches this rule.")
...
public class RepositoryRuleRequiredDeployments implements OrgRules, RepositoryRule {
     ...
     */
    public RepositoryRuleRequiredDeployments(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleRequiredDeployments type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleRequiredDeployments repositoryRuleRequiredDeployments = (RepositoryRuleRequiredDeployments) o;
        return Objects.equals(this.type, repositoryRuleRequiredDeployments.type)
                && Objects.equals(this.parameters, repositoryRuleRequiredDeployments.parameters);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleRequiredDeployments {\n");
