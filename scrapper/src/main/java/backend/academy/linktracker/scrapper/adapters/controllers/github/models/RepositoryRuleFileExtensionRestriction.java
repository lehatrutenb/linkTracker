 ...
 */
@Schema(
        name = "repository-rule-file-extension-restriction",
        description =
                "Prevent commits that include files with specified file extensions from being pushed to the commit graph.")
...
public class RepositoryRuleFileExtensionRestriction implements OrgRules, RepositoryRule {
     ...
     */
    public RepositoryRuleFileExtensionRestriction(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleFileExtensionRestriction type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleFileExtensionRestriction repositoryRuleFileExtensionRestriction =
                (RepositoryRuleFileExtensionRestriction) o;
        return Objects.equals(this.type, repositoryRuleFileExtensionRestriction.type)
                && Objects.equals(this.parameters, repositoryRuleFileExtensionRestriction.parameters);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleFileExtensionRestriction {\n");
