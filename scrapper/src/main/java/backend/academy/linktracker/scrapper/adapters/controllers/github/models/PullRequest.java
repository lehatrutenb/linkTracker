...
public class PullRequest {
    ...
    public PullRequest links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = JsonNullable.of(activeLockReason);
        return this;
    }
    ...
    public PullRequest assignee(User4 assignee) {
        this.assignee = JsonNullable.of(assignee);
        return this;
    }
    ...
    public PullRequest assignees(List<@Valid User4> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest addAssigneesItem(User4 assigneesItem) {
    ...
    public PullRequest authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = JsonNullable.of(autoMerge);
        return this;
    }
    ...
    public PullRequest commits(Long commits) {
    ...
    public PullRequest labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }
    ...
    public PullRequest requestedReviewers(List<PullRequestRequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest addRequestedReviewersItem(PullRequestRequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }
    ...
    public PullRequest user(User3 user) {
        this.user = JsonNullable.of(user);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.links, pullRequest.links)
                ...
                && equalsNullable(this.mergeable, pullRequest.mergeable)
                && Objects.equals(this.mergeableState, pullRequest.mergeableState)
                && equalsNullable(this.merged, pullRequest.merged)
                && Objects.equals(this.mergedAt, pullRequest.mergedAt)
                && equalsNullable(this.mergedBy, pullRequest.mergedBy)
                ...
                && equalsNullable(this.rebaseable, pullRequest.rebaseable)
