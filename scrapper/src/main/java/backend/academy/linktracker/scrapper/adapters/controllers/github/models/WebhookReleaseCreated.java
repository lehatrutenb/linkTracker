 ...
 */
@JsonTypeName("webhook-release-created")
@Generated(
...
public class WebhookReleaseCreated {
    ...
    public WebhookReleaseCreated enterprise(EnterpriseWebhooks enterprise) {
    ...
    public WebhookReleaseCreated organization(OrganizationSimpleWebhooks organization) {
    ...
    public WebhookReleaseCreated release(WebhooksRelease release) {
        this.release = release;
        return this;
    }
    ...
    public WebhookReleaseCreated repository(RepositoryWebhooks repository) {
        this.repository = repository;
        return this;
    }
