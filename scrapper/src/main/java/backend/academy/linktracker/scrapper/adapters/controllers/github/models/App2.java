...
public class App2 {
    ...
    private Optional<App2Permissions> permissions = Optional.empty();
    ...
    public App2 createdAt(OffsetDateTime createdAt) {
        this.createdAt = JsonNullable.of(createdAt);
        return this;
    }
    ...
    public App2 description(String description) {
        this.description = JsonNullable.of(description);
        return this;
    }
    ...
    public App2 events(List<EventsEnum> events) {
        this.events = events;
        return this;
    }

    public App2 addEventsItem(EventsEnum eventsItem) {
        if (this.events == null) {
    ...
    public App2 externalUrl(URI externalUrl) {
        this.externalUrl = JsonNullable.of(externalUrl);
        return this;
    }
    ...
    public App2 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public App2 clientId(String clientId) {
    ...
    public App2 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public App2 permissions(App2Permissions permissions) {
    ...
    public Optional<App2Permissions> getPermissions() {
        return permissions;
    }

    public void setPermissions(Optional<App2Permissions> permissions) {
        this.permissions = permissions;
    }

    public App2 slug(String slug) {
    ...
    public App2 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = JsonNullable.of(updatedAt);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        App2 app2 = (App2) o;
        return Objects.equals(this.createdAt, app2.createdAt)
                && Objects.equals(this.description, app2.description)
                && Objects.equals(this.events, app2.events)
                && Objects.equals(this.externalUrl, app2.externalUrl)
                && Objects.equals(this.htmlUrl, app2.htmlUrl)
                && Objects.equals(this.id, app2.id)
                && equalsNullable(this.clientId, app2.clientId)
                && Objects.equals(this.name, app2.name)
                && Objects.equals(this.nodeId, app2.nodeId)
                && Objects.equals(this.owner, app2.owner)
                && Objects.equals(this.permissions, app2.permissions)
                && Objects.equals(this.slug, app2.slug)
                && Objects.equals(this.updatedAt, app2.updatedAt);
    }
