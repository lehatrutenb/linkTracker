 ...
 */
@JsonTypeName("webhook-pull-request-ready-for-review")
@Generated(
...
public class WebhookPullRequestReadyForReview {
    ...
    public WebhookPullRequestReadyForReview enterprise(EnterpriseWebhooks enterprise) {
    ...
    public WebhookPullRequestReadyForReview number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public WebhookPullRequestReadyForReview organization(OrganizationSimpleWebhooks organization) {
    ...
    public WebhookPullRequestReadyForReview pullRequest(PullRequestWebhook pullRequest) {
        this.pullRequest = pullRequest;
        return this;
    }
    ...
    public WebhookPullRequestReadyForReview repository(RepositoryWebhooks repository) {
        this.repository = repository;
        return this;
    }
