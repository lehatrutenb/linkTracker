...
public class WorkflowStep1 {
    ...
    public WorkflowStep1 completedAt(String completedAt) {
        this.completedAt = completedAt;
        return this;
    }
    ...
    public WorkflowStep1 conclusion(ConclusionEnum conclusion) {
        this.conclusion = conclusion;
        return this;
    }
    ...
    public WorkflowStep1 name(String name) {
        this.name = name;
        return this;
    }
    ...
    public WorkflowStep1 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public WorkflowStep1 startedAt(String startedAt) {
        this.startedAt = startedAt;
        return this;
    }
    ...
    public WorkflowStep1 status(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WorkflowStep1 workflowStep1 = (WorkflowStep1) o;
        return Objects.equals(this.completedAt, workflowStep1.completedAt)
                && Objects.equals(this.conclusion, workflowStep1.conclusion)
                && Objects.equals(this.name, workflowStep1.name)
                && Objects.equals(this.number, workflowStep1.number)
                && Objects.equals(this.startedAt, workflowStep1.startedAt)
                && Objects.equals(this.status, workflowStep1.status);
    }
