 ...
 */
@Schema(name = "Issue_3", description = "The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.")
@JsonTypeName("Issue_3")
@Generated(
...
public class Issue3 {
    ...
    private JsonNullable<App14> performedViaGithubApp = JsonNullable.<App14>undefined();
    ...
    public Issue3 assignee(User4 assignee) {
    ...
    public Issue3 assignees(List<@Valid User5> assignees) {
        this.assignees = assignees;
        return this;
    }

    public Issue3 addAssigneesItem(User5 assigneesItem) {
    ...
    public Issue3 comments(Long comments) {
        this.comments = comments;
        return this;
    }
    ...
    public Issue3 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }
    ...
    public Issue3 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public Issue3 performedViaGithubApp(App14 performedViaGithubApp) {
    ...
    public JsonNullable<App14> getPerformedViaGithubApp() {
        return performedViaGithubApp;
    }

    public void setPerformedViaGithubApp(JsonNullable<App14> performedViaGithubApp) {
        this.performedViaGithubApp = performedViaGithubApp;
    }

    public Issue3 pullRequest(WebhooksIssuePullRequest pullRequest) {
    ...
    public Issue3 pinnedComment(NullableIssueComment pinnedComment) {
    ...
    public Issue3 subIssuesSummary(SubIssuesSummary subIssuesSummary) {
    ...
    public Issue3 issueDependenciesSummary(IssueDependenciesSummary issueDependenciesSummary) {
    ...
    public Issue3 issueFieldValues(List<@Valid IssueFieldValue> issueFieldValues) {
        this.issueFieldValues = issueFieldValues;
        return this;
    }

    public Issue3 addIssueFieldValuesItem(IssueFieldValue issueFieldValuesItem) {
    ...
    public Issue3 type(IssueType type) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.activeLockReason, issue3.activeLockReason)
                && equalsNullable(this.assignee, issue3.assignee)
                ...
                && equalsNullable(this.performedViaGithubApp, issue3.performedViaGithubApp)
                ...
                && equalsNullable(this.pinnedComment, issue3.pinnedComment)
                && Objects.equals(this.subIssuesSummary, issue3.subIssuesSummary)
                && Objects.equals(this.issueDependenciesSummary, issue3.issueDependenciesSummary)
                && Objects.equals(this.issueFieldValues, issue3.issueFieldValues)
                && Objects.equals(this.state, issue3.state)
                && equalsNullable(this.stateReason, issue3.stateReason)
                && Objects.equals(this.timelineUrl, issue3.timelineUrl)
                && equalsNullable(this.type, issue3.type)
