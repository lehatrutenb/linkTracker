 ...
 */
@Schema(
        name = "webhook_issue_comment_edited_issue",
        description = "The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) the comment belongs to.")
@JsonTypeName("webhook_issue_comment_edited_issue")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhookIssueCommentEditedIssue {
    ...
    public WebhookIssueCommentEditedIssue() {
        super();
    }
    ...
    public WebhookIssueCommentEditedIssue activeLockReason(String activeLockReason) {
        this.activeLockReason = JsonNullable.of(activeLockReason);
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue assignee(User4 assignee) {
        this.assignee = JsonNullable.of(assignee);
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue assignees(List<Object> assignees) {
        this.assignees = assignees;
        return this;
    }

    public WebhookIssueCommentEditedIssue addAssigneesItem(Object assigneesItem) {
    ...
    public WebhookIssueCommentEditedIssue authorAssociation(String authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue body(String body) {
        this.body = JsonNullable.of(body);
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue closedAt(String closedAt) {
        this.closedAt = JsonNullable.of(closedAt);
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue comments(Long comments) {
        this.comments = comments;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue commentsUrl(String commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue createdAt(String createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue draft(Boolean draft) {
    ...
    public WebhookIssueCommentEditedIssue eventsUrl(String eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue htmlUrl(String htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public WebhookIssueCommentEditedIssue addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public WebhookIssueCommentEditedIssue labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue milestone(Object milestone) {
        this.milestone = JsonNullable.of(milestone);
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue performedViaGithubApp(Object performedViaGithubApp) {
    ...
    public WebhookIssueCommentEditedIssue pullRequest(WebhooksIssuePullRequest pullRequest) {
    ...
    public WebhookIssueCommentEditedIssue reactions(WebhookIssueCommentCreatedIssueAllOfReactions reactions) {
        this.reactions = reactions;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue repositoryUrl(String repositoryUrl) {
        this.repositoryUrl = repositoryUrl;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue subIssuesSummary(SubIssuesSummary subIssuesSummary) {
    ...
    public WebhookIssueCommentEditedIssue issueDependenciesSummary(IssueDependenciesSummary issueDependenciesSummary) {
    ...
    public WebhookIssueCommentEditedIssue state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue stateReason(String stateReason) {
    ...
    public WebhookIssueCommentEditedIssue timelineUrl(String timelineUrl) {
    ...
    public WebhookIssueCommentEditedIssue title(String title) {
        this.title = title;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue type(IssueType type) {
    ...
    public WebhookIssueCommentEditedIssue updatedAt(String updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue url(String url) {
        this.url = url;
        return this;
    }
    ...
    public WebhookIssueCommentEditedIssue user(WebhookIssueCommentCreatedIssueAllOfUser user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhookIssueCommentEditedIssue webhookIssueCommentEditedIssue = (WebhookIssueCommentEditedIssue) o;
        return Objects.equals(this.activeLockReason, webhookIssueCommentEditedIssue.activeLockReason)
                && Objects.equals(this.assignee, webhookIssueCommentEditedIssue.assignee)
                && Objects.equals(this.assignees, webhookIssueCommentEditedIssue.assignees)
                && Objects.equals(this.authorAssociation, webhookIssueCommentEditedIssue.authorAssociation)
                && Objects.equals(this.body, webhookIssueCommentEditedIssue.body)
                && Objects.equals(this.closedAt, webhookIssueCommentEditedIssue.closedAt)
                && Objects.equals(this.comments, webhookIssueCommentEditedIssue.comments)
                && Objects.equals(this.commentsUrl, webhookIssueCommentEditedIssue.commentsUrl)
                && Objects.equals(this.createdAt, webhookIssueCommentEditedIssue.createdAt)
                && Objects.equals(this.draft, webhookIssueCommentEditedIssue.draft)
                && Objects.equals(this.eventsUrl, webhookIssueCommentEditedIssue.eventsUrl)
                && Objects.equals(this.htmlUrl, webhookIssueCommentEditedIssue.htmlUrl)
                && Objects.equals(this.id, webhookIssueCommentEditedIssue.id)
                && Objects.equals(this.labels, webhookIssueCommentEditedIssue.labels)
                && Objects.equals(this.labelsUrl, webhookIssueCommentEditedIssue.labelsUrl)
                && Objects.equals(this.locked, webhookIssueCommentEditedIssue.locked)
                && Objects.equals(this.milestone, webhookIssueCommentEditedIssue.milestone)
                && Objects.equals(this.nodeId, webhookIssueCommentEditedIssue.nodeId)
                && Objects.equals(this.number, webhookIssueCommentEditedIssue.number)
                && equalsNullable(this.performedViaGithubApp, webhookIssueCommentEditedIssue.performedViaGithubApp)
                && Objects.equals(this.pullRequest, webhookIssueCommentEditedIssue.pullRequest)
                && Objects.equals(this.reactions, webhookIssueCommentEditedIssue.reactions)
                && Objects.equals(this.repositoryUrl, webhookIssueCommentEditedIssue.repositoryUrl)
                && Objects.equals(this.subIssuesSummary, webhookIssueCommentEditedIssue.subIssuesSummary)
                && Objects.equals(
                        this.issueDependenciesSummary, webhookIssueCommentEditedIssue.issueDependenciesSummary)
                && Objects.equals(this.state, webhookIssueCommentEditedIssue.state)
                && equalsNullable(this.stateReason, webhookIssueCommentEditedIssue.stateReason)
                && Objects.equals(this.timelineUrl, webhookIssueCommentEditedIssue.timelineUrl)
                && Objects.equals(this.title, webhookIssueCommentEditedIssue.title)
                && equalsNullable(this.type, webhookIssueCommentEditedIssue.type)
                && Objects.equals(this.updatedAt, webhookIssueCommentEditedIssue.updatedAt)
                && Objects.equals(this.url, webhookIssueCommentEditedIssue.url)
                && Objects.equals(this.user, webhookIssueCommentEditedIssue.user);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhookIssueCommentEditedIssue {\n");
