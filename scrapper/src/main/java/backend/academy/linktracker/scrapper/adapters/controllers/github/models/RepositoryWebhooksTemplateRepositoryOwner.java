...
public class RepositoryWebhooksTemplateRepositoryOwner {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryWebhooksTemplateRepositoryOwner repositoryWebhooksTemplateRepositoryOwner =
                (RepositoryWebhooksTemplateRepositoryOwner) o;
        return Objects.equals(this.login, repositoryWebhooksTemplateRepositoryOwner.login)
                && Objects.equals(this.id, repositoryWebhooksTemplateRepositoryOwner.id)
                && Objects.equals(this.nodeId, repositoryWebhooksTemplateRepositoryOwner.nodeId)
                && Objects.equals(this.avatarUrl, repositoryWebhooksTemplateRepositoryOwner.avatarUrl)
                && Objects.equals(this.gravatarId, repositoryWebhooksTemplateRepositoryOwner.gravatarId)
                && Objects.equals(this.url, repositoryWebhooksTemplateRepositoryOwner.url)
                && Objects.equals(this.htmlUrl, repositoryWebhooksTemplateRepositoryOwner.htmlUrl)
                && Objects.equals(this.followersUrl, repositoryWebhooksTemplateRepositoryOwner.followersUrl)
                && Objects.equals(this.followingUrl, repositoryWebhooksTemplateRepositoryOwner.followingUrl)
                && Objects.equals(this.gistsUrl, repositoryWebhooksTemplateRepositoryOwner.gistsUrl)
                && Objects.equals(this.starredUrl, repositoryWebhooksTemplateRepositoryOwner.starredUrl)
                && Objects.equals(this.subscriptionsUrl, repositoryWebhooksTemplateRepositoryOwner.subscriptionsUrl)
                && Objects.equals(this.organizationsUrl, repositoryWebhooksTemplateRepositoryOwner.organizationsUrl)
                && Objects.equals(this.reposUrl, repositoryWebhooksTemplateRepositoryOwner.reposUrl)
                && Objects.equals(this.eventsUrl, repositoryWebhooksTemplateRepositoryOwner.eventsUrl)
                && Objects.equals(this.receivedEventsUrl, repositoryWebhooksTemplateRepositoryOwner.receivedEventsUrl)
                && Objects.equals(this.type, repositoryWebhooksTemplateRepositoryOwner.type)
                && Objects.equals(this.siteAdmin, repositoryWebhooksTemplateRepositoryOwner.siteAdmin);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryWebhooksTemplateRepositoryOwner {\n");
