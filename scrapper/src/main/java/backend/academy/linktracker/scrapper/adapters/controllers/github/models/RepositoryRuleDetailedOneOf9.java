 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_9")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf9 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf9() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf9(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf9 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf9 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf9 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf9 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf9 repositoryRuleDetailedOneOf9 = (RepositoryRuleDetailedOneOf9) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf9.type)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf9.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf9.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf9.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf9 {\n");
