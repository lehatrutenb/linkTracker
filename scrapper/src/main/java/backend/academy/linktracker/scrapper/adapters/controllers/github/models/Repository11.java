 ...
 * A git repository
 */
@Schema(name = "Repository_11", description = "A git repository")
@JsonTypeName("Repository_11")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class Repository11 {
    ...
    public Repository11 allowAutoMerge(Boolean allowAutoMerge) {
    ...
    public Repository11 allowForking(Boolean allowForking) {
    ...
    public Repository11 allowMergeCommit(Boolean allowMergeCommit) {
    ...
    public Repository11 allowRebaseMerge(Boolean allowRebaseMerge) {
    ...
    public Repository11 allowSquashMerge(Boolean allowSquashMerge) {
    ...
    public Repository11 allowUpdateBranch(Boolean allowUpdateBranch) {
    ...
    public Repository11 archiveUrl(String archiveUrl) {
        this.archiveUrl = archiveUrl;
        return this;
    }
    ...
    public Repository11 archived(Boolean archived) {
        this.archived = archived;
        return this;
    }
    ...
    public Repository11 assigneesUrl(String assigneesUrl) {
        this.assigneesUrl = assigneesUrl;
        return this;
    }
    ...
    public Repository11 blobsUrl(String blobsUrl) {
        this.blobsUrl = blobsUrl;
        return this;
    }
    ...
    public Repository11 branchesUrl(String branchesUrl) {
        this.branchesUrl = branchesUrl;
        return this;
    }
    ...
    public Repository11 cloneUrl(URI cloneUrl) {
        this.cloneUrl = cloneUrl;
        return this;
    }
    ...
    public Repository11 collaboratorsUrl(String collaboratorsUrl) {
        this.collaboratorsUrl = collaboratorsUrl;
        return this;
    }
    ...
    public Repository11 commentsUrl(String commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public Repository11 commitsUrl(String commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public Repository11 compareUrl(String compareUrl) {
        this.compareUrl = compareUrl;
        return this;
    }
    ...
    public Repository11 contentsUrl(String contentsUrl) {
        this.contentsUrl = contentsUrl;
        return this;
    }
    ...
    public Repository11 contributorsUrl(URI contributorsUrl) {
        this.contributorsUrl = contributorsUrl;
        return this;
    }
    ...
    public Repository11 createdAt(RepositoryCreatedAt createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Repository11 defaultBranch(String defaultBranch) {
        this.defaultBranch = defaultBranch;
        return this;
    }
    ...
    public Repository11 deleteBranchOnMerge(Boolean deleteBranchOnMerge) {
    ...
    public Repository11 deploymentsUrl(URI deploymentsUrl) {
        this.deploymentsUrl = deploymentsUrl;
        return this;
    }
    ...
    public Repository11 description(String description) {
        this.description = description;
        return this;
    }
    ...
    public Repository11 disabled(Boolean disabled) {
    ...
    public Repository11 downloadsUrl(URI downloadsUrl) {
        this.downloadsUrl = downloadsUrl;
        return this;
    }
    ...
    public Repository11 eventsUrl(URI eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Repository11 fork(Boolean fork) {
        this.fork = fork;
        return this;
    }
    ...
    public Repository11 forks(Long forks) {
        this.forks = forks;
        return this;
    }
    ...
    public Repository11 forksCount(Long forksCount) {
        this.forksCount = forksCount;
        return this;
    }
    ...
    public Repository11 forksUrl(URI forksUrl) {
        this.forksUrl = forksUrl;
        return this;
    }
    ...
    public Repository11 fullName(String fullName) {
        this.fullName = fullName;
        return this;
    }
    ...
    public Repository11 gitCommitsUrl(String gitCommitsUrl) {
        this.gitCommitsUrl = gitCommitsUrl;
        return this;
    }
    ...
    public Repository11 gitRefsUrl(String gitRefsUrl) {
        this.gitRefsUrl = gitRefsUrl;
        return this;
    }
    ...
    public Repository11 gitTagsUrl(String gitTagsUrl) {
        this.gitTagsUrl = gitTagsUrl;
        return this;
    }
    ...
    public Repository11 gitUrl(URI gitUrl) {
        this.gitUrl = gitUrl;
        return this;
    }
    ...
    public Repository11 hasDownloads(Boolean hasDownloads) {
        this.hasDownloads = hasDownloads;
        return this;
    }
    ...
    public Repository11 hasIssues(Boolean hasIssues) {
        this.hasIssues = hasIssues;
        return this;
    }
    ...
    public Repository11 hasPages(Boolean hasPages) {
        this.hasPages = hasPages;
        return this;
    }
    ...
    public Repository11 hasProjects(Boolean hasProjects) {
        this.hasProjects = hasProjects;
        return this;
    }
    ...
    public Repository11 hasWiki(Boolean hasWiki) {
        this.hasWiki = hasWiki;
        return this;
    }
    ...
    public Repository11 hasDiscussions(Boolean hasDiscussions) {
        this.hasDiscussions = hasDiscussions;
        return this;
    }
    ...
    public Repository11 hasPullRequests(Boolean hasPullRequests) {
    ...
    public Repository11 pullRequestCreationPolicy(PullRequestCreationPolicyEnum pullRequestCreationPolicy) {
    ...
    public Repository11 hasCommitComments(Boolean hasCommitComments) {
    ...
    public Repository11 homepage(String homepage) {
        this.homepage = homepage;
        return this;
    }
    ...
    public Repository11 hooksUrl(URI hooksUrl) {
        this.hooksUrl = hooksUrl;
        return this;
    }
    ...
    public Repository11 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Repository11 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public Repository11 isTemplate(Boolean isTemplate) {
    ...
    public Repository11 issueCommentUrl(String issueCommentUrl) {
        this.issueCommentUrl = issueCommentUrl;
        return this;
    }
    ...
    public Repository11 issueEventsUrl(String issueEventsUrl) {
        this.issueEventsUrl = issueEventsUrl;
        return this;
    }
    ...
    public Repository11 issuesUrl(String issuesUrl) {
        this.issuesUrl = issuesUrl;
        return this;
    }
    ...
    public Repository11 keysUrl(String keysUrl) {
        this.keysUrl = keysUrl;
        return this;
    }
    ...
    public Repository11 labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public Repository11 language(String language) {
        this.language = language;
        return this;
    }
    ...
    public Repository11 languagesUrl(URI languagesUrl) {
        this.languagesUrl = languagesUrl;
        return this;
    }
    ...
    public Repository11 license(License license) {
        this.license = license;
        return this;
    }
    ...
    public Repository11 masterBranch(String masterBranch) {
    ...
    public Repository11 mergeCommitMessage(MergeCommitMessageEnum mergeCommitMessage) {
    ...
    public Repository11 mergeCommitTitle(MergeCommitTitleEnum mergeCommitTitle) {
    ...
    public Repository11 mergesUrl(URI mergesUrl) {
        this.mergesUrl = mergesUrl;
        return this;
    }
    ...
    public Repository11 milestonesUrl(String milestonesUrl) {
        this.milestonesUrl = milestonesUrl;
        return this;
    }
    ...
    public Repository11 mirrorUrl(URI mirrorUrl) {
        this.mirrorUrl = mirrorUrl;
        return this;
    }
    ...
    public Repository11 name(String name) {
        this.name = name;
        return this;
    }
    ...
    public Repository11 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Repository11 notificationsUrl(String notificationsUrl) {
        this.notificationsUrl = notificationsUrl;
        return this;
    }
    ...
    public Repository11 openIssues(Long openIssues) {
        this.openIssues = openIssues;
        return this;
    }
    ...
    public Repository11 openIssuesCount(Long openIssuesCount) {
        this.openIssuesCount = openIssuesCount;
        return this;
    }
    ...
    public Repository11 organization(String organization) {
    ...
    public Repository11 owner(User owner) {
        this.owner = owner;
        return this;
    }
    ...
    public Repository11 permissions(RepositoryPermissions permissions) {
    ...
    public Repository11 _private(Boolean _private) {
        this._private = _private;
        return this;
    }
    ...
    public Repository11 _public(Boolean _public) {
    ...
    public Repository11 pullsUrl(String pullsUrl) {
        this.pullsUrl = pullsUrl;
        return this;
    }
    ...
    public Repository11 pushedAt(RepositoryPushedAt pushedAt) {
        this.pushedAt = pushedAt;
        return this;
    }
    ...
    public Repository11 releasesUrl(String releasesUrl) {
        this.releasesUrl = releasesUrl;
        return this;
    }
    ...
    public Repository11 roleName(String roleName) {
    ...
    public Repository11 size(Long size) {
        this.size = size;
        return this;
    }
    ...
    public Repository11 squashMergeCommitMessage(SquashMergeCommitMessageEnum squashMergeCommitMessage) {
    ...
    public Repository11 squashMergeCommitTitle(SquashMergeCommitTitleEnum squashMergeCommitTitle) {
    ...
    public Repository11 sshUrl(String sshUrl) {
        this.sshUrl = sshUrl;
        return this;
    }
    ...
    public Repository11 stargazers(Long stargazers) {
    ...
    public Repository11 stargazersCount(Long stargazersCount) {
        this.stargazersCount = stargazersCount;
        return this;
    }
    ...
    public Repository11 stargazersUrl(URI stargazersUrl) {
        this.stargazersUrl = stargazersUrl;
        return this;
    }
    ...
    public Repository11 statusesUrl(String statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public Repository11 subscribersUrl(URI subscribersUrl) {
        this.subscribersUrl = subscribersUrl;
        return this;
    }
    ...
    public Repository11 subscriptionUrl(URI subscriptionUrl) {
        this.subscriptionUrl = subscriptionUrl;
        return this;
    }
    ...
    public Repository11 svnUrl(URI svnUrl) {
        this.svnUrl = svnUrl;
        return this;
    }
    ...
    public Repository11 tagsUrl(URI tagsUrl) {
        this.tagsUrl = tagsUrl;
        return this;
    }
    ...
    public Repository11 teamsUrl(URI teamsUrl) {
        this.teamsUrl = teamsUrl;
        return this;
    }
    ...
    public Repository11 topics(List<String> topics) {
        this.topics = topics;
        return this;
    }

    public Repository11 addTopicsItem(String topicsItem) {
        if (this.topics == null) {
    ...
    public Repository11 treesUrl(String treesUrl) {
        this.treesUrl = treesUrl;
        return this;
    }
    ...
    public Repository11 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Repository11 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public Repository11 visibility(VisibilityEnum visibility) {
        this.visibility = visibility;
        return this;
    }
    ...
    public Repository11 watchers(Long watchers) {
        this.watchers = watchers;
        return this;
    }
    ...
    public Repository11 watchersCount(Long watchersCount) {
        this.watchersCount = watchersCount;
        return this;
    }
    ...
    public Repository11 webCommitSignoffRequired(Boolean webCommitSignoffRequired) {
    ...
    public boolean equals(Object o) {
        ...
        Repository11 repository11 = (Repository11) o;
        return Objects.equals(this.allowAutoMerge, repository11.allowAutoMerge)
                && Objects.equals(this.allowForking, repository11.allowForking)
                && Objects.equals(this.allowMergeCommit, repository11.allowMergeCommit)
                && Objects.equals(this.allowRebaseMerge, repository11.allowRebaseMerge)
                && Objects.equals(this.allowSquashMerge, repository11.allowSquashMerge)
                && Objects.equals(this.allowUpdateBranch, repository11.allowUpdateBranch)
                && Objects.equals(this.archiveUrl, repository11.archiveUrl)
                && Objects.equals(this.archived, repository11.archived)
                && Objects.equals(this.assigneesUrl, repository11.assigneesUrl)
                && Objects.equals(this.blobsUrl, repository11.blobsUrl)
                && Objects.equals(this.branchesUrl, repository11.branchesUrl)
                && Objects.equals(this.cloneUrl, repository11.cloneUrl)
                && Objects.equals(this.collaboratorsUrl, repository11.collaboratorsUrl)
                && Objects.equals(this.commentsUrl, repository11.commentsUrl)
                && Objects.equals(this.commitsUrl, repository11.commitsUrl)
                && Objects.equals(this.compareUrl, repository11.compareUrl)
                && Objects.equals(this.contentsUrl, repository11.contentsUrl)
                && Objects.equals(this.contributorsUrl, repository11.contributorsUrl)
                && Objects.equals(this.createdAt, repository11.createdAt)
                && Objects.equals(this.defaultBranch, repository11.defaultBranch)
                && Objects.equals(this.deleteBranchOnMerge, repository11.deleteBranchOnMerge)
                && Objects.equals(this.deploymentsUrl, repository11.deploymentsUrl)
                && Objects.equals(this.description, repository11.description)
                && Objects.equals(this.disabled, repository11.disabled)
                && Objects.equals(this.downloadsUrl, repository11.downloadsUrl)
                && Objects.equals(this.eventsUrl, repository11.eventsUrl)
                && Objects.equals(this.fork, repository11.fork)
                && Objects.equals(this.forks, repository11.forks)
                && Objects.equals(this.forksCount, repository11.forksCount)
                && Objects.equals(this.forksUrl, repository11.forksUrl)
                && Objects.equals(this.fullName, repository11.fullName)
                && Objects.equals(this.gitCommitsUrl, repository11.gitCommitsUrl)
                && Objects.equals(this.gitRefsUrl, repository11.gitRefsUrl)
                && Objects.equals(this.gitTagsUrl, repository11.gitTagsUrl)
                && Objects.equals(this.gitUrl, repository11.gitUrl)
                && Objects.equals(this.hasDownloads, repository11.hasDownloads)
                && Objects.equals(this.hasIssues, repository11.hasIssues)
                && Objects.equals(this.hasPages, repository11.hasPages)
                && Objects.equals(this.hasProjects, repository11.hasProjects)
                && Objects.equals(this.hasWiki, repository11.hasWiki)
                && Objects.equals(this.hasDiscussions, repository11.hasDiscussions)
                && Objects.equals(this.hasPullRequests, repository11.hasPullRequests)
                && Objects.equals(this.pullRequestCreationPolicy, repository11.pullRequestCreationPolicy)
                && Objects.equals(this.hasCommitComments, repository11.hasCommitComments)
                && Objects.equals(this.homepage, repository11.homepage)
                && Objects.equals(this.hooksUrl, repository11.hooksUrl)
                && Objects.equals(this.htmlUrl, repository11.htmlUrl)
                && Objects.equals(this.id, repository11.id)
                && Objects.equals(this.isTemplate, repository11.isTemplate)
                && Objects.equals(this.issueCommentUrl, repository11.issueCommentUrl)
                && Objects.equals(this.issueEventsUrl, repository11.issueEventsUrl)
                && Objects.equals(this.issuesUrl, repository11.issuesUrl)
                && Objects.equals(this.keysUrl, repository11.keysUrl)
                && Objects.equals(this.labelsUrl, repository11.labelsUrl)
                && Objects.equals(this.language, repository11.language)
                && Objects.equals(this.languagesUrl, repository11.languagesUrl)
                && Objects.equals(this.license, repository11.license)
                && Objects.equals(this.masterBranch, repository11.masterBranch)
                && Objects.equals(this.mergeCommitMessage, repository11.mergeCommitMessage)
                && Objects.equals(this.mergeCommitTitle, repository11.mergeCommitTitle)
                && Objects.equals(this.mergesUrl, repository11.mergesUrl)
                && Objects.equals(this.milestonesUrl, repository11.milestonesUrl)
                && Objects.equals(this.mirrorUrl, repository11.mirrorUrl)
                && Objects.equals(this.name, repository11.name)
                && Objects.equals(this.nodeId, repository11.nodeId)
                && Objects.equals(this.notificationsUrl, repository11.notificationsUrl)
                && Objects.equals(this.openIssues, repository11.openIssues)
                && Objects.equals(this.openIssuesCount, repository11.openIssuesCount)
                && Objects.equals(this.organization, repository11.organization)
                && Objects.equals(this.owner, repository11.owner)
                && Objects.equals(this.permissions, repository11.permissions)
                && Objects.equals(this._private, repository11._private)
                && Objects.equals(this._public, repository11._public)
                && Objects.equals(this.pullsUrl, repository11.pullsUrl)
                && Objects.equals(this.pushedAt, repository11.pushedAt)
                && Objects.equals(this.releasesUrl, repository11.releasesUrl)
                && Objects.equals(this.roleName, repository11.roleName)
                && Objects.equals(this.size, repository11.size)
                && Objects.equals(this.squashMergeCommitMessage, repository11.squashMergeCommitMessage)
                && Objects.equals(this.squashMergeCommitTitle, repository11.squashMergeCommitTitle)
                && Objects.equals(this.sshUrl, repository11.sshUrl)
                && Objects.equals(this.stargazers, repository11.stargazers)
                && Objects.equals(this.stargazersCount, repository11.stargazersCount)
                && Objects.equals(this.stargazersUrl, repository11.stargazersUrl)
                && Objects.equals(this.statusesUrl, repository11.statusesUrl)
                && Objects.equals(this.subscribersUrl, repository11.subscribersUrl)
                && Objects.equals(this.subscriptionUrl, repository11.subscriptionUrl)
                && Objects.equals(this.svnUrl, repository11.svnUrl)
                && Objects.equals(this.tagsUrl, repository11.tagsUrl)
                && Objects.equals(this.teamsUrl, repository11.teamsUrl)
                && Objects.equals(this.topics, repository11.topics)
                && Objects.equals(this.treesUrl, repository11.treesUrl)
                && Objects.equals(this.updatedAt, repository11.updatedAt)
                && Objects.equals(this.url, repository11.url)
                && Objects.equals(this.visibility, repository11.visibility)
                && Objects.equals(this.watchers, repository11.watchers)
                && Objects.equals(this.watchersCount, repository11.watchersCount)
                && Objects.equals(this.webCommitSignoffRequired, repository11.webCommitSignoffRequired);
    }
