...
public class PullRequestEvent implements EventPayload {
    ...
    public PullRequestEvent assignee(SimpleUser1 assignee) {
    ...
    public PullRequestEvent assignees(List<@Valid SimpleUser1> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequestEvent addAssigneesItem(SimpleUser1 assigneesItem) {
