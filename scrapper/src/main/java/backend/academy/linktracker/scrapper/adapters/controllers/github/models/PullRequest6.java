 ...
 * PullRequest6
 */
@JsonTypeName("Pull_Request_6")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class PullRequest6 {
    ...
    @Valid
    private List<PullRequest6RequestedReviewersInner> requestedReviewers = new ArrayList<>();

    @Valid
    private List<@Valid Team1> requestedTeams = new ArrayList<>();
    ...
    public PullRequest6(
            ...
            Long number,
            URI patchUrl,
            List<PullRequest6RequestedReviewersInner> requestedReviewers,
            List<@Valid Team1> requestedTeams,
    ...
    public PullRequest6 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest6 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public PullRequest6 additions(Long additions) {
    ...
    public PullRequest6 assignee(User assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public PullRequest6 assignees(List<@Valid User> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest6 addAssigneesItem(User assigneesItem) {
    ...
    public PullRequest6 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest6 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public PullRequest6 base(PullRequest6Base base) {
        this.base = base;
        return this;
    }
    ...
    @JsonProperty("base")
    public PullRequest6Base getBase() {
        return base;
    }

    public void setBase(PullRequest6Base base) {
        this.base = base;
    }

    public PullRequest6 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public PullRequest6 changedFiles(Long changedFiles) {
    ...
    public PullRequest6 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public PullRequest6 comments(Long comments) {
    ...
    public PullRequest6 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest6 commits(Long commits) {
    ...
    public PullRequest6 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest6 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest6 deletions(Long deletions) {
    ...
    public PullRequest6 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest6 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest6 head(PullRequestBase head) {
        this.head = head;
        return this;
    }
    ...
    public PullRequest6 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest6 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest6 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest6 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest6 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest6 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest6 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest6 mergeable(Boolean mergeable) {
    ...
    public PullRequest6 mergeableState(String mergeableState) {
    ...
    public PullRequest6 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public PullRequest6 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public PullRequest6 mergedBy(User mergedBy) {
    ...
    public PullRequest6 milestone(Milestone1 milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public PullRequest6 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest6 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest6 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest6 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest6 requestedReviewers(List<PullRequest6RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest6 addRequestedReviewersItem(PullRequest6RequestedReviewersInner requestedReviewersItem) {
    ...
    public List<PullRequest6RequestedReviewersInner> getRequestedReviewers() {
        return requestedReviewers;
    }

    public void setRequestedReviewers(List<PullRequest6RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }

    public PullRequest6 requestedTeams(List<@Valid Team1> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest6 addRequestedTeamsItem(Team1 requestedTeamsItem) {
    ...
    public List<@Valid Team1> getRequestedTeams() {
        return requestedTeams;
    }

    public void setRequestedTeams(List<@Valid Team1> requestedTeams) {
        this.requestedTeams = requestedTeams;
    }

    public PullRequest6 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest6 reviewComments(Long reviewComments) {
    ...
    public PullRequest6 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest6 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest6 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest6 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest6 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest6 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest6 user(User1 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest6 pullRequest6 = (PullRequest6) o;
        return Objects.equals(this.links, pullRequest6.links)
                && Objects.equals(this.activeLockReason, pullRequest6.activeLockReason)
                && Objects.equals(this.additions, pullRequest6.additions)
                && Objects.equals(this.assignee, pullRequest6.assignee)
                && Objects.equals(this.assignees, pullRequest6.assignees)
                && Objects.equals(this.authorAssociation, pullRequest6.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest6.autoMerge)
                && Objects.equals(this.base, pullRequest6.base)
                && Objects.equals(this.body, pullRequest6.body)
                && Objects.equals(this.changedFiles, pullRequest6.changedFiles)
                && Objects.equals(this.closedAt, pullRequest6.closedAt)
                && Objects.equals(this.comments, pullRequest6.comments)
                && Objects.equals(this.commentsUrl, pullRequest6.commentsUrl)
                && Objects.equals(this.commits, pullRequest6.commits)
                && Objects.equals(this.commitsUrl, pullRequest6.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest6.createdAt)
                && Objects.equals(this.deletions, pullRequest6.deletions)
                && Objects.equals(this.diffUrl, pullRequest6.diffUrl)
                && Objects.equals(this.draft, pullRequest6.draft)
                && Objects.equals(this.head, pullRequest6.head)
                && Objects.equals(this.htmlUrl, pullRequest6.htmlUrl)
                && Objects.equals(this.id, pullRequest6.id)
                && Objects.equals(this.issueUrl, pullRequest6.issueUrl)
                && Objects.equals(this.labels, pullRequest6.labels)
                && Objects.equals(this.locked, pullRequest6.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest6.maintainerCanModify)
                && Objects.equals(this.mergeable, pullRequest6.mergeable)
                && Objects.equals(this.mergeableState, pullRequest6.mergeableState)
                && Objects.equals(this.merged, pullRequest6.merged)
                && Objects.equals(this.mergedAt, pullRequest6.mergedAt)
                && Objects.equals(this.mergedBy, pullRequest6.mergedBy)
                && Objects.equals(this.milestone, pullRequest6.milestone)
                && Objects.equals(this.nodeId, pullRequest6.nodeId)
                && Objects.equals(this.number, pullRequest6.number)
                && Objects.equals(this.patchUrl, pullRequest6.patchUrl)
                && Objects.equals(this.rebaseable, pullRequest6.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest6.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest6.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest6.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest6.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest6.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest6.state)
                && Objects.equals(this.statusesUrl, pullRequest6.statusesUrl)
                && Objects.equals(this.title, pullRequest6.title)
                && Objects.equals(this.updatedAt, pullRequest6.updatedAt)
                && Objects.equals(this.url, pullRequest6.url)
                && Objects.equals(this.user, pullRequest6.user);
    }
