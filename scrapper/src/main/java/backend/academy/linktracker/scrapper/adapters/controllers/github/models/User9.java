...
public class User9 {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.avatarUrl, user9.avatarUrl)
                ...
                && Objects.equals(this.gistsUrl, user9.gistsUrl)
                && Objects.equals(this.gravatarId, user9.gravatarId)
                && Objects.equals(this.htmlUrl, user9.htmlUrl)
                && Objects.equals(this.id, user9.id)
                && Objects.equals(this.login, user9.login)
                && Objects.equals(this.name, user9.name)
                && Objects.equals(this.nodeId, user9.nodeId)
                && Objects.equals(this.organizationsUrl, user9.organizationsUrl)
                && Objects.equals(this.receivedEventsUrl, user9.receivedEventsUrl)
                && Objects.equals(this.reposUrl, user9.reposUrl)
                && Objects.equals(this.siteAdmin, user9.siteAdmin)
                && Objects.equals(this.starredUrl, user9.starredUrl)
                && Objects.equals(this.subscriptionsUrl, user9.subscriptionsUrl)
                && Objects.equals(this.type, user9.type)
                && Objects.equals(this.url, user9.url)
