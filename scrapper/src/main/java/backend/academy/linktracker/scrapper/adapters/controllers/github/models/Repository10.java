 ...
 * A git repository
 */
@Schema(name = "Repository_10", description = "A git repository")
@JsonTypeName("Repository_10")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class Repository10 {
    ...
    public Repository10 allowAutoMerge(Boolean allowAutoMerge) {
    ...
    public Repository10 allowForking(Boolean allowForking) {
    ...
    public Repository10 allowMergeCommit(Boolean allowMergeCommit) {
    ...
    public Repository10 allowRebaseMerge(Boolean allowRebaseMerge) {
    ...
    public Repository10 allowSquashMerge(Boolean allowSquashMerge) {
    ...
    public Repository10 allowUpdateBranch(Boolean allowUpdateBranch) {
    ...
    public Repository10 archiveUrl(String archiveUrl) {
        this.archiveUrl = archiveUrl;
        return this;
    }
    ...
    public Repository10 archived(Boolean archived) {
        this.archived = archived;
        return this;
    }
    ...
    public Repository10 assigneesUrl(String assigneesUrl) {
        this.assigneesUrl = assigneesUrl;
        return this;
    }
    ...
    public Repository10 blobsUrl(String blobsUrl) {
        this.blobsUrl = blobsUrl;
        return this;
    }
    ...
    public Repository10 branchesUrl(String branchesUrl) {
        this.branchesUrl = branchesUrl;
        return this;
    }
    ...
    public Repository10 cloneUrl(URI cloneUrl) {
        this.cloneUrl = cloneUrl;
        return this;
    }
    ...
    public Repository10 collaboratorsUrl(String collaboratorsUrl) {
        this.collaboratorsUrl = collaboratorsUrl;
        return this;
    }
    ...
    public Repository10 commentsUrl(String commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public Repository10 commitsUrl(String commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public Repository10 compareUrl(String compareUrl) {
        this.compareUrl = compareUrl;
        return this;
    }
    ...
    public Repository10 contentsUrl(String contentsUrl) {
        this.contentsUrl = contentsUrl;
        return this;
    }
    ...
    public Repository10 contributorsUrl(URI contributorsUrl) {
        this.contributorsUrl = contributorsUrl;
        return this;
    }
    ...
    public Repository10 createdAt(RepositoryCreatedAt createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Repository10 defaultBranch(String defaultBranch) {
        this.defaultBranch = defaultBranch;
        return this;
    }
    ...
    public Repository10 deleteBranchOnMerge(Boolean deleteBranchOnMerge) {
    ...
    public Repository10 deploymentsUrl(URI deploymentsUrl) {
        this.deploymentsUrl = deploymentsUrl;
        return this;
    }
    ...
    public Repository10 description(String description) {
        this.description = description;
        return this;
    }
    ...
    public Repository10 disabled(Boolean disabled) {
    ...
    public Repository10 downloadsUrl(URI downloadsUrl) {
        this.downloadsUrl = downloadsUrl;
        return this;
    }
    ...
    public Repository10 eventsUrl(URI eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Repository10 fork(Boolean fork) {
        this.fork = fork;
        return this;
    }
    ...
    public Repository10 forks(Long forks) {
        this.forks = forks;
        return this;
    }
    ...
    public Repository10 forksCount(Long forksCount) {
        this.forksCount = forksCount;
        return this;
    }
    ...
    public Repository10 forksUrl(URI forksUrl) {
        this.forksUrl = forksUrl;
        return this;
    }
    ...
    public Repository10 fullName(String fullName) {
        this.fullName = fullName;
        return this;
    }
    ...
    public Repository10 gitCommitsUrl(String gitCommitsUrl) {
        this.gitCommitsUrl = gitCommitsUrl;
        return this;
    }
    ...
    public Repository10 gitRefsUrl(String gitRefsUrl) {
        this.gitRefsUrl = gitRefsUrl;
        return this;
    }
    ...
    public Repository10 gitTagsUrl(String gitTagsUrl) {
        this.gitTagsUrl = gitTagsUrl;
        return this;
    }
    ...
    public Repository10 gitUrl(URI gitUrl) {
        this.gitUrl = gitUrl;
        return this;
    }
    ...
    public Repository10 hasDownloads(Boolean hasDownloads) {
        this.hasDownloads = hasDownloads;
        return this;
    }
    ...
    public Repository10 hasIssues(Boolean hasIssues) {
        this.hasIssues = hasIssues;
        return this;
    }
    ...
    public Repository10 hasPages(Boolean hasPages) {
        this.hasPages = hasPages;
        return this;
    }
    ...
    public Repository10 hasProjects(Boolean hasProjects) {
        this.hasProjects = hasProjects;
        return this;
    }
    ...
    public Repository10 hasWiki(Boolean hasWiki) {
        this.hasWiki = hasWiki;
        return this;
    }
    ...
    public Repository10 homepage(String homepage) {
        this.homepage = homepage;
        return this;
    }
    ...
    public Repository10 hooksUrl(URI hooksUrl) {
        this.hooksUrl = hooksUrl;
        return this;
    }
    ...
    public Repository10 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Repository10 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public Repository10 isTemplate(Boolean isTemplate) {
    ...
    public Repository10 issueCommentUrl(String issueCommentUrl) {
        this.issueCommentUrl = issueCommentUrl;
        return this;
    }
    ...
    public Repository10 issueEventsUrl(String issueEventsUrl) {
        this.issueEventsUrl = issueEventsUrl;
        return this;
    }
    ...
    public Repository10 issuesUrl(String issuesUrl) {
        this.issuesUrl = issuesUrl;
        return this;
    }
    ...
    public Repository10 keysUrl(String keysUrl) {
        this.keysUrl = keysUrl;
        return this;
    }
    ...
    public Repository10 labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public Repository10 language(String language) {
        this.language = language;
        return this;
    }
    ...
    public Repository10 languagesUrl(URI languagesUrl) {
        this.languagesUrl = languagesUrl;
        return this;
    }
    ...
    public Repository10 license(License license) {
        this.license = license;
        return this;
    }
    ...
    public Repository10 masterBranch(String masterBranch) {
    ...
    public Repository10 mergesUrl(URI mergesUrl) {
        this.mergesUrl = mergesUrl;
        return this;
    }
    ...
    public Repository10 milestonesUrl(String milestonesUrl) {
        this.milestonesUrl = milestonesUrl;
        return this;
    }
    ...
    public Repository10 mirrorUrl(URI mirrorUrl) {
        this.mirrorUrl = mirrorUrl;
        return this;
    }
    ...
    public Repository10 name(String name) {
        this.name = name;
        return this;
    }
    ...
    public Repository10 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Repository10 notificationsUrl(String notificationsUrl) {
        this.notificationsUrl = notificationsUrl;
        return this;
    }
    ...
    public Repository10 openIssues(Long openIssues) {
        this.openIssues = openIssues;
        return this;
    }
    ...
    public Repository10 openIssuesCount(Long openIssuesCount) {
        this.openIssuesCount = openIssuesCount;
        return this;
    }
    ...
    public Repository10 organization(String organization) {
    ...
    public Repository10 owner(User owner) {
        this.owner = owner;
        return this;
    }
    ...
    public Repository10 permissions(RepositoryPermissions permissions) {
    ...
    public Repository10 _private(Boolean _private) {
        this._private = _private;
        return this;
    }
    ...
    public Repository10 _public(Boolean _public) {
    ...
    public Repository10 pullsUrl(String pullsUrl) {
        this.pullsUrl = pullsUrl;
        return this;
    }
    ...
    public Repository10 pushedAt(RepositoryPushedAt pushedAt) {
        this.pushedAt = pushedAt;
        return this;
    }
    ...
    public Repository10 releasesUrl(String releasesUrl) {
        this.releasesUrl = releasesUrl;
        return this;
    }
    ...
    public Repository10 roleName(String roleName) {
    ...
    public Repository10 size(Long size) {
        this.size = size;
        return this;
    }
    ...
    public Repository10 sshUrl(String sshUrl) {
        this.sshUrl = sshUrl;
        return this;
    }
    ...
    public Repository10 stargazers(Long stargazers) {
    ...
    public Repository10 stargazersCount(Long stargazersCount) {
        this.stargazersCount = stargazersCount;
        return this;
    }
    ...
    public Repository10 stargazersUrl(URI stargazersUrl) {
        this.stargazersUrl = stargazersUrl;
        return this;
    }
    ...
    public Repository10 statusesUrl(String statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public Repository10 subscribersUrl(URI subscribersUrl) {
        this.subscribersUrl = subscribersUrl;
        return this;
    }
    ...
    public Repository10 subscriptionUrl(URI subscriptionUrl) {
        this.subscriptionUrl = subscriptionUrl;
        return this;
    }
    ...
    public Repository10 svnUrl(URI svnUrl) {
        this.svnUrl = svnUrl;
        return this;
    }
    ...
    public Repository10 tagsUrl(URI tagsUrl) {
        this.tagsUrl = tagsUrl;
        return this;
    }
    ...
    public Repository10 teamsUrl(URI teamsUrl) {
        this.teamsUrl = teamsUrl;
        return this;
    }
    ...
    public Repository10 topics(List<String> topics) {
        this.topics = topics;
        return this;
    }

    public Repository10 addTopicsItem(String topicsItem) {
        if (this.topics == null) {
    ...
    public Repository10 treesUrl(String treesUrl) {
        this.treesUrl = treesUrl;
        return this;
    }
    ...
    public Repository10 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Repository10 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public Repository10 visibility(VisibilityEnum visibility) {
        this.visibility = visibility;
        return this;
    }
    ...
    public Repository10 watchers(Long watchers) {
        this.watchers = watchers;
        return this;
    }
    ...
    public Repository10 watchersCount(Long watchersCount) {
        this.watchersCount = watchersCount;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Repository10 repository10 = (Repository10) o;
        return Objects.equals(this.allowAutoMerge, repository10.allowAutoMerge)
                && Objects.equals(this.allowForking, repository10.allowForking)
                && Objects.equals(this.allowMergeCommit, repository10.allowMergeCommit)
                && Objects.equals(this.allowRebaseMerge, repository10.allowRebaseMerge)
                && Objects.equals(this.allowSquashMerge, repository10.allowSquashMerge)
                && Objects.equals(this.allowUpdateBranch, repository10.allowUpdateBranch)
                && Objects.equals(this.archiveUrl, repository10.archiveUrl)
                && Objects.equals(this.archived, repository10.archived)
                && Objects.equals(this.assigneesUrl, repository10.assigneesUrl)
                && Objects.equals(this.blobsUrl, repository10.blobsUrl)
                && Objects.equals(this.branchesUrl, repository10.branchesUrl)
                && Objects.equals(this.cloneUrl, repository10.cloneUrl)
                && Objects.equals(this.collaboratorsUrl, repository10.collaboratorsUrl)
                && Objects.equals(this.commentsUrl, repository10.commentsUrl)
                && Objects.equals(this.commitsUrl, repository10.commitsUrl)
                && Objects.equals(this.compareUrl, repository10.compareUrl)
                && Objects.equals(this.contentsUrl, repository10.contentsUrl)
                && Objects.equals(this.contributorsUrl, repository10.contributorsUrl)
                && Objects.equals(this.createdAt, repository10.createdAt)
                && Objects.equals(this.defaultBranch, repository10.defaultBranch)
                && Objects.equals(this.deleteBranchOnMerge, repository10.deleteBranchOnMerge)
                && Objects.equals(this.deploymentsUrl, repository10.deploymentsUrl)
                && Objects.equals(this.description, repository10.description)
                && Objects.equals(this.disabled, repository10.disabled)
                && Objects.equals(this.downloadsUrl, repository10.downloadsUrl)
                && Objects.equals(this.eventsUrl, repository10.eventsUrl)
                && Objects.equals(this.fork, repository10.fork)
                && Objects.equals(this.forks, repository10.forks)
                && Objects.equals(this.forksCount, repository10.forksCount)
                && Objects.equals(this.forksUrl, repository10.forksUrl)
                && Objects.equals(this.fullName, repository10.fullName)
                && Objects.equals(this.gitCommitsUrl, repository10.gitCommitsUrl)
                && Objects.equals(this.gitRefsUrl, repository10.gitRefsUrl)
                && Objects.equals(this.gitTagsUrl, repository10.gitTagsUrl)
                && Objects.equals(this.gitUrl, repository10.gitUrl)
                && Objects.equals(this.hasDownloads, repository10.hasDownloads)
                && Objects.equals(this.hasIssues, repository10.hasIssues)
                && Objects.equals(this.hasPages, repository10.hasPages)
                && Objects.equals(this.hasProjects, repository10.hasProjects)
                && Objects.equals(this.hasWiki, repository10.hasWiki)
                && Objects.equals(this.homepage, repository10.homepage)
                && Objects.equals(this.hooksUrl, repository10.hooksUrl)
                && Objects.equals(this.htmlUrl, repository10.htmlUrl)
                && Objects.equals(this.id, repository10.id)
                && Objects.equals(this.isTemplate, repository10.isTemplate)
                && Objects.equals(this.issueCommentUrl, repository10.issueCommentUrl)
                && Objects.equals(this.issueEventsUrl, repository10.issueEventsUrl)
                && Objects.equals(this.issuesUrl, repository10.issuesUrl)
                && Objects.equals(this.keysUrl, repository10.keysUrl)
                && Objects.equals(this.labelsUrl, repository10.labelsUrl)
                && Objects.equals(this.language, repository10.language)
                && Objects.equals(this.languagesUrl, repository10.languagesUrl)
                && Objects.equals(this.license, repository10.license)
                && Objects.equals(this.masterBranch, repository10.masterBranch)
                && Objects.equals(this.mergesUrl, repository10.mergesUrl)
                && Objects.equals(this.milestonesUrl, repository10.milestonesUrl)
                && Objects.equals(this.mirrorUrl, repository10.mirrorUrl)
                && Objects.equals(this.name, repository10.name)
                && Objects.equals(this.nodeId, repository10.nodeId)
                && Objects.equals(this.notificationsUrl, repository10.notificationsUrl)
                && Objects.equals(this.openIssues, repository10.openIssues)
                && Objects.equals(this.openIssuesCount, repository10.openIssuesCount)
                && Objects.equals(this.organization, repository10.organization)
                && Objects.equals(this.owner, repository10.owner)
                && Objects.equals(this.permissions, repository10.permissions)
                && Objects.equals(this._private, repository10._private)
                && Objects.equals(this._public, repository10._public)
                && Objects.equals(this.pullsUrl, repository10.pullsUrl)
                && Objects.equals(this.pushedAt, repository10.pushedAt)
                && Objects.equals(this.releasesUrl, repository10.releasesUrl)
                && Objects.equals(this.roleName, repository10.roleName)
                && Objects.equals(this.size, repository10.size)
                && Objects.equals(this.sshUrl, repository10.sshUrl)
                && Objects.equals(this.stargazers, repository10.stargazers)
                && Objects.equals(this.stargazersCount, repository10.stargazersCount)
                && Objects.equals(this.stargazersUrl, repository10.stargazersUrl)
                && Objects.equals(this.statusesUrl, repository10.statusesUrl)
                && Objects.equals(this.subscribersUrl, repository10.subscribersUrl)
                && Objects.equals(this.subscriptionUrl, repository10.subscriptionUrl)
                && Objects.equals(this.svnUrl, repository10.svnUrl)
                && Objects.equals(this.tagsUrl, repository10.tagsUrl)
                && Objects.equals(this.teamsUrl, repository10.teamsUrl)
                && Objects.equals(this.topics, repository10.topics)
                && Objects.equals(this.treesUrl, repository10.treesUrl)
                && Objects.equals(this.updatedAt, repository10.updatedAt)
                && Objects.equals(this.url, repository10.url)
                && Objects.equals(this.visibility, repository10.visibility)
                && Objects.equals(this.watchers, repository10.watchers)
                && Objects.equals(this.watchersCount, repository10.watchersCount);
    }
