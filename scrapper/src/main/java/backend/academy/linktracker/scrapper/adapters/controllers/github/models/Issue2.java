...
public class Issue2 {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.activeLockReason, issue2.activeLockReason)
                && equalsNullable(this.assignee, issue2.assignee)
                ...
                && equalsNullable(this.performedViaGithubApp, issue2.performedViaGithubApp)
                ...
                && equalsNullable(this.pinnedComment, issue2.pinnedComment)
                ...
                && equalsNullable(this.stateReason, issue2.stateReason)
                && Objects.equals(this.timelineUrl, issue2.timelineUrl)
                && equalsNullable(this.type, issue2.type)
