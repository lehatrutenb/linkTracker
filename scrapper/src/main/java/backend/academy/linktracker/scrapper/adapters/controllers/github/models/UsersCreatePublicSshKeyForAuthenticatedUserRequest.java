...
public class UsersCreatePublicSshKeyForAuthenticatedUserRequest {
     ...
     */
    public UsersCreatePublicSshKeyForAuthenticatedUserRequest(String key) {
        this.key = key;
    }
    ...
    public UsersCreatePublicSshKeyForAuthenticatedUserRequest key(String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @NotNull
    @Pattern(regexp = "^ssh-(rsa|dss|ed25519) |^ecdsa-sha2-nistp(256|384|521) ")
    @Schema(
            name = "key",
    ...
    public boolean equals(Object o) {
        ...
        UsersCreatePublicSshKeyForAuthenticatedUserRequest usersCreatePublicSshKeyForAuthenticatedUserRequest =
                (UsersCreatePublicSshKeyForAuthenticatedUserRequest) o;
        return Objects.equals(this.title, usersCreatePublicSshKeyForAuthenticatedUserRequest.title)
                && Objects.equals(this.key, usersCreatePublicSshKeyForAuthenticatedUserRequest.key);
    }
