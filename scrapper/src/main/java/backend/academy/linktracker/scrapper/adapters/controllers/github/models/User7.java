...
public class User7 {
     ...
     */
    public User7(Long id, String login) {
        this.id = id;
        this.login = login;
    }

    public User7 avatarUrl(URI avatarUrl) {
    ...
    public User7 deleted(Boolean deleted) {
    ...
    public User7 eventsUrl(String eventsUrl) {
    ...
    public User7 followersUrl(URI followersUrl) {
    ...
    public User7 followingUrl(String followingUrl) {
    ...
    public User7 gistsUrl(String gistsUrl) {
    ...
    public User7 gravatarId(String gravatarId) {
    ...
    public User7 htmlUrl(URI htmlUrl) {
    ...
    public User7 login(String login) {
        this.login = login;
        return this;
    }
    ...
    public User7 nodeId(String nodeId) {
    ...
    public User7 organizationsUrl(URI organizationsUrl) {
    ...
    public User7 receivedEventsUrl(URI receivedEventsUrl) {
    ...
    public User7 reposUrl(URI reposUrl) {
    ...
    public User7 siteAdmin(Boolean siteAdmin) {
    ...
    public User7 starredUrl(String starredUrl) {
    ...
    public User7 subscriptionsUrl(URI subscriptionsUrl) {
    ...
    public User7 type(TypeEnum type) {
    ...
    public User7 userViewType(String userViewType) {
    ...
    public boolean equals(Object o) {
        ...
        User7 user7 = (User7) o;
        return Objects.equals(this.avatarUrl, user7.avatarUrl)
                && Objects.equals(this.deleted, user7.deleted)
                && equalsNullable(this.email, user7.email)
                && Objects.equals(this.eventsUrl, user7.eventsUrl)
                && Objects.equals(this.followersUrl, user7.followersUrl)
                && Objects.equals(this.followingUrl, user7.followingUrl)
                && Objects.equals(this.gistsUrl, user7.gistsUrl)
                && Objects.equals(this.gravatarId, user7.gravatarId)
                && Objects.equals(this.htmlUrl, user7.htmlUrl)
                && Objects.equals(this.id, user7.id)
                && Objects.equals(this.login, user7.login)
                && Objects.equals(this.name, user7.name)
                && Objects.equals(this.nodeId, user7.nodeId)
                && Objects.equals(this.organizationsUrl, user7.organizationsUrl)
                && Objects.equals(this.receivedEventsUrl, user7.receivedEventsUrl)
                && Objects.equals(this.reposUrl, user7.reposUrl)
                && Objects.equals(this.siteAdmin, user7.siteAdmin)
                && Objects.equals(this.starredUrl, user7.starredUrl)
                && Objects.equals(this.subscriptionsUrl, user7.subscriptionsUrl)
                && Objects.equals(this.type, user7.type)
                && Objects.equals(this.userViewType, user7.userViewType)
                && Objects.equals(this.url, user7.url);
    }
