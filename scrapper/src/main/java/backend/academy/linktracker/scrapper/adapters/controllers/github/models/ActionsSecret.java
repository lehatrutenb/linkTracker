 ...
 */
@Schema(name = "actions-secret", description = "Set secrets for GitHub Actions.")
@JsonTypeName("actions-secret")
@Generated(
...
public class ActionsSecret {
     ...
     */
    public ActionsSecret(String name, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        this.name = name;
