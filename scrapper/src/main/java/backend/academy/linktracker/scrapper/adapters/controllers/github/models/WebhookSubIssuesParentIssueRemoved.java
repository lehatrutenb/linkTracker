 ...
 */
@JsonTypeName("webhook-sub-issues-parent-issue-removed")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhookSubIssuesParentIssueRemoved {
    ...
    public WebhookSubIssuesParentIssueRemoved action(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public WebhookSubIssuesParentIssueRemoved parentIssueId(BigDecimal parentIssueId) {
        this.parentIssueId = parentIssueId;
        return this;
    }
    ...
    public WebhookSubIssuesParentIssueRemoved parentIssue(Issue parentIssue) {
        this.parentIssue = parentIssue;
        return this;
    }
    ...
    public WebhookSubIssuesParentIssueRemoved parentIssueRepo(Repository parentIssueRepo) {
        this.parentIssueRepo = parentIssueRepo;
        return this;
    }
    ...
    public WebhookSubIssuesParentIssueRemoved subIssueId(BigDecimal subIssueId) {
        this.subIssueId = subIssueId;
        return this;
    }
    ...
    public WebhookSubIssuesParentIssueRemoved subIssue(Issue subIssue) {
        this.subIssue = subIssue;
        return this;
    }
    ...
    public WebhookSubIssuesParentIssueRemoved installation(SimpleInstallation installation) {
    ...
    public WebhookSubIssuesParentIssueRemoved organization(OrganizationSimpleWebhooks organization) {
    ...
    public WebhookSubIssuesParentIssueRemoved repository(RepositoryWebhooks repository) {
    ...
    public WebhookSubIssuesParentIssueRemoved sender(SimpleUser sender) {
    ...
    public boolean equals(Object o) {
        ...
        WebhookSubIssuesParentIssueRemoved webhookSubIssuesParentIssueRemoved = (WebhookSubIssuesParentIssueRemoved) o;
        return Objects.equals(this.action, webhookSubIssuesParentIssueRemoved.action)
                && Objects.equals(this.parentIssueId, webhookSubIssuesParentIssueRemoved.parentIssueId)
                && Objects.equals(this.parentIssue, webhookSubIssuesParentIssueRemoved.parentIssue)
                && Objects.equals(this.parentIssueRepo, webhookSubIssuesParentIssueRemoved.parentIssueRepo)
                && Objects.equals(this.subIssueId, webhookSubIssuesParentIssueRemoved.subIssueId)
                && Objects.equals(this.subIssue, webhookSubIssuesParentIssueRemoved.subIssue)
                && Objects.equals(this.installation, webhookSubIssuesParentIssueRemoved.installation)
                && Objects.equals(this.organization, webhookSubIssuesParentIssueRemoved.organization)
                && Objects.equals(this.repository, webhookSubIssuesParentIssueRemoved.repository)
                && Objects.equals(this.sender, webhookSubIssuesParentIssueRemoved.sender);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhookSubIssuesParentIssueRemoved {\n");
