 ...
 */
@JsonTypeName("webhook_pull_request_review_comment_edited_pull_request")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhookPullRequestReviewCommentEditedPullRequest {
    ...
    private JsonNullable<User7> user = JsonNullable.<User7>undefined();
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = JsonNullable.of(activeLockReason);
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest assignee(User assignee) {
        this.assignee = JsonNullable.of(assignee);
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest assignees(List<@Valid User> assignees) {
        this.assignees = assignees;
        return this;
    }

    public WebhookPullRequestReviewCommentEditedPullRequest addAssigneesItem(User assigneesItem) {
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest autoMerge(PullRequestAutoMerge autoMerge) {
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest body(String body) {
        this.body = JsonNullable.of(body);
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest closedAt(String closedAt) {
        this.closedAt = JsonNullable.of(closedAt);
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest createdAt(String createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest draft(Boolean draft) {
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest head(
            WebhookPullRequestReviewCommentDeletedPullRequestHead head) {
        this.head = head;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public WebhookPullRequestReviewCommentEditedPullRequest addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest mergedAt(String mergedAt) {
        this.mergedAt = JsonNullable.of(mergedAt);
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest milestone(Milestone milestone) {
        this.milestone = JsonNullable.of(milestone);
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest requestedReviewers(
            List<PullRequest3RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public WebhookPullRequestReviewCommentEditedPullRequest addRequestedReviewersItem(
            PullRequest3RequestedReviewersInner requestedReviewersItem) {
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public WebhookPullRequestReviewCommentEditedPullRequest addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest title(String title) {
        this.title = title;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest updatedAt(String updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public WebhookPullRequestReviewCommentEditedPullRequest user(User7 user) {
        this.user = JsonNullable.of(user);
        return this;
    }
    ...
    @JsonProperty("user")
    public JsonNullable<User7> getUser() {
        return user;
    }

    public void setUser(JsonNullable<User7> user) {
        this.user = user;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhookPullRequestReviewCommentEditedPullRequest webhookPullRequestReviewCommentEditedPullRequest =
                (WebhookPullRequestReviewCommentEditedPullRequest) o;
        return Objects.equals(this.links, webhookPullRequestReviewCommentEditedPullRequest.links)
                && Objects.equals(
                        this.activeLockReason, webhookPullRequestReviewCommentEditedPullRequest.activeLockReason)
                && Objects.equals(this.assignee, webhookPullRequestReviewCommentEditedPullRequest.assignee)
                && Objects.equals(this.assignees, webhookPullRequestReviewCommentEditedPullRequest.assignees)
                && Objects.equals(
                        this.authorAssociation, webhookPullRequestReviewCommentEditedPullRequest.authorAssociation)
                && equalsNullable(this.autoMerge, webhookPullRequestReviewCommentEditedPullRequest.autoMerge)
                && Objects.equals(this.base, webhookPullRequestReviewCommentEditedPullRequest.base)
                && Objects.equals(this.body, webhookPullRequestReviewCommentEditedPullRequest.body)
                && Objects.equals(this.closedAt, webhookPullRequestReviewCommentEditedPullRequest.closedAt)
                && Objects.equals(this.commentsUrl, webhookPullRequestReviewCommentEditedPullRequest.commentsUrl)
                && Objects.equals(this.commitsUrl, webhookPullRequestReviewCommentEditedPullRequest.commitsUrl)
                && Objects.equals(this.createdAt, webhookPullRequestReviewCommentEditedPullRequest.createdAt)
                && Objects.equals(this.diffUrl, webhookPullRequestReviewCommentEditedPullRequest.diffUrl)
                && Objects.equals(this.draft, webhookPullRequestReviewCommentEditedPullRequest.draft)
                && Objects.equals(this.head, webhookPullRequestReviewCommentEditedPullRequest.head)
                && Objects.equals(this.htmlUrl, webhookPullRequestReviewCommentEditedPullRequest.htmlUrl)
                && Objects.equals(this.id, webhookPullRequestReviewCommentEditedPullRequest.id)
                && Objects.equals(this.issueUrl, webhookPullRequestReviewCommentEditedPullRequest.issueUrl)
                && Objects.equals(this.labels, webhookPullRequestReviewCommentEditedPullRequest.labels)
                && Objects.equals(this.locked, webhookPullRequestReviewCommentEditedPullRequest.locked)
                && Objects.equals(this.mergedAt, webhookPullRequestReviewCommentEditedPullRequest.mergedAt)
                && Objects.equals(this.milestone, webhookPullRequestReviewCommentEditedPullRequest.milestone)
                && Objects.equals(this.nodeId, webhookPullRequestReviewCommentEditedPullRequest.nodeId)
                && Objects.equals(this.number, webhookPullRequestReviewCommentEditedPullRequest.number)
                && Objects.equals(this.patchUrl, webhookPullRequestReviewCommentEditedPullRequest.patchUrl)
                && Objects.equals(
                        this.requestedReviewers, webhookPullRequestReviewCommentEditedPullRequest.requestedReviewers)
                && Objects.equals(this.requestedTeams, webhookPullRequestReviewCommentEditedPullRequest.requestedTeams)
                && Objects.equals(
                        this.reviewCommentUrl, webhookPullRequestReviewCommentEditedPullRequest.reviewCommentUrl)
                && Objects.equals(
                        this.reviewCommentsUrl, webhookPullRequestReviewCommentEditedPullRequest.reviewCommentsUrl)
                && Objects.equals(this.state, webhookPullRequestReviewCommentEditedPullRequest.state)
                && Objects.equals(this.statusesUrl, webhookPullRequestReviewCommentEditedPullRequest.statusesUrl)
                && Objects.equals(this.title, webhookPullRequestReviewCommentEditedPullRequest.title)
                && Objects.equals(this.updatedAt, webhookPullRequestReviewCommentEditedPullRequest.updatedAt)
                && Objects.equals(this.url, webhookPullRequestReviewCommentEditedPullRequest.url)
                && Objects.equals(this.user, webhookPullRequestReviewCommentEditedPullRequest.user);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhookPullRequestReviewCommentEditedPullRequest {\n");
