 ...
 */
@Schema(name = "App_2_permissions", description = "The set of permissions for the GitHub app")
...
public class App2Permissions {
    ...
    public boolean equals(Object o) {
        ...
        App2Permissions app2Permissions = (App2Permissions) o;
        return Objects.equals(this.actions, app2Permissions.actions)
                && Objects.equals(this.administration, app2Permissions.administration)
                && Objects.equals(this.checks, app2Permissions.checks)
                && Objects.equals(this.contentReferences, app2Permissions.contentReferences)
                && Objects.equals(this.contents, app2Permissions.contents)
                && Objects.equals(this.deployments, app2Permissions.deployments)
                && Objects.equals(this.discussions, app2Permissions.discussions)
                && Objects.equals(this.emails, app2Permissions.emails)
                && Objects.equals(this.environments, app2Permissions.environments)
                && Objects.equals(this.issues, app2Permissions.issues)
                && Objects.equals(this.keys, app2Permissions.keys)
                && Objects.equals(this.members, app2Permissions.members)
                && Objects.equals(this.metadata, app2Permissions.metadata)
                && Objects.equals(this.organizationAdministration, app2Permissions.organizationAdministration)
                && Objects.equals(this.organizationHooks, app2Permissions.organizationHooks)
                && Objects.equals(this.organizationPackages, app2Permissions.organizationPackages)
                && Objects.equals(this.organizationPlan, app2Permissions.organizationPlan)
                && Objects.equals(this.organizationProjects, app2Permissions.organizationProjects)
                && Objects.equals(this.organizationSecrets, app2Permissions.organizationSecrets)
                && Objects.equals(this.organizationSelfHostedRunners, app2Permissions.organizationSelfHostedRunners)
                && Objects.equals(this.organizationUserBlocking, app2Permissions.organizationUserBlocking)
                && Objects.equals(this.packages, app2Permissions.packages)
                && Objects.equals(this.pages, app2Permissions.pages)
                && Objects.equals(this.pullRequests, app2Permissions.pullRequests)
                && Objects.equals(this.repositoryHooks, app2Permissions.repositoryHooks)
                && Objects.equals(this.repositoryProjects, app2Permissions.repositoryProjects)
                && Objects.equals(this.secretScanningAlerts, app2Permissions.secretScanningAlerts)
                && Objects.equals(this.secrets, app2Permissions.secrets)
                && Objects.equals(this.securityEvents, app2Permissions.securityEvents)
                && Objects.equals(this.securityScanningAlert, app2Permissions.securityScanningAlert)
                && Objects.equals(this.singleFile, app2Permissions.singleFile)
                && Objects.equals(this.statuses, app2Permissions.statuses)
                && Objects.equals(this.vulnerabilityAlerts, app2Permissions.vulnerabilityAlerts)
                && Objects.equals(this.workflows, app2Permissions.workflows);
    }
    ...
    public String toString() {
        ...
        sb.append("class App2Permissions {\n");
