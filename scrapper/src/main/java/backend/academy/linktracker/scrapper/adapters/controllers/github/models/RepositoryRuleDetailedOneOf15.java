 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_15")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf15 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf15() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf15(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf15 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf15 parameters(RepositoryRuleFilePathRestrictionParameters parameters) {
    ...
    public RepositoryRuleDetailedOneOf15 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf15 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf15 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf15 repositoryRuleDetailedOneOf15 = (RepositoryRuleDetailedOneOf15) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf15.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf15.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf15.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf15.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf15.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf15 {\n");
