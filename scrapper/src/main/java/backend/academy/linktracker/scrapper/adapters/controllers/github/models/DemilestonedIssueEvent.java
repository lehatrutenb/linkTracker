 ...
 */
@Schema(name = "demilestoned-issue-event", description = "Demilestoned Issue Event")
@JsonTypeName("demilestoned-issue-event")
@Generated(
...
public class DemilestonedIssueEvent {
    ...
    public DemilestonedIssueEvent id(Long id) {
        this.id = id;
        return this;
    }
