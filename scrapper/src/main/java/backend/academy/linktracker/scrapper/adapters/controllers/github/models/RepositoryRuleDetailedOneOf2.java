 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_2")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf2 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf2() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf2(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf2 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf2 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf2 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf2 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf2 repositoryRuleDetailedOneOf2 = (RepositoryRuleDetailedOneOf2) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf2.type)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf2.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf2.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf2.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf2 {\n");
