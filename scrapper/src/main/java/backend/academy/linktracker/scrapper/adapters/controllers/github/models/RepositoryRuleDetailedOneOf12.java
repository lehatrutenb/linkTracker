 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_12")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf12 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf12() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf12(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf12 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf12 parameters(RepositoryRuleCommitMessagePatternParameters parameters) {
    ...
    public RepositoryRuleDetailedOneOf12 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf12 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf12 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf12 repositoryRuleDetailedOneOf12 = (RepositoryRuleDetailedOneOf12) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf12.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf12.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf12.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf12.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf12.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf12 {\n");
