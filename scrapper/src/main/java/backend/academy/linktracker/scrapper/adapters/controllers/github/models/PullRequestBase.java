 ...
 * PullRequestBase
 */
@JsonTypeName("Pull_Request_base")
@Generated(
...
public class PullRequestBase {
     ...
     */
    public PullRequestBase(String label, String ref, Repository3 repo, String sha, User1 user) {
        this.label = label;
        this.ref = ref;
        this.repo = repo;
        this.sha = sha;
    ...
    public PullRequestBase user(User1 user) {
        this.user = JsonNullable.of(user);
        return this;
    }
