 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_8")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf8 implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf8() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf8(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf8 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf8 parameters(RepositoryRuleRequiredStatusChecksParameters parameters) {
    ...
    public RepositoryRuleDetailedOneOf8 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf8 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf8 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf8 repositoryRuleDetailedOneOf8 = (RepositoryRuleDetailedOneOf8) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf8.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf8.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf8.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf8.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf8.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf8 {\n");
