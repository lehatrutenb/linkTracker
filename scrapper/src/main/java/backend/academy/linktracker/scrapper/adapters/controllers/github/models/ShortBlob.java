 ...
 * Short Blob
 */
@Schema(name = "short-blob", description = "Short Blob")
@JsonTypeName("short-blob")
@Generated(
...
public class ShortBlob {
     ...
     */
    public ShortBlob(String url, String sha) {
        this.url = url;
        this.sha = sha;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.url, shortBlob.url) && Objects.equals(this.sha, shortBlob.sha);
    }
