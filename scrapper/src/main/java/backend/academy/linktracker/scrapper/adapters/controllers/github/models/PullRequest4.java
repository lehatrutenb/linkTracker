...
public class PullRequest4 {
    ...
    public PullRequest4 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest4 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = JsonNullable.of(activeLockReason);
        return this;
    }
    ...
    public PullRequest4 additions(Long additions) {
    ...
    public PullRequest4 assignee(User4 assignee) {
        this.assignee = JsonNullable.of(assignee);
        return this;
    }
    ...
    public PullRequest4 assignees(List<@Valid User5> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest4 addAssigneesItem(User5 assigneesItem) {
    ...
    public PullRequest4 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest4 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = JsonNullable.of(autoMerge);
        return this;
    }
    ...
    public PullRequest4 base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public PullRequest4 body(String body) {
        this.body = JsonNullable.of(body);
        return this;
    }
    ...
    public PullRequest4 changedFiles(Long changedFiles) {
    ...
    public PullRequest4 closedAt(OffsetDateTime closedAt) {
        this.closedAt = JsonNullable.of(closedAt);
        return this;
    }
    ...
    public PullRequest4 comments(Long comments) {
    ...
    public PullRequest4 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest4 commits(Long commits) {
    ...
    public PullRequest4 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest4 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest4 deletions(Long deletions) {
    ...
    public PullRequest4 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest4 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest4 head(PullRequestHead head) {
        this.head = head;
        return this;
    }
    ...
    public PullRequest4 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest4 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest4 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest4 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest4 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest4 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest4 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest4 mergeable(Boolean mergeable) {
    ...
    public PullRequest4 mergeableState(String mergeableState) {
    ...
    public PullRequest4 merged(Boolean merged) {
    ...
    public PullRequest4 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = JsonNullable.of(mergedAt);
        return this;
    }
    ...
    public PullRequest4 mergedBy(User4 mergedBy) {
    ...
    public PullRequest4 milestone(Milestone milestone) {
        this.milestone = JsonNullable.of(milestone);
        return this;
    }
    ...
    public PullRequest4 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest4 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest4 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest4 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest4 requestedReviewers(List<PullRequestRequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest4 addRequestedReviewersItem(PullRequestRequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest4 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest4 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public PullRequest4 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest4 reviewComments(Long reviewComments) {
    ...
    public PullRequest4 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest4 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest4 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest4 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest4 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest4 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest4 user(User3 user) {
        this.user = JsonNullable.of(user);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest4 pullRequest4 = (PullRequest4) o;
        return Objects.equals(this.links, pullRequest4.links)
                && Objects.equals(this.activeLockReason, pullRequest4.activeLockReason)
                && Objects.equals(this.additions, pullRequest4.additions)
                && Objects.equals(this.assignee, pullRequest4.assignee)
                && Objects.equals(this.assignees, pullRequest4.assignees)
                && Objects.equals(this.authorAssociation, pullRequest4.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest4.autoMerge)
                && Objects.equals(this.base, pullRequest4.base)
                && Objects.equals(this.body, pullRequest4.body)
                && Objects.equals(this.changedFiles, pullRequest4.changedFiles)
                && Objects.equals(this.closedAt, pullRequest4.closedAt)
                && Objects.equals(this.comments, pullRequest4.comments)
                && Objects.equals(this.commentsUrl, pullRequest4.commentsUrl)
                && Objects.equals(this.commits, pullRequest4.commits)
                && Objects.equals(this.commitsUrl, pullRequest4.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest4.createdAt)
                && Objects.equals(this.deletions, pullRequest4.deletions)
                && Objects.equals(this.diffUrl, pullRequest4.diffUrl)
                && Objects.equals(this.draft, pullRequest4.draft)
                && Objects.equals(this.head, pullRequest4.head)
                && Objects.equals(this.htmlUrl, pullRequest4.htmlUrl)
                && Objects.equals(this.id, pullRequest4.id)
                && Objects.equals(this.issueUrl, pullRequest4.issueUrl)
                && Objects.equals(this.labels, pullRequest4.labels)
                && Objects.equals(this.locked, pullRequest4.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest4.maintainerCanModify)
                && equalsNullable(this.mergeable, pullRequest4.mergeable)
                && Objects.equals(this.mergeableState, pullRequest4.mergeableState)
                && equalsNullable(this.merged, pullRequest4.merged)
                && Objects.equals(this.mergedAt, pullRequest4.mergedAt)
                && equalsNullable(this.mergedBy, pullRequest4.mergedBy)
                && Objects.equals(this.milestone, pullRequest4.milestone)
                && Objects.equals(this.nodeId, pullRequest4.nodeId)
                && Objects.equals(this.number, pullRequest4.number)
                && Objects.equals(this.patchUrl, pullRequest4.patchUrl)
                && equalsNullable(this.rebaseable, pullRequest4.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest4.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest4.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest4.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest4.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest4.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest4.state)
                && Objects.equals(this.statusesUrl, pullRequest4.statusesUrl)
                && Objects.equals(this.title, pullRequest4.title)
                && Objects.equals(this.updatedAt, pullRequest4.updatedAt)
                && Objects.equals(this.url, pullRequest4.url)
                && Objects.equals(this.user, pullRequest4.user);
    }
