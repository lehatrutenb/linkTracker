 ...
 * SimplePullRequest3
 */
@JsonTypeName("Simple_Pull_Request_3")
@Generated(
...
public class SimplePullRequest3 {
    ...
    private SimplePullRequest3Head head;
    ...
    public SimplePullRequest3 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public SimplePullRequest3 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public SimplePullRequest3 assignees(List<@Valid User2> assignees) {
        this.assignees = assignees;
        return this;
    }

    public SimplePullRequest3 addAssigneesItem(User2 assigneesItem) {
    ...
    public SimplePullRequest3 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public SimplePullRequest3 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public SimplePullRequest3 closedAt(String closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public SimplePullRequest3 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public SimplePullRequest3 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public SimplePullRequest3 createdAt(String createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public SimplePullRequest3 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public SimplePullRequest3 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public SimplePullRequest3 head(SimplePullRequest3Head head) {
        this.head = head;
        return this;
    }
    ...
    @JsonProperty("head")
    public SimplePullRequest3Head getHead() {
        return head;
    }

    public void setHead(SimplePullRequest3Head head) {
        this.head = head;
    }

    public SimplePullRequest3 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public SimplePullRequest3 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public SimplePullRequest3 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public SimplePullRequest3 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public SimplePullRequest3 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public SimplePullRequest3 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public SimplePullRequest3 mergedAt(String mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public SimplePullRequest3 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public SimplePullRequest3 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public SimplePullRequest3 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public SimplePullRequest3 requestedReviewers(List<PullRequestRequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public SimplePullRequest3 addRequestedReviewersItem(PullRequestRequestedReviewersInner requestedReviewersItem) {
    ...
    public SimplePullRequest3 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public SimplePullRequest3 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public SimplePullRequest3 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public SimplePullRequest3 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public SimplePullRequest3 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public SimplePullRequest3 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public SimplePullRequest3 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public SimplePullRequest3 updatedAt(String updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public SimplePullRequest3 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public SimplePullRequest3 user(User3 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.links, simplePullRequest3.links)
