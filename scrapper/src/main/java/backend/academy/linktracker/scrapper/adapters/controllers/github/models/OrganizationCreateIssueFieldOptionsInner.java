...
public class OrganizationCreateIssueFieldOptionsInner {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, organizationCreateIssueFieldOptionsInner.name)
                && equalsNullable(this.description, organizationCreateIssueFieldOptionsInner.description)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, hashCodeNullable(description), color, priority);
    }
