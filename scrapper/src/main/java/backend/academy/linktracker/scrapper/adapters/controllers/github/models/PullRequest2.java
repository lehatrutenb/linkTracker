...
public class PullRequest2 {
    ...
    public PullRequest2 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest2 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public PullRequest2 additions(Long additions) {
    ...
    public PullRequest2 assignee(User assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public PullRequest2 assignees(List<@Valid User2> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest2 addAssigneesItem(User2 assigneesItem) {
    ...
    public PullRequest2 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest2 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public PullRequest2 base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public PullRequest2 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public PullRequest2 changedFiles(Long changedFiles) {
    ...
    public PullRequest2 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public PullRequest2 comments(Long comments) {
    ...
    public PullRequest2 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest2 commits(Long commits) {
    ...
    public PullRequest2 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest2 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest2 deletions(Long deletions) {
    ...
    public PullRequest2 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest2 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest2 head(PullRequest2Head head) {
        this.head = head;
        return this;
    }
    ...
    @JsonProperty("head")
    public PullRequest2Head getHead() {
        return head;
    }

    public void setHead(PullRequest2Head head) {
        this.head = head;
    }

    public PullRequest2 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest2 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest2 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest2 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest2 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest2 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest2 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest2 mergeable(Boolean mergeable) {
    ...
    public PullRequest2 mergeableState(String mergeableState) {
    ...
    public PullRequest2 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public PullRequest2 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public PullRequest2 mergedBy(User mergedBy) {
    ...
    public PullRequest2 milestone(Milestone milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public PullRequest2 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest2 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest2 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest2 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest2 requestedReviewers(List<PullRequestRequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest2 addRequestedReviewersItem(PullRequestRequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest2 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest2 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public PullRequest2 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest2 reviewComments(Long reviewComments) {
    ...
    public PullRequest2 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest2 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest2 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest2 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest2 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest2 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest2 user(User3 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest2 pullRequest2 = (PullRequest2) o;
        return Objects.equals(this.links, pullRequest2.links)
                && Objects.equals(this.activeLockReason, pullRequest2.activeLockReason)
                && Objects.equals(this.additions, pullRequest2.additions)
                && Objects.equals(this.assignee, pullRequest2.assignee)
                && Objects.equals(this.assignees, pullRequest2.assignees)
                && Objects.equals(this.authorAssociation, pullRequest2.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest2.autoMerge)
                && Objects.equals(this.base, pullRequest2.base)
                && Objects.equals(this.body, pullRequest2.body)
                && Objects.equals(this.changedFiles, pullRequest2.changedFiles)
                && Objects.equals(this.closedAt, pullRequest2.closedAt)
                && Objects.equals(this.comments, pullRequest2.comments)
                && Objects.equals(this.commentsUrl, pullRequest2.commentsUrl)
                && Objects.equals(this.commits, pullRequest2.commits)
                && Objects.equals(this.commitsUrl, pullRequest2.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest2.createdAt)
                && Objects.equals(this.deletions, pullRequest2.deletions)
                && Objects.equals(this.diffUrl, pullRequest2.diffUrl)
                && Objects.equals(this.draft, pullRequest2.draft)
                && Objects.equals(this.head, pullRequest2.head)
                && Objects.equals(this.htmlUrl, pullRequest2.htmlUrl)
                && Objects.equals(this.id, pullRequest2.id)
                && Objects.equals(this.issueUrl, pullRequest2.issueUrl)
                && Objects.equals(this.labels, pullRequest2.labels)
                && Objects.equals(this.locked, pullRequest2.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest2.maintainerCanModify)
                && Objects.equals(this.mergeable, pullRequest2.mergeable)
                && Objects.equals(this.mergeableState, pullRequest2.mergeableState)
                && Objects.equals(this.merged, pullRequest2.merged)
                && Objects.equals(this.mergedAt, pullRequest2.mergedAt)
                && Objects.equals(this.mergedBy, pullRequest2.mergedBy)
                && Objects.equals(this.milestone, pullRequest2.milestone)
                && Objects.equals(this.nodeId, pullRequest2.nodeId)
                && Objects.equals(this.number, pullRequest2.number)
                && Objects.equals(this.patchUrl, pullRequest2.patchUrl)
                && Objects.equals(this.rebaseable, pullRequest2.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest2.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest2.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest2.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest2.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest2.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest2.state)
                && Objects.equals(this.statusesUrl, pullRequest2.statusesUrl)
                && Objects.equals(this.title, pullRequest2.title)
                && Objects.equals(this.updatedAt, pullRequest2.updatedAt)
                && Objects.equals(this.url, pullRequest2.url)
                && Objects.equals(this.user, pullRequest2.user);
    }
