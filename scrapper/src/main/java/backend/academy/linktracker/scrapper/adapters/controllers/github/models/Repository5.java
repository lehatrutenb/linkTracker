 ...
 * A git repository
 */
@Schema(name = "Repository_5", description = "A git repository")
@JsonTypeName("Repository_5")
@Generated(
...
public class Repository5 {
    ...
    public Repository5 allowAutoMerge(Boolean allowAutoMerge) {
    ...
    public Repository5 allowForking(Boolean allowForking) {
    ...
    public Repository5 allowMergeCommit(Boolean allowMergeCommit) {
    ...
    public Repository5 allowRebaseMerge(Boolean allowRebaseMerge) {
    ...
    public Repository5 allowSquashMerge(Boolean allowSquashMerge) {
    ...
    public Repository5 allowUpdateBranch(Boolean allowUpdateBranch) {
    ...
    public Repository5 archiveUrl(String archiveUrl) {
        this.archiveUrl = archiveUrl;
        return this;
    }
    ...
    public Repository5 archived(Boolean archived) {
        this.archived = archived;
        return this;
    }
    ...
    public Repository5 assigneesUrl(String assigneesUrl) {
        this.assigneesUrl = assigneesUrl;
        return this;
    }
    ...
    public Repository5 blobsUrl(String blobsUrl) {
        this.blobsUrl = blobsUrl;
        return this;
    }
    ...
    public Repository5 branchesUrl(String branchesUrl) {
        this.branchesUrl = branchesUrl;
        return this;
    }
    ...
    public Repository5 cloneUrl(URI cloneUrl) {
        this.cloneUrl = cloneUrl;
        return this;
    }
    ...
    public Repository5 collaboratorsUrl(String collaboratorsUrl) {
        this.collaboratorsUrl = collaboratorsUrl;
        return this;
    }
    ...
    public Repository5 commentsUrl(String commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public Repository5 commitsUrl(String commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public Repository5 compareUrl(String compareUrl) {
        this.compareUrl = compareUrl;
        return this;
    }
    ...
    public Repository5 contentsUrl(String contentsUrl) {
        this.contentsUrl = contentsUrl;
        return this;
    }
    ...
    public Repository5 contributorsUrl(URI contributorsUrl) {
        this.contributorsUrl = contributorsUrl;
        return this;
    }
    ...
    public Repository5 createdAt(RepositoryCreatedAt createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Repository5 defaultBranch(String defaultBranch) {
        this.defaultBranch = defaultBranch;
        return this;
    }
    ...
    public Repository5 deleteBranchOnMerge(Boolean deleteBranchOnMerge) {
    ...
    public Repository5 deploymentsUrl(URI deploymentsUrl) {
        this.deploymentsUrl = deploymentsUrl;
        return this;
    }
    ...
    public Repository5 description(String description) {
        this.description = JsonNullable.of(description);
        return this;
    }
    ...
    public Repository5 disabled(Boolean disabled) {
    ...
    public Repository5 downloadsUrl(URI downloadsUrl) {
        this.downloadsUrl = downloadsUrl;
        return this;
    }
    ...
    public Repository5 eventsUrl(URI eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Repository5 fork(Boolean fork) {
        this.fork = fork;
        return this;
    }
    ...
    public Repository5 forks(Long forks) {
        this.forks = forks;
        return this;
    }
    ...
    public Repository5 forksCount(Long forksCount) {
        this.forksCount = forksCount;
        return this;
    }
    ...
    public Repository5 forksUrl(URI forksUrl) {
        this.forksUrl = forksUrl;
        return this;
    }
    ...
    public Repository5 fullName(String fullName) {
        this.fullName = fullName;
        return this;
    }
    ...
    public Repository5 gitCommitsUrl(String gitCommitsUrl) {
        this.gitCommitsUrl = gitCommitsUrl;
        return this;
    }
    ...
    public Repository5 gitRefsUrl(String gitRefsUrl) {
        this.gitRefsUrl = gitRefsUrl;
        return this;
    }
    ...
    public Repository5 gitTagsUrl(String gitTagsUrl) {
        this.gitTagsUrl = gitTagsUrl;
        return this;
    }
    ...
    public Repository5 gitUrl(URI gitUrl) {
        this.gitUrl = gitUrl;
        return this;
    }
    ...
    public Repository5 hasDownloads(Boolean hasDownloads) {
        this.hasDownloads = hasDownloads;
        return this;
    }
    ...
    public Repository5 hasIssues(Boolean hasIssues) {
        this.hasIssues = hasIssues;
        return this;
    }
    ...
    public Repository5 hasDiscussions(Boolean hasDiscussions) {
        this.hasDiscussions = hasDiscussions;
        return this;
    }
    ...
    public Repository5 hasPullRequests(Boolean hasPullRequests) {
    ...
    public Repository5 pullRequestCreationPolicy(PullRequestCreationPolicyEnum pullRequestCreationPolicy) {
    ...
    public Repository5 hasCommitComments(Boolean hasCommitComments) {
    ...
    public Repository5 hasPages(Boolean hasPages) {
        this.hasPages = hasPages;
        return this;
    }
    ...
    public Repository5 hasProjects(Boolean hasProjects) {
        this.hasProjects = hasProjects;
        return this;
    }
    ...
    public Repository5 hasWiki(Boolean hasWiki) {
        this.hasWiki = hasWiki;
        return this;
    }
    ...
    public Repository5 homepage(String homepage) {
        this.homepage = JsonNullable.of(homepage);
        return this;
    }
    ...
    public Repository5 hooksUrl(URI hooksUrl) {
        this.hooksUrl = hooksUrl;
        return this;
    }
    ...
    public Repository5 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Repository5 isTemplate(Boolean isTemplate) {
    ...
    public Repository5 issueCommentUrl(String issueCommentUrl) {
        this.issueCommentUrl = issueCommentUrl;
        return this;
    }
    ...
    public Repository5 issueEventsUrl(String issueEventsUrl) {
        this.issueEventsUrl = issueEventsUrl;
        return this;
    }
    ...
    public Repository5 issuesUrl(String issuesUrl) {
        this.issuesUrl = issuesUrl;
        return this;
    }
    ...
    public Repository5 keysUrl(String keysUrl) {
        this.keysUrl = keysUrl;
        return this;
    }
    ...
    public Repository5 labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public Repository5 language(String language) {
        this.language = JsonNullable.of(language);
        return this;
    }
    ...
    public Repository5 languagesUrl(URI languagesUrl) {
        this.languagesUrl = languagesUrl;
        return this;
    }
    ...
    public Repository5 masterBranch(String masterBranch) {
    ...
    public Repository5 mergeCommitMessage(MergeCommitMessageEnum mergeCommitMessage) {
    ...
    public Repository5 mergeCommitTitle(MergeCommitTitleEnum mergeCommitTitle) {
    ...
    public Repository5 mergesUrl(URI mergesUrl) {
        this.mergesUrl = mergesUrl;
        return this;
    }
    ...
    public Repository5 milestonesUrl(String milestonesUrl) {
        this.milestonesUrl = milestonesUrl;
        return this;
    }
    ...
    public Repository5 mirrorUrl(URI mirrorUrl) {
        this.mirrorUrl = JsonNullable.of(mirrorUrl);
        return this;
    }
    ...
    public Repository5 name(String name) {
        this.name = name;
        return this;
    }
    ...
    public Repository5 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Repository5 notificationsUrl(String notificationsUrl) {
        this.notificationsUrl = notificationsUrl;
        return this;
    }
    ...
    public Repository5 openIssues(Long openIssues) {
        this.openIssues = openIssues;
        return this;
    }
    ...
    public Repository5 openIssuesCount(Long openIssuesCount) {
        this.openIssuesCount = openIssuesCount;
        return this;
    }
    ...
    public Repository5 organization(String organization) {
    ...
    public Repository5 _private(Boolean _private) {
        this._private = _private;
        return this;
    }
    ...
    public Repository5 _public(Boolean _public) {
    ...
    public Repository5 pullsUrl(String pullsUrl) {
        this.pullsUrl = pullsUrl;
        return this;
    }
    ...
    public Repository5 pushedAt(RepositoryPushedAt pushedAt) {
        this.pushedAt = JsonNullable.of(pushedAt);
        return this;
    }
    ...
    public Repository5 releasesUrl(String releasesUrl) {
        this.releasesUrl = releasesUrl;
        return this;
    }
    ...
    public Repository5 roleName(String roleName) {
    ...
    public Repository5 size(Long size) {
        this.size = size;
        return this;
    }
    ...
    public Repository5 squashMergeCommitMessage(SquashMergeCommitMessageEnum squashMergeCommitMessage) {
    ...
    public Repository5 squashMergeCommitTitle(SquashMergeCommitTitleEnum squashMergeCommitTitle) {
    ...
    public Repository5 sshUrl(String sshUrl) {
        this.sshUrl = sshUrl;
        return this;
    }
    ...
    public Repository5 stargazers(Long stargazers) {
    ...
    public Repository5 stargazersCount(Long stargazersCount) {
        this.stargazersCount = stargazersCount;
        return this;
    }
    ...
    public Repository5 stargazersUrl(URI stargazersUrl) {
        this.stargazersUrl = stargazersUrl;
        return this;
    }
    ...
    public Repository5 statusesUrl(String statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public Repository5 subscribersUrl(URI subscribersUrl) {
        this.subscribersUrl = subscribersUrl;
        return this;
    }
    ...
    public Repository5 subscriptionUrl(URI subscriptionUrl) {
        this.subscriptionUrl = subscriptionUrl;
        return this;
    }
    ...
    public Repository5 svnUrl(URI svnUrl) {
        this.svnUrl = svnUrl;
        return this;
    }
    ...
    public Repository5 tagsUrl(URI tagsUrl) {
        this.tagsUrl = tagsUrl;
        return this;
    }
    ...
    public Repository5 teamsUrl(URI teamsUrl) {
        this.teamsUrl = teamsUrl;
        return this;
    }
    ...
    public Repository5 topics(List<String> topics) {
        this.topics = topics;
        return this;
    }

    public Repository5 addTopicsItem(String topicsItem) {
        if (this.topics == null) {
    ...
    public Repository5 treesUrl(String treesUrl) {
        this.treesUrl = treesUrl;
        return this;
    }
    ...
    public Repository5 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Repository5 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public Repository5 visibility(VisibilityEnum visibility) {
        this.visibility = visibility;
        return this;
    }
    ...
    public Repository5 watchers(Long watchers) {
        this.watchers = watchers;
        return this;
    }
    ...
    public Repository5 watchersCount(Long watchersCount) {
        this.watchersCount = watchersCount;
        return this;
    }
    ...
    public Repository5 webCommitSignoffRequired(Boolean webCommitSignoffRequired) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.allowAutoMerge, repository5.allowAutoMerge)
                ...
                && Objects.equals(this.hasDiscussions, repository5.hasDiscussions)
                && Objects.equals(this.hasPullRequests, repository5.hasPullRequests)
                && Objects.equals(this.pullRequestCreationPolicy, repository5.pullRequestCreationPolicy)
                && Objects.equals(this.hasCommitComments, repository5.hasCommitComments)
                ...
                && equalsNullable(this.roleName, repository5.roleName)
