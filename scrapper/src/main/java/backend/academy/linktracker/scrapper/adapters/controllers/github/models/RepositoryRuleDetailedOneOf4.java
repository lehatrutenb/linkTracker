 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_4")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf4 implements RepositoryRuleDetailed {
    ...
    private Optional<RepositoryRuleMergeQueueParameters> parameters = Optional.empty();
    ...
    public RepositoryRuleDetailedOneOf4() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf4(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf4 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf4 parameters(RepositoryRuleMergeQueueParameters parameters) {
    ...
    public Optional<RepositoryRuleMergeQueueParameters> getParameters() {
        return parameters;
    }

    public void setParameters(Optional<RepositoryRuleMergeQueueParameters> parameters) {
        this.parameters = parameters;
    }

    public RepositoryRuleDetailedOneOf4 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf4 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf4 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf4 repositoryRuleDetailedOneOf4 = (RepositoryRuleDetailedOneOf4) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf4.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf4.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf4.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf4.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf4.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf4 {\n");
