package backend.academy.linktracker.scrapper.adapter.exception;

import backend.academy.linktracker.scrapper.usecase.dto.generated.ApiErrorResponse;
import backend.academy.linktracker.scrapper.usecase.exception.ConflictException;
import backend.academy.linktracker.scrapper.usecase.exception.DomainException;
import backend.academy.linktracker.scrapper.usecase.exception.NotFoundException;
import backend.academy.linktracker.scrapper.usecase.exception.ValidationException;
