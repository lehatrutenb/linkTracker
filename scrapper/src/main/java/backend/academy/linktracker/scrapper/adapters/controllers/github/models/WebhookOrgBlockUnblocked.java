...
public class WebhookOrgBlockUnblocked {
    ...
    public WebhookOrgBlockUnblocked action(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public WebhookOrgBlockUnblocked organization(OrganizationSimpleWebhooks organization) {
        this.organization = organization;
        return this;
    }
    ...
    public WebhookOrgBlockUnblocked sender(SimpleUser sender) {
        this.sender = sender;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhookOrgBlockUnblocked webhookOrgBlockUnblocked = (WebhookOrgBlockUnblocked) o;
        return Objects.equals(this.action, webhookOrgBlockUnblocked.action)
                && Objects.equals(this.blockedUser, webhookOrgBlockUnblocked.blockedUser)
                && Objects.equals(this.enterprise, webhookOrgBlockUnblocked.enterprise)
                && Objects.equals(this.installation, webhookOrgBlockUnblocked.installation)
                && Objects.equals(this.organization, webhookOrgBlockUnblocked.organization)
                && Objects.equals(this.repository, webhookOrgBlockUnblocked.repository)
                && Objects.equals(this.sender, webhookOrgBlockUnblocked.sender);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhookOrgBlockUnblocked {\n");
