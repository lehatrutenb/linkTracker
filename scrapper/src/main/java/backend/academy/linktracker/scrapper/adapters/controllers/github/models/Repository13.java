 ...
 * A git repository
 */
@Schema(name = "Repository_13", description = "A git repository")
@JsonTypeName("Repository_13")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class Repository13 {
    ...
    public Repository13 allowAutoMerge(Boolean allowAutoMerge) {
    ...
    public Repository13 allowForking(Boolean allowForking) {
    ...
    public Repository13 allowMergeCommit(Boolean allowMergeCommit) {
    ...
    public Repository13 allowRebaseMerge(Boolean allowRebaseMerge) {
    ...
    public Repository13 allowSquashMerge(Boolean allowSquashMerge) {
    ...
    public Repository13 allowUpdateBranch(Boolean allowUpdateBranch) {
    ...
    public Repository13 archiveUrl(String archiveUrl) {
        this.archiveUrl = archiveUrl;
        return this;
    }
    ...
    public Repository13 archived(Boolean archived) {
        this.archived = archived;
        return this;
    }
    ...
    public Repository13 assigneesUrl(String assigneesUrl) {
        this.assigneesUrl = assigneesUrl;
        return this;
    }
    ...
    public Repository13 blobsUrl(String blobsUrl) {
        this.blobsUrl = blobsUrl;
        return this;
    }
    ...
    public Repository13 branchesUrl(String branchesUrl) {
        this.branchesUrl = branchesUrl;
        return this;
    }
    ...
    public Repository13 cloneUrl(URI cloneUrl) {
        this.cloneUrl = cloneUrl;
        return this;
    }
    ...
    public Repository13 collaboratorsUrl(String collaboratorsUrl) {
        this.collaboratorsUrl = collaboratorsUrl;
        return this;
    }
    ...
    public Repository13 commentsUrl(String commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public Repository13 commitsUrl(String commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public Repository13 compareUrl(String compareUrl) {
        this.compareUrl = compareUrl;
        return this;
    }
    ...
    public Repository13 contentsUrl(String contentsUrl) {
        this.contentsUrl = contentsUrl;
        return this;
    }
    ...
    public Repository13 contributorsUrl(URI contributorsUrl) {
        this.contributorsUrl = contributorsUrl;
        return this;
    }
    ...
    public Repository13 createdAt(RepositoryCreatedAt createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Repository13 defaultBranch(String defaultBranch) {
        this.defaultBranch = defaultBranch;
        return this;
    }
    ...
    public Repository13 deleteBranchOnMerge(Boolean deleteBranchOnMerge) {
    ...
    public Repository13 deploymentsUrl(URI deploymentsUrl) {
        this.deploymentsUrl = deploymentsUrl;
        return this;
    }
    ...
    public Repository13 description(String description) {
        this.description = description;
        return this;
    }
    ...
    public Repository13 disabled(Boolean disabled) {
    ...
    public Repository13 downloadsUrl(URI downloadsUrl) {
        this.downloadsUrl = downloadsUrl;
        return this;
    }
    ...
    public Repository13 eventsUrl(URI eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Repository13 fork(Boolean fork) {
        this.fork = fork;
        return this;
    }
    ...
    public Repository13 forks(Long forks) {
        this.forks = forks;
        return this;
    }
    ...
    public Repository13 forksCount(Long forksCount) {
        this.forksCount = forksCount;
        return this;
    }
    ...
    public Repository13 forksUrl(URI forksUrl) {
        this.forksUrl = forksUrl;
        return this;
    }
    ...
    public Repository13 fullName(String fullName) {
        this.fullName = fullName;
        return this;
    }
    ...
    public Repository13 gitCommitsUrl(String gitCommitsUrl) {
        this.gitCommitsUrl = gitCommitsUrl;
        return this;
    }
    ...
    public Repository13 gitRefsUrl(String gitRefsUrl) {
        this.gitRefsUrl = gitRefsUrl;
        return this;
    }
    ...
    public Repository13 gitTagsUrl(String gitTagsUrl) {
        this.gitTagsUrl = gitTagsUrl;
        return this;
    }
    ...
    public Repository13 gitUrl(URI gitUrl) {
        this.gitUrl = gitUrl;
        return this;
    }
    ...
    public Repository13 hasDownloads(Boolean hasDownloads) {
        this.hasDownloads = hasDownloads;
        return this;
    }
    ...
    public Repository13 hasIssues(Boolean hasIssues) {
        this.hasIssues = hasIssues;
        return this;
    }
    ...
    public Repository13 hasPages(Boolean hasPages) {
        this.hasPages = hasPages;
        return this;
    }
    ...
    public Repository13 hasProjects(Boolean hasProjects) {
        this.hasProjects = hasProjects;
        return this;
    }
    ...
    public Repository13 hasWiki(Boolean hasWiki) {
        this.hasWiki = hasWiki;
        return this;
    }
    ...
    public Repository13 hasDiscussions(Boolean hasDiscussions) {
        this.hasDiscussions = hasDiscussions;
        return this;
    }
    ...
    public Repository13 hasPullRequests(Boolean hasPullRequests) {
    ...
    public Repository13 pullRequestCreationPolicy(PullRequestCreationPolicyEnum pullRequestCreationPolicy) {
    ...
    public Repository13 hasCommitComments(Boolean hasCommitComments) {
    ...
    public Repository13 homepage(String homepage) {
        this.homepage = homepage;
        return this;
    }
    ...
    public Repository13 hooksUrl(URI hooksUrl) {
        this.hooksUrl = hooksUrl;
        return this;
    }
    ...
    public Repository13 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Repository13 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public Repository13 isTemplate(Boolean isTemplate) {
    ...
    public Repository13 issueCommentUrl(String issueCommentUrl) {
        this.issueCommentUrl = issueCommentUrl;
        return this;
    }
    ...
    public Repository13 issueEventsUrl(String issueEventsUrl) {
        this.issueEventsUrl = issueEventsUrl;
        return this;
    }
    ...
    public Repository13 issuesUrl(String issuesUrl) {
        this.issuesUrl = issuesUrl;
        return this;
    }
    ...
    public Repository13 keysUrl(String keysUrl) {
        this.keysUrl = keysUrl;
        return this;
    }
    ...
    public Repository13 labelsUrl(String labelsUrl) {
        this.labelsUrl = labelsUrl;
        return this;
    }
    ...
    public Repository13 language(String language) {
        this.language = language;
        return this;
    }
    ...
    public Repository13 languagesUrl(URI languagesUrl) {
        this.languagesUrl = languagesUrl;
        return this;
    }
    ...
    public Repository13 license(License license) {
        this.license = license;
        return this;
    }
    ...
    public Repository13 masterBranch(String masterBranch) {
    ...
    public Repository13 mergesUrl(URI mergesUrl) {
        this.mergesUrl = mergesUrl;
        return this;
    }
    ...
    public Repository13 milestonesUrl(String milestonesUrl) {
        this.milestonesUrl = milestonesUrl;
        return this;
    }
    ...
    public Repository13 mirrorUrl(URI mirrorUrl) {
        this.mirrorUrl = mirrorUrl;
        return this;
    }
    ...
    public Repository13 name(String name) {
        this.name = name;
        return this;
    }
    ...
    public Repository13 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Repository13 notificationsUrl(String notificationsUrl) {
        this.notificationsUrl = notificationsUrl;
        return this;
    }
    ...
    public Repository13 openIssues(Long openIssues) {
        this.openIssues = openIssues;
        return this;
    }
    ...
    public Repository13 openIssuesCount(Long openIssuesCount) {
        this.openIssuesCount = openIssuesCount;
        return this;
    }
    ...
    public Repository13 organization(String organization) {
    ...
    public Repository13 owner(User owner) {
        this.owner = owner;
        return this;
    }
    ...
    public Repository13 permissions(RepositoryPermissions permissions) {
    ...
    public Repository13 _private(Boolean _private) {
        this._private = _private;
        return this;
    }
    ...
    public Repository13 _public(Boolean _public) {
    ...
    public Repository13 pullsUrl(String pullsUrl) {
        this.pullsUrl = pullsUrl;
        return this;
    }
    ...
    public Repository13 pushedAt(RepositoryPushedAt pushedAt) {
        this.pushedAt = pushedAt;
        return this;
    }
    ...
    public Repository13 releasesUrl(String releasesUrl) {
        this.releasesUrl = releasesUrl;
        return this;
    }
    ...
    public Repository13 roleName(String roleName) {
    ...
    public Repository13 size(Long size) {
        this.size = size;
        return this;
    }
    ...
    public Repository13 sshUrl(String sshUrl) {
        this.sshUrl = sshUrl;
        return this;
    }
    ...
    public Repository13 stargazers(Long stargazers) {
    ...
    public Repository13 stargazersCount(Long stargazersCount) {
        this.stargazersCount = stargazersCount;
        return this;
    }
    ...
    public Repository13 stargazersUrl(URI stargazersUrl) {
        this.stargazersUrl = stargazersUrl;
        return this;
    }
    ...
    public Repository13 statusesUrl(String statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public Repository13 subscribersUrl(URI subscribersUrl) {
        this.subscribersUrl = subscribersUrl;
        return this;
    }
    ...
    public Repository13 subscriptionUrl(URI subscriptionUrl) {
        this.subscriptionUrl = subscriptionUrl;
        return this;
    }
    ...
    public Repository13 svnUrl(URI svnUrl) {
        this.svnUrl = svnUrl;
        return this;
    }
    ...
    public Repository13 tagsUrl(URI tagsUrl) {
        this.tagsUrl = tagsUrl;
        return this;
    }
    ...
    public Repository13 teamsUrl(URI teamsUrl) {
        this.teamsUrl = teamsUrl;
        return this;
    }
    ...
    public Repository13 topics(List<String> topics) {
        this.topics = topics;
        return this;
    }

    public Repository13 addTopicsItem(String topicsItem) {
        if (this.topics == null) {
    ...
    public Repository13 treesUrl(String treesUrl) {
        this.treesUrl = treesUrl;
        return this;
    }
    ...
    public Repository13 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Repository13 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public Repository13 visibility(VisibilityEnum visibility) {
        this.visibility = visibility;
        return this;
    }
    ...
    public Repository13 watchers(Long watchers) {
        this.watchers = watchers;
        return this;
    }
    ...
    public Repository13 watchersCount(Long watchersCount) {
        this.watchersCount = watchersCount;
        return this;
    }
    ...
    public Repository13 webCommitSignoffRequired(Boolean webCommitSignoffRequired) {
    ...
    public boolean equals(Object o) {
        ...
        Repository13 repository13 = (Repository13) o;
        return Objects.equals(this.allowAutoMerge, repository13.allowAutoMerge)
                && Objects.equals(this.allowForking, repository13.allowForking)
                && Objects.equals(this.allowMergeCommit, repository13.allowMergeCommit)
                && Objects.equals(this.allowRebaseMerge, repository13.allowRebaseMerge)
                && Objects.equals(this.allowSquashMerge, repository13.allowSquashMerge)
                && Objects.equals(this.allowUpdateBranch, repository13.allowUpdateBranch)
                && Objects.equals(this.archiveUrl, repository13.archiveUrl)
                && Objects.equals(this.archived, repository13.archived)
                && Objects.equals(this.assigneesUrl, repository13.assigneesUrl)
                && Objects.equals(this.blobsUrl, repository13.blobsUrl)
                && Objects.equals(this.branchesUrl, repository13.branchesUrl)
                && Objects.equals(this.cloneUrl, repository13.cloneUrl)
                && Objects.equals(this.collaboratorsUrl, repository13.collaboratorsUrl)
                && Objects.equals(this.commentsUrl, repository13.commentsUrl)
                && Objects.equals(this.commitsUrl, repository13.commitsUrl)
                && Objects.equals(this.compareUrl, repository13.compareUrl)
                && Objects.equals(this.contentsUrl, repository13.contentsUrl)
                && Objects.equals(this.contributorsUrl, repository13.contributorsUrl)
                && Objects.equals(this.createdAt, repository13.createdAt)
                && Objects.equals(this.defaultBranch, repository13.defaultBranch)
                && Objects.equals(this.deleteBranchOnMerge, repository13.deleteBranchOnMerge)
                && Objects.equals(this.deploymentsUrl, repository13.deploymentsUrl)
                && Objects.equals(this.description, repository13.description)
                && Objects.equals(this.disabled, repository13.disabled)
                && Objects.equals(this.downloadsUrl, repository13.downloadsUrl)
                && Objects.equals(this.eventsUrl, repository13.eventsUrl)
                && Objects.equals(this.fork, repository13.fork)
                && Objects.equals(this.forks, repository13.forks)
                && Objects.equals(this.forksCount, repository13.forksCount)
                && Objects.equals(this.forksUrl, repository13.forksUrl)
                && Objects.equals(this.fullName, repository13.fullName)
                && Objects.equals(this.gitCommitsUrl, repository13.gitCommitsUrl)
                && Objects.equals(this.gitRefsUrl, repository13.gitRefsUrl)
                && Objects.equals(this.gitTagsUrl, repository13.gitTagsUrl)
                && Objects.equals(this.gitUrl, repository13.gitUrl)
                && Objects.equals(this.hasDownloads, repository13.hasDownloads)
                && Objects.equals(this.hasIssues, repository13.hasIssues)
                && Objects.equals(this.hasPages, repository13.hasPages)
                && Objects.equals(this.hasProjects, repository13.hasProjects)
                && Objects.equals(this.hasWiki, repository13.hasWiki)
                && Objects.equals(this.hasDiscussions, repository13.hasDiscussions)
                && Objects.equals(this.hasPullRequests, repository13.hasPullRequests)
                && Objects.equals(this.pullRequestCreationPolicy, repository13.pullRequestCreationPolicy)
                && Objects.equals(this.hasCommitComments, repository13.hasCommitComments)
                && Objects.equals(this.homepage, repository13.homepage)
                && Objects.equals(this.hooksUrl, repository13.hooksUrl)
                && Objects.equals(this.htmlUrl, repository13.htmlUrl)
                && Objects.equals(this.id, repository13.id)
                && Objects.equals(this.isTemplate, repository13.isTemplate)
                && Objects.equals(this.issueCommentUrl, repository13.issueCommentUrl)
                && Objects.equals(this.issueEventsUrl, repository13.issueEventsUrl)
                && Objects.equals(this.issuesUrl, repository13.issuesUrl)
                && Objects.equals(this.keysUrl, repository13.keysUrl)
                && Objects.equals(this.labelsUrl, repository13.labelsUrl)
                && Objects.equals(this.language, repository13.language)
                && Objects.equals(this.languagesUrl, repository13.languagesUrl)
                && Objects.equals(this.license, repository13.license)
                && Objects.equals(this.masterBranch, repository13.masterBranch)
                && Objects.equals(this.mergesUrl, repository13.mergesUrl)
                && Objects.equals(this.milestonesUrl, repository13.milestonesUrl)
                && Objects.equals(this.mirrorUrl, repository13.mirrorUrl)
                && Objects.equals(this.name, repository13.name)
                && Objects.equals(this.nodeId, repository13.nodeId)
                && Objects.equals(this.notificationsUrl, repository13.notificationsUrl)
                && Objects.equals(this.openIssues, repository13.openIssues)
                && Objects.equals(this.openIssuesCount, repository13.openIssuesCount)
                && Objects.equals(this.organization, repository13.organization)
                && Objects.equals(this.owner, repository13.owner)
                && Objects.equals(this.permissions, repository13.permissions)
                && Objects.equals(this._private, repository13._private)
                && Objects.equals(this._public, repository13._public)
                && Objects.equals(this.pullsUrl, repository13.pullsUrl)
                && Objects.equals(this.pushedAt, repository13.pushedAt)
                && Objects.equals(this.releasesUrl, repository13.releasesUrl)
                && Objects.equals(this.roleName, repository13.roleName)
                && Objects.equals(this.size, repository13.size)
                && Objects.equals(this.sshUrl, repository13.sshUrl)
                && Objects.equals(this.stargazers, repository13.stargazers)
                && Objects.equals(this.stargazersCount, repository13.stargazersCount)
                && Objects.equals(this.stargazersUrl, repository13.stargazersUrl)
                && Objects.equals(this.statusesUrl, repository13.statusesUrl)
                && Objects.equals(this.subscribersUrl, repository13.subscribersUrl)
                && Objects.equals(this.subscriptionUrl, repository13.subscriptionUrl)
                && Objects.equals(this.svnUrl, repository13.svnUrl)
                && Objects.equals(this.tagsUrl, repository13.tagsUrl)
                && Objects.equals(this.teamsUrl, repository13.teamsUrl)
                && Objects.equals(this.topics, repository13.topics)
                && Objects.equals(this.treesUrl, repository13.treesUrl)
                && Objects.equals(this.updatedAt, repository13.updatedAt)
                && Objects.equals(this.url, repository13.url)
                && Objects.equals(this.visibility, repository13.visibility)
                && Objects.equals(this.watchers, repository13.watchers)
                && Objects.equals(this.watchersCount, repository13.watchersCount)
                && Objects.equals(this.webCommitSignoffRequired, repository13.webCommitSignoffRequired);
    }
