 ...
 */
@Schema(name = "GitHub_app_permissions", description = "The set of permissions for the GitHub app")
@JsonTypeName("GitHub_app_permissions")
@Generated(
...
public class GitHubAppPermissions {
    ...
    public GitHubAppPermissions issues(String issues) {
    ...
    public GitHubAppPermissions checks(String checks) {
    ...
    public GitHubAppPermissions metadata(String metadata) {
    ...
    public GitHubAppPermissions contents(String contents) {
    ...
    public GitHubAppPermissions deployments(String deployments) {
     ...
     */
    @JsonAnySetter
    public GitHubAppPermissions putAdditionalProperty(String key, String value) {
    ...
    public boolean equals(Object o) {
        ...
        GitHubAppPermissions gitHubAppPermissions = (GitHubAppPermissions) o;
        return Objects.equals(this.issues, gitHubAppPermissions.issues)
                && Objects.equals(this.checks, gitHubAppPermissions.checks)
                && Objects.equals(this.metadata, gitHubAppPermissions.metadata)
                && Objects.equals(this.contents, gitHubAppPermissions.contents)
                && Objects.equals(this.deployments, gitHubAppPermissions.deployments)
                && Objects.equals(this.additionalProperties, gitHubAppPermissions.additionalProperties);
    }
