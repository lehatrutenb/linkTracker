 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_1")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf1 implements RepositoryRuleDetailed {
    ...
    private Optional<RepositoryRuleUpdateParameters> parameters = Optional.empty();
    ...
    public RepositoryRuleDetailedOneOf1() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf1(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf1 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf1 parameters(RepositoryRuleUpdateParameters parameters) {
    ...
    public Optional<RepositoryRuleUpdateParameters> getParameters() {
        return parameters;
    }

    public void setParameters(Optional<RepositoryRuleUpdateParameters> parameters) {
        this.parameters = parameters;
    }

    public RepositoryRuleDetailedOneOf1 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf1 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf1 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf1 repositoryRuleDetailedOneOf1 = (RepositoryRuleDetailedOneOf1) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf1.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf1.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf1.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf1.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf1.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf1 {\n");
