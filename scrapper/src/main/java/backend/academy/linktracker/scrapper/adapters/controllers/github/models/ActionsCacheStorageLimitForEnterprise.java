 ...
 */
@Schema(
        name = "actions-cache-storage-limit-for-enterprise",
        description = "GitHub Actions cache storage policy for an enterprise.")
@JsonTypeName("actions-cache-storage-limit-for-enterprise")
@Generated(
...
public class ActionsCacheStorageLimitForEnterprise {
    ...
    public ActionsCacheStorageLimitForEnterprise maxCacheSizeGb(Long maxCacheSizeGb) {
    ...
    public boolean equals(Object o) {
        ...
        ActionsCacheStorageLimitForEnterprise actionsCacheStorageLimitForEnterprise =
                (ActionsCacheStorageLimitForEnterprise) o;
        return Objects.equals(this.maxCacheSizeGb, actionsCacheStorageLimitForEnterprise.maxCacheSizeGb);
    }
    ...
    public String toString() {
        ...
        sb.append("class ActionsCacheStorageLimitForEnterprise {\n");
