 ...
 */
@JsonTypeName("webhook-projects-v2-item-restored")
@Generated(
...
public class WebhookProjectsV2ItemRestored {
    ...
    public WebhookProjectsV2ItemRestored changes(WebhooksProjectChanges changes) {
        this.changes = changes;
        return this;
    }
    ...
    public WebhookProjectsV2ItemRestored organization(OrganizationSimpleWebhooks organization) {
        this.organization = organization;
        return this;
    }
