...
public class HostedComputeUpdateNetworkConfigurationForOrgRequest {
    ...
    public HostedComputeUpdateNetworkConfigurationForOrgRequest networkSettingsIds(List<String> networkSettingsIds) {
        this.networkSettingsIds = networkSettingsIds;
        return this;
    }

    public HostedComputeUpdateNetworkConfigurationForOrgRequest addNetworkSettingsIdsItem(
    ...
    public boolean equals(Object o) {
        ...
        HostedComputeUpdateNetworkConfigurationForOrgRequest hostedComputeUpdateNetworkConfigurationForOrgRequest =
                (HostedComputeUpdateNetworkConfigurationForOrgRequest) o;
        return Objects.equals(this.name, hostedComputeUpdateNetworkConfigurationForOrgRequest.name)
                && Objects.equals(
                        this.computeService, hostedComputeUpdateNetworkConfigurationForOrgRequest.computeService)
                && Objects.equals(
                        this.networkSettingsIds,
                        hostedComputeUpdateNetworkConfigurationForOrgRequest.networkSettingsIds);
    }
    ...
    public String toString() {
        ...
        sb.append("class HostedComputeUpdateNetworkConfigurationForOrgRequest {\n");
