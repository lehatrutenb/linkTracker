...
public class WebhookProjectCardDeleted {
     ...
     */
    public WebhookProjectCardDeleted(ActionEnum action, ProjectCard projectCard, SimpleUser sender) {
        this.action = action;
    ...
    public WebhookProjectCardDeleted projectCard(ProjectCard projectCard) {
        this.projectCard = projectCard;
        return this;
    }
