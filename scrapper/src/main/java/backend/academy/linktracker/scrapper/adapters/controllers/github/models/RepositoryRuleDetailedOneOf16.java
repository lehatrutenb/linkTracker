 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_16")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf16 implements RepositoryRuleDetailed {
    ...
    private Optional<RepositoryRuleMaxFilePathLengthParameters> parameters = Optional.empty();
    ...
    public RepositoryRuleDetailedOneOf16() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf16(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf16 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf16 parameters(RepositoryRuleMaxFilePathLengthParameters parameters) {
    ...
    public Optional<RepositoryRuleMaxFilePathLengthParameters> getParameters() {
        return parameters;
    }

    public void setParameters(Optional<RepositoryRuleMaxFilePathLengthParameters> parameters) {
        this.parameters = parameters;
    }

    public RepositoryRuleDetailedOneOf16 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf16 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf16 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf16 repositoryRuleDetailedOneOf16 = (RepositoryRuleDetailedOneOf16) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf16.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf16.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf16.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf16.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf16.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf16 {\n");
