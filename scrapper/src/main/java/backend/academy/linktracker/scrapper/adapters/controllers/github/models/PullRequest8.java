 ...
 * PullRequest8
 */
@JsonTypeName("Pull_Request_8")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class PullRequest8 {
    ...
    @Valid
    private List<@Valid User4> assignees = new ArrayList<>();
    ...
    public PullRequest8 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest8 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public PullRequest8 additions(Long additions) {
    ...
    public PullRequest8 assignee(User4 assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public PullRequest8 assignees(List<@Valid User4> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest8 addAssigneesItem(User4 assigneesItem) {
    ...
    public List<@Valid User4> getAssignees() {
        return assignees;
    }

    public void setAssignees(List<@Valid User4> assignees) {
        this.assignees = assignees;
    }

    public PullRequest8 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest8 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public PullRequest8 base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public PullRequest8 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public PullRequest8 changedFiles(Long changedFiles) {
    ...
    public PullRequest8 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public PullRequest8 comments(Long comments) {
    ...
    public PullRequest8 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest8 commits(Long commits) {
    ...
    public PullRequest8 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest8 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest8 deletions(Long deletions) {
    ...
    public PullRequest8 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest8 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest8 head(PullRequestBase head) {
        this.head = head;
        return this;
    }
    ...
    public PullRequest8 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest8 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest8 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest8 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest8 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest8 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest8 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest8 mergeable(Boolean mergeable) {
    ...
    public PullRequest8 mergeableState(String mergeableState) {
    ...
    public PullRequest8 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public PullRequest8 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public PullRequest8 mergedBy(User mergedBy) {
    ...
    public PullRequest8 milestone(Milestone milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public PullRequest8 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest8 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest8 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest8 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest8 requestedReviewers(List<PullRequest6RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest8 addRequestedReviewersItem(PullRequest6RequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest8 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest8 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public PullRequest8 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest8 reviewComments(Long reviewComments) {
    ...
    public PullRequest8 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest8 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest8 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest8 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest8 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest8 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest8 user(User3 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest8 pullRequest8 = (PullRequest8) o;
        return Objects.equals(this.links, pullRequest8.links)
                && Objects.equals(this.activeLockReason, pullRequest8.activeLockReason)
                && Objects.equals(this.additions, pullRequest8.additions)
                && Objects.equals(this.assignee, pullRequest8.assignee)
                && Objects.equals(this.assignees, pullRequest8.assignees)
                && Objects.equals(this.authorAssociation, pullRequest8.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest8.autoMerge)
                && Objects.equals(this.base, pullRequest8.base)
                && Objects.equals(this.body, pullRequest8.body)
                && Objects.equals(this.changedFiles, pullRequest8.changedFiles)
                && Objects.equals(this.closedAt, pullRequest8.closedAt)
                && Objects.equals(this.comments, pullRequest8.comments)
                && Objects.equals(this.commentsUrl, pullRequest8.commentsUrl)
                && Objects.equals(this.commits, pullRequest8.commits)
                && Objects.equals(this.commitsUrl, pullRequest8.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest8.createdAt)
                && Objects.equals(this.deletions, pullRequest8.deletions)
                && Objects.equals(this.diffUrl, pullRequest8.diffUrl)
                && Objects.equals(this.draft, pullRequest8.draft)
                && Objects.equals(this.head, pullRequest8.head)
                && Objects.equals(this.htmlUrl, pullRequest8.htmlUrl)
                && Objects.equals(this.id, pullRequest8.id)
                && Objects.equals(this.issueUrl, pullRequest8.issueUrl)
                && Objects.equals(this.labels, pullRequest8.labels)
                && Objects.equals(this.locked, pullRequest8.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest8.maintainerCanModify)
                && Objects.equals(this.mergeable, pullRequest8.mergeable)
                && Objects.equals(this.mergeableState, pullRequest8.mergeableState)
                && Objects.equals(this.merged, pullRequest8.merged)
                && Objects.equals(this.mergedAt, pullRequest8.mergedAt)
                && Objects.equals(this.mergedBy, pullRequest8.mergedBy)
                && Objects.equals(this.milestone, pullRequest8.milestone)
                && Objects.equals(this.nodeId, pullRequest8.nodeId)
                && Objects.equals(this.number, pullRequest8.number)
                && Objects.equals(this.patchUrl, pullRequest8.patchUrl)
                && Objects.equals(this.rebaseable, pullRequest8.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest8.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest8.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest8.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest8.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest8.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest8.state)
                && Objects.equals(this.statusesUrl, pullRequest8.statusesUrl)
                && Objects.equals(this.title, pullRequest8.title)
                && Objects.equals(this.updatedAt, pullRequest8.updatedAt)
                && Objects.equals(this.url, pullRequest8.url)
                && Objects.equals(this.user, pullRequest8.user);
    }
