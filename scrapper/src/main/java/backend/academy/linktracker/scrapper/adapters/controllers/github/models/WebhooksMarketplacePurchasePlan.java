 ...
 */
@JsonTypeName("webhooks_marketplace_purchase_plan")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhooksMarketplacePurchasePlan {
    ...
    public WebhooksMarketplacePurchasePlan bullets(List<String> bullets) {
        this.bullets = bullets;
        return this;
    }

    public WebhooksMarketplacePurchasePlan addBulletsItem(String bulletsItem) {
    ...
    public WebhooksMarketplacePurchasePlan description(String description) {
        this.description = description;
        return this;
    }
    ...
    public WebhooksMarketplacePurchasePlan hasFreeTrial(Boolean hasFreeTrial) {
        this.hasFreeTrial = hasFreeTrial;
        return this;
    }
    ...
    public WebhooksMarketplacePurchasePlan id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public WebhooksMarketplacePurchasePlan monthlyPriceInCents(Long monthlyPriceInCents) {
        this.monthlyPriceInCents = monthlyPriceInCents;
        return this;
    }
    ...
    public WebhooksMarketplacePurchasePlan name(String name) {
        this.name = name;
        return this;
    }
    ...
    public WebhooksMarketplacePurchasePlan priceModel(PriceModelEnum priceModel) {
        this.priceModel = priceModel;
        return this;
    }
    ...
    public WebhooksMarketplacePurchasePlan unitName(String unitName) {
        this.unitName = JsonNullable.of(unitName);
        return this;
    }
    ...
    public WebhooksMarketplacePurchasePlan yearlyPriceInCents(Long yearlyPriceInCents) {
        this.yearlyPriceInCents = yearlyPriceInCents;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhooksMarketplacePurchasePlan webhooksMarketplacePurchasePlan = (WebhooksMarketplacePurchasePlan) o;
        return Objects.equals(this.bullets, webhooksMarketplacePurchasePlan.bullets)
                && Objects.equals(this.description, webhooksMarketplacePurchasePlan.description)
                && Objects.equals(this.hasFreeTrial, webhooksMarketplacePurchasePlan.hasFreeTrial)
                && Objects.equals(this.id, webhooksMarketplacePurchasePlan.id)
                && Objects.equals(this.monthlyPriceInCents, webhooksMarketplacePurchasePlan.monthlyPriceInCents)
                && Objects.equals(this.name, webhooksMarketplacePurchasePlan.name)
                && Objects.equals(this.priceModel, webhooksMarketplacePurchasePlan.priceModel)
                && Objects.equals(this.unitName, webhooksMarketplacePurchasePlan.unitName)
                && Objects.equals(this.yearlyPriceInCents, webhooksMarketplacePurchasePlan.yearlyPriceInCents);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhooksMarketplacePurchasePlan {\n");
