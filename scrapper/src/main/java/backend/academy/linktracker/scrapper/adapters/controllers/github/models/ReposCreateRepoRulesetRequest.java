...
public class ReposCreateRepoRulesetRequest {
     ...
     */
    public ReposCreateRepoRulesetRequest(String name, RepositoryRuleEnforcement enforcement) {
        this.name = name;
    ...
    public ReposCreateRepoRulesetRequest bypassActors(List<@Valid RepositoryRulesetBypassActor> bypassActors) {
    ...
    public ReposCreateRepoRulesetRequest rules(List<@Valid RepositoryRule> rules) {
        this.rules = rules;
        return this;
    }
