 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf_7")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf7 implements RepositoryRuleDetailed {
    ...
    private Optional<RepositoryRulePullRequestParameters> parameters = Optional.empty();
    ...
    public RepositoryRuleDetailedOneOf7() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf7(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf7 type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf7 parameters(RepositoryRulePullRequestParameters parameters) {
    ...
    public Optional<RepositoryRulePullRequestParameters> getParameters() {
        return parameters;
    }

    public void setParameters(Optional<RepositoryRulePullRequestParameters> parameters) {
        this.parameters = parameters;
    }

    public RepositoryRuleDetailedOneOf7 rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf7 rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf7 rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf7 repositoryRuleDetailedOneOf7 = (RepositoryRuleDetailedOneOf7) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf7.type)
                && Objects.equals(this.parameters, repositoryRuleDetailedOneOf7.parameters)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf7.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf7.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf7.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf7 {\n");
