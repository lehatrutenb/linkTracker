...
public class PullRequest7 {
    ...
    public PullRequest7 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest7 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = JsonNullable.of(activeLockReason);
        return this;
    }
    ...
    public PullRequest7 additions(Long additions) {
    ...
    public PullRequest7 assignee(User assignee) {
        this.assignee = JsonNullable.of(assignee);
        return this;
    }
    ...
    public PullRequest7 assignees(List<@Valid User> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest7 addAssigneesItem(User assigneesItem) {
    ...
    public PullRequest7 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest7 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = JsonNullable.of(autoMerge);
        return this;
    }
    ...
    public PullRequest7 base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public PullRequest7 body(String body) {
        this.body = JsonNullable.of(body);
        return this;
    }
    ...
    public PullRequest7 changedFiles(Long changedFiles) {
    ...
    public PullRequest7 closedAt(OffsetDateTime closedAt) {
        this.closedAt = JsonNullable.of(closedAt);
        return this;
    }
    ...
    public PullRequest7 comments(Long comments) {
    ...
    public PullRequest7 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest7 commits(Long commits) {
    ...
    public PullRequest7 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest7 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest7 deletions(Long deletions) {
    ...
    public PullRequest7 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest7 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest7 head(PullRequestBase head) {
        this.head = head;
        return this;
    }
    ...
    public PullRequest7 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest7 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest7 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest7 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest7 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest7 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest7 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest7 mergeable(Boolean mergeable) {
    ...
    public PullRequest7 mergeableState(String mergeableState) {
    ...
    public PullRequest7 merged(Boolean merged) {
    ...
    public PullRequest7 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = JsonNullable.of(mergedAt);
        return this;
    }
    ...
    public PullRequest7 mergedBy(User mergedBy) {
    ...
    public PullRequest7 milestone(Milestone1 milestone) {
        this.milestone = JsonNullable.of(milestone);
        return this;
    }
    ...
    public PullRequest7 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest7 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest7 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest7 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest7 requestedReviewers(List<PullRequest6RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest7 addRequestedReviewersItem(PullRequest6RequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest7 requestedTeams(List<@Valid Team1> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest7 addRequestedTeamsItem(Team1 requestedTeamsItem) {
    ...
    public PullRequest7 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest7 reviewComments(Long reviewComments) {
    ...
    public PullRequest7 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest7 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest7 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest7 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest7 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest7 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest7 user(User1 user) {
        this.user = JsonNullable.of(user);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest7 pullRequest7 = (PullRequest7) o;
        return Objects.equals(this.links, pullRequest7.links)
                && Objects.equals(this.activeLockReason, pullRequest7.activeLockReason)
                && Objects.equals(this.additions, pullRequest7.additions)
                && Objects.equals(this.assignee, pullRequest7.assignee)
                && Objects.equals(this.assignees, pullRequest7.assignees)
                && Objects.equals(this.authorAssociation, pullRequest7.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest7.autoMerge)
                && Objects.equals(this.base, pullRequest7.base)
                && Objects.equals(this.body, pullRequest7.body)
                && Objects.equals(this.changedFiles, pullRequest7.changedFiles)
                && Objects.equals(this.closedAt, pullRequest7.closedAt)
                && Objects.equals(this.comments, pullRequest7.comments)
                && Objects.equals(this.commentsUrl, pullRequest7.commentsUrl)
                && Objects.equals(this.commits, pullRequest7.commits)
                && Objects.equals(this.commitsUrl, pullRequest7.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest7.createdAt)
                && Objects.equals(this.deletions, pullRequest7.deletions)
                && Objects.equals(this.diffUrl, pullRequest7.diffUrl)
                && Objects.equals(this.draft, pullRequest7.draft)
                && Objects.equals(this.head, pullRequest7.head)
                && Objects.equals(this.htmlUrl, pullRequest7.htmlUrl)
                && Objects.equals(this.id, pullRequest7.id)
                && Objects.equals(this.issueUrl, pullRequest7.issueUrl)
                && Objects.equals(this.labels, pullRequest7.labels)
                && Objects.equals(this.locked, pullRequest7.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest7.maintainerCanModify)
                && equalsNullable(this.mergeable, pullRequest7.mergeable)
                && Objects.equals(this.mergeableState, pullRequest7.mergeableState)
                && equalsNullable(this.merged, pullRequest7.merged)
                && Objects.equals(this.mergedAt, pullRequest7.mergedAt)
                && equalsNullable(this.mergedBy, pullRequest7.mergedBy)
                && Objects.equals(this.milestone, pullRequest7.milestone)
                && Objects.equals(this.nodeId, pullRequest7.nodeId)
                && Objects.equals(this.number, pullRequest7.number)
                && Objects.equals(this.patchUrl, pullRequest7.patchUrl)
                && equalsNullable(this.rebaseable, pullRequest7.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest7.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest7.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest7.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest7.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest7.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest7.state)
                && Objects.equals(this.statusesUrl, pullRequest7.statusesUrl)
                && Objects.equals(this.title, pullRequest7.title)
                && Objects.equals(this.updatedAt, pullRequest7.updatedAt)
                && Objects.equals(this.url, pullRequest7.url)
                && Objects.equals(this.user, pullRequest7.user);
    }
