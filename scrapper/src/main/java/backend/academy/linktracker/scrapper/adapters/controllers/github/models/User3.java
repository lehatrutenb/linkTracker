...
public class User3 {
     ...
     */
    public User3(Long id, String login) {
        this.id = id;
        this.login = login;
    }

    public User3 avatarUrl(URI avatarUrl) {
    ...
    public User3 deleted(Boolean deleted) {
    ...
    public User3 email(String email) {
    ...
    public User3 eventsUrl(String eventsUrl) {
    ...
    public User3 followersUrl(URI followersUrl) {
    ...
    public User3 followingUrl(String followingUrl) {
    ...
    public User3 gistsUrl(String gistsUrl) {
    ...
    public User3 gravatarId(String gravatarId) {
    ...
    public User3 htmlUrl(URI htmlUrl) {
    ...
    public User3 login(String login) {
        this.login = login;
        return this;
    }
    ...
    public User3 nodeId(String nodeId) {
    ...
    public User3 organizationsUrl(URI organizationsUrl) {
    ...
    public User3 receivedEventsUrl(URI receivedEventsUrl) {
    ...
    public User3 reposUrl(URI reposUrl) {
    ...
    public User3 siteAdmin(Boolean siteAdmin) {
    ...
    public User3 starredUrl(String starredUrl) {
    ...
    public User3 subscriptionsUrl(URI subscriptionsUrl) {
    ...
    public User3 type(TypeEnum type) {
    ...
    public User3 userViewType(String userViewType) {
    ...
    public boolean equals(Object o) {
        ...
        User3 user3 = (User3) o;
        return Objects.equals(this.avatarUrl, user3.avatarUrl)
                && Objects.equals(this.deleted, user3.deleted)
                && equalsNullable(this.email, user3.email)
                && Objects.equals(this.eventsUrl, user3.eventsUrl)
                && Objects.equals(this.followersUrl, user3.followersUrl)
                && Objects.equals(this.followingUrl, user3.followingUrl)
                && Objects.equals(this.gistsUrl, user3.gistsUrl)
                && Objects.equals(this.gravatarId, user3.gravatarId)
                && Objects.equals(this.htmlUrl, user3.htmlUrl)
                && Objects.equals(this.id, user3.id)
                && Objects.equals(this.login, user3.login)
                && Objects.equals(this.name, user3.name)
                && Objects.equals(this.nodeId, user3.nodeId)
                && Objects.equals(this.organizationsUrl, user3.organizationsUrl)
                && Objects.equals(this.receivedEventsUrl, user3.receivedEventsUrl)
                && Objects.equals(this.reposUrl, user3.reposUrl)
                && Objects.equals(this.siteAdmin, user3.siteAdmin)
                && Objects.equals(this.starredUrl, user3.starredUrl)
                && Objects.equals(this.subscriptionsUrl, user3.subscriptionsUrl)
                && Objects.equals(this.type, user3.type)
                && Objects.equals(this.url, user3.url)
                && Objects.equals(this.userViewType, user3.userViewType);
    }
