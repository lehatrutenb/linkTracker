 ...
 * PullRequest3
 */
@JsonTypeName("Pull_Request_3")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class PullRequest3 {
    ...
    public PullRequest3 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest3 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public PullRequest3 additions(Long additions) {
    ...
    public PullRequest3 assignee(User assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public PullRequest3 assignees(List<@Valid User2> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest3 addAssigneesItem(User2 assigneesItem) {
    ...
    public PullRequest3 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest3 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public PullRequest3 base(PullRequest3Base base) {
        this.base = base;
        return this;
    }
    ...
    @JsonProperty("base")
    public PullRequest3Base getBase() {
        return base;
    }

    public void setBase(PullRequest3Base base) {
        this.base = base;
    }

    public PullRequest3 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public PullRequest3 changedFiles(Long changedFiles) {
    ...
    public PullRequest3 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public PullRequest3 comments(Long comments) {
    ...
    public PullRequest3 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest3 commits(Long commits) {
    ...
    public PullRequest3 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest3 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest3 deletions(Long deletions) {
    ...
    public PullRequest3 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest3 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest3 head(PullRequest3Base head) {
        this.head = head;
        return this;
    }
    ...
    @JsonProperty("head")
    public PullRequest3Base getHead() {
        return head;
    }

    public void setHead(PullRequest3Base head) {
        this.head = head;
    }

    public PullRequest3 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest3 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest3 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest3 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest3 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest3 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest3 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest3 mergeable(Boolean mergeable) {
    ...
    public PullRequest3 mergeableState(String mergeableState) {
    ...
    public PullRequest3 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public PullRequest3 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public PullRequest3 mergedBy(User mergedBy) {
    ...
    public PullRequest3 milestone(Milestone milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public PullRequest3 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest3 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest3 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest3 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest3 requestedReviewers(List<PullRequest3RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest3 addRequestedReviewersItem(PullRequest3RequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest3 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest3 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public PullRequest3 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest3 reviewComments(Long reviewComments) {
    ...
    public PullRequest3 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest3 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest3 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest3 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest3 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest3 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest3 user(User3 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest3 pullRequest3 = (PullRequest3) o;
        return Objects.equals(this.links, pullRequest3.links)
                && Objects.equals(this.activeLockReason, pullRequest3.activeLockReason)
                && Objects.equals(this.additions, pullRequest3.additions)
                && Objects.equals(this.assignee, pullRequest3.assignee)
                && Objects.equals(this.assignees, pullRequest3.assignees)
                && Objects.equals(this.authorAssociation, pullRequest3.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest3.autoMerge)
                && Objects.equals(this.base, pullRequest3.base)
                && Objects.equals(this.body, pullRequest3.body)
                && Objects.equals(this.changedFiles, pullRequest3.changedFiles)
                && Objects.equals(this.closedAt, pullRequest3.closedAt)
                && Objects.equals(this.comments, pullRequest3.comments)
                && Objects.equals(this.commentsUrl, pullRequest3.commentsUrl)
                && Objects.equals(this.commits, pullRequest3.commits)
                && Objects.equals(this.commitsUrl, pullRequest3.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest3.createdAt)
                && Objects.equals(this.deletions, pullRequest3.deletions)
                && Objects.equals(this.diffUrl, pullRequest3.diffUrl)
                && Objects.equals(this.draft, pullRequest3.draft)
                && Objects.equals(this.head, pullRequest3.head)
                && Objects.equals(this.htmlUrl, pullRequest3.htmlUrl)
                && Objects.equals(this.id, pullRequest3.id)
                && Objects.equals(this.issueUrl, pullRequest3.issueUrl)
                && Objects.equals(this.labels, pullRequest3.labels)
                && Objects.equals(this.locked, pullRequest3.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest3.maintainerCanModify)
                && Objects.equals(this.mergeable, pullRequest3.mergeable)
                && Objects.equals(this.mergeableState, pullRequest3.mergeableState)
                && Objects.equals(this.merged, pullRequest3.merged)
                && Objects.equals(this.mergedAt, pullRequest3.mergedAt)
                && Objects.equals(this.mergedBy, pullRequest3.mergedBy)
                && Objects.equals(this.milestone, pullRequest3.milestone)
                && Objects.equals(this.nodeId, pullRequest3.nodeId)
                && Objects.equals(this.number, pullRequest3.number)
                && Objects.equals(this.patchUrl, pullRequest3.patchUrl)
                && Objects.equals(this.rebaseable, pullRequest3.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest3.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest3.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest3.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest3.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest3.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest3.state)
                && Objects.equals(this.statusesUrl, pullRequest3.statusesUrl)
                && Objects.equals(this.title, pullRequest3.title)
                && Objects.equals(this.updatedAt, pullRequest3.updatedAt)
                && Objects.equals(this.url, pullRequest3.url)
                && Objects.equals(this.user, pullRequest3.user);
    }
