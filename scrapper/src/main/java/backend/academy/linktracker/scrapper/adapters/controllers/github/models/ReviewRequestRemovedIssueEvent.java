 ...
 */
@Schema(name = "review-request-removed-issue-event", description = "Review Request Removed Issue Event")
@JsonTypeName("review-request-removed-issue-event")
@Generated(
...
public class ReviewRequestRemovedIssueEvent {
    ...
    public ReviewRequestRemovedIssueEvent id(Long id) {
        this.id = id;
        return this;
    }
