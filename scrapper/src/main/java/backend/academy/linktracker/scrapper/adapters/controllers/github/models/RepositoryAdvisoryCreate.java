...
public class RepositoryAdvisoryCreate {
    ...
    public RepositoryAdvisoryCreate vulnerabilities(
            List<@Valid RepositoryAdvisoryCreateVulnerabilitiesInner> vulnerabilities) {
        this.vulnerabilities = vulnerabilities;
        return this;
    }

    public RepositoryAdvisoryCreate addVulnerabilitiesItem(
    ...
    public String toString() {
        ...
        sb.append("    cvssVectorString: ")
                ...
                .append("\n");
        sb.append("    startPrivateFork: ")
                .append(toIndentedString(startPrivateFork))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
