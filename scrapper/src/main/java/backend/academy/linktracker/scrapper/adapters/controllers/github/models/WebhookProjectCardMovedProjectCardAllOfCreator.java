 ...
 */
@JsonTypeName("webhook_project_card_moved_project_card_allOf_creator")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-04-05T13:06:55.012025427Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class WebhookProjectCardMovedProjectCardAllOfCreator {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator avatarUrl(String avatarUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator eventsUrl(String eventsUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator followersUrl(String followersUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator followingUrl(String followingUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator gistsUrl(String gistsUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator gravatarId(String gravatarId) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator htmlUrl(String htmlUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator id(Long id) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator login(String login) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator nodeId(String nodeId) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator organizationsUrl(String organizationsUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator receivedEventsUrl(String receivedEventsUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator reposUrl(String reposUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator siteAdmin(Boolean siteAdmin) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator starredUrl(String starredUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator subscriptionsUrl(String subscriptionsUrl) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator type(String type) {
    ...
    public WebhookProjectCardMovedProjectCardAllOfCreator url(String url) {
    ...
    public boolean equals(Object o) {
        ...
        WebhookProjectCardMovedProjectCardAllOfCreator webhookProjectCardMovedProjectCardAllOfCreator =
                (WebhookProjectCardMovedProjectCardAllOfCreator) o;
        return Objects.equals(this.avatarUrl, webhookProjectCardMovedProjectCardAllOfCreator.avatarUrl)
                && Objects.equals(this.eventsUrl, webhookProjectCardMovedProjectCardAllOfCreator.eventsUrl)
                && Objects.equals(this.followersUrl, webhookProjectCardMovedProjectCardAllOfCreator.followersUrl)
                && Objects.equals(this.followingUrl, webhookProjectCardMovedProjectCardAllOfCreator.followingUrl)
                && Objects.equals(this.gistsUrl, webhookProjectCardMovedProjectCardAllOfCreator.gistsUrl)
                && Objects.equals(this.gravatarId, webhookProjectCardMovedProjectCardAllOfCreator.gravatarId)
                && Objects.equals(this.htmlUrl, webhookProjectCardMovedProjectCardAllOfCreator.htmlUrl)
                && Objects.equals(this.id, webhookProjectCardMovedProjectCardAllOfCreator.id)
                && Objects.equals(this.login, webhookProjectCardMovedProjectCardAllOfCreator.login)
                && Objects.equals(this.nodeId, webhookProjectCardMovedProjectCardAllOfCreator.nodeId)
                && Objects.equals(
                        this.organizationsUrl, webhookProjectCardMovedProjectCardAllOfCreator.organizationsUrl)
                && Objects.equals(
                        this.receivedEventsUrl, webhookProjectCardMovedProjectCardAllOfCreator.receivedEventsUrl)
                && Objects.equals(this.reposUrl, webhookProjectCardMovedProjectCardAllOfCreator.reposUrl)
                && Objects.equals(this.siteAdmin, webhookProjectCardMovedProjectCardAllOfCreator.siteAdmin)
                && Objects.equals(this.starredUrl, webhookProjectCardMovedProjectCardAllOfCreator.starredUrl)
                && Objects.equals(
                        this.subscriptionsUrl, webhookProjectCardMovedProjectCardAllOfCreator.subscriptionsUrl)
                && Objects.equals(this.type, webhookProjectCardMovedProjectCardAllOfCreator.type)
                && Objects.equals(this.url, webhookProjectCardMovedProjectCardAllOfCreator.url);
    }
    ...
    public String toString() {
        ...
        sb.append("class WebhookProjectCardMovedProjectCardAllOfCreator {\n");
