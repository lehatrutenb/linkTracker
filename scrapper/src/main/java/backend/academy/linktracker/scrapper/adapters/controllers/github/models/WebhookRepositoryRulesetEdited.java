...
public class WebhookRepositoryRulesetEdited {
     ...
     */
    public WebhookRepositoryRulesetEdited(ActionEnum action, RepositoryRuleset repositoryRuleset, SimpleUser sender) {
        this.action = action;
        this.repositoryRuleset = repositoryRuleset;
        this.sender = sender;
    }

    public WebhookRepositoryRulesetEdited action(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public WebhookRepositoryRulesetEdited repositoryRuleset(RepositoryRuleset repositoryRuleset) {
        this.repositoryRuleset = repositoryRuleset;
        return this;
    }
    ...
    public WebhookRepositoryRulesetEdited sender(SimpleUser sender) {
        this.sender = sender;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        WebhookRepositoryRulesetEdited webhookRepositoryRulesetEdited = (WebhookRepositoryRulesetEdited) o;
        return Objects.equals(this.action, webhookRepositoryRulesetEdited.action)
                && Objects.equals(this.enterprise, webhookRepositoryRulesetEdited.enterprise)
                && Objects.equals(this.installation, webhookRepositoryRulesetEdited.installation)
                && Objects.equals(this.organization, webhookRepositoryRulesetEdited.organization)
                && Objects.equals(this.repository, webhookRepositoryRulesetEdited.repository)
                && Objects.equals(this.repositoryRuleset, webhookRepositoryRulesetEdited.repositoryRuleset)
                && Objects.equals(this.changes, webhookRepositoryRulesetEdited.changes)
                && Objects.equals(this.sender, webhookRepositoryRulesetEdited.sender);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                action, enterprise, installation, organization, repository, repositoryRuleset, changes, sender);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class WebhookRepositoryRulesetEdited {\n");
