 ...
 */
@Schema(
        name = "ApiCommentsResponse",
        description = "Standard Stack Exchange API response wrapper for comments collections.")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-05-09T22:14:15.603572775Z[Etc/UTC]",
...
public class ApiCommentsResponse {
    ...
    @Schema(
            name = "items",
            description = "The comments returned by the request.",
