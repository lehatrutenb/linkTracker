...
public class User6 {
     ...
     */
    public User6(Long id) {
        this.id = id;
    }

    public User6 avatarUrl(URI avatarUrl) {
    ...
    public User6 deleted(Boolean deleted) {
    ...
    public User6 email(String email) {
    ...
    public User6 eventsUrl(String eventsUrl) {
    ...
    public User6 followersUrl(URI followersUrl) {
    ...
    public User6 followingUrl(String followingUrl) {
    ...
    public User6 gistsUrl(String gistsUrl) {
    ...
    public User6 gravatarId(String gravatarId) {
    ...
    public User6 htmlUrl(URI htmlUrl) {
    ...
    public User6 login(String login) {
    ...
    public User6 nodeId(String nodeId) {
    ...
    public User6 organizationsUrl(URI organizationsUrl) {
    ...
    public User6 receivedEventsUrl(URI receivedEventsUrl) {
    ...
    public User6 reposUrl(URI reposUrl) {
    ...
    public User6 siteAdmin(Boolean siteAdmin) {
    ...
    public User6 starredUrl(String starredUrl) {
    ...
    public User6 subscriptionsUrl(URI subscriptionsUrl) {
    ...
    public User6 type(TypeEnum type) {
    ...
    public User6 userViewType(String userViewType) {
    ...
    public boolean equals(Object o) {
        ...
        User6 user6 = (User6) o;
        return Objects.equals(this.avatarUrl, user6.avatarUrl)
                && Objects.equals(this.deleted, user6.deleted)
                && equalsNullable(this.email, user6.email)
                && Objects.equals(this.eventsUrl, user6.eventsUrl)
                && Objects.equals(this.followersUrl, user6.followersUrl)
                && Objects.equals(this.followingUrl, user6.followingUrl)
                && Objects.equals(this.gistsUrl, user6.gistsUrl)
                && Objects.equals(this.gravatarId, user6.gravatarId)
                && Objects.equals(this.htmlUrl, user6.htmlUrl)
                && Objects.equals(this.id, user6.id)
                && Objects.equals(this.login, user6.login)
                && Objects.equals(this.name, user6.name)
                && Objects.equals(this.nodeId, user6.nodeId)
                && Objects.equals(this.organizationsUrl, user6.organizationsUrl)
                && Objects.equals(this.receivedEventsUrl, user6.receivedEventsUrl)
                && Objects.equals(this.reposUrl, user6.reposUrl)
                && Objects.equals(this.siteAdmin, user6.siteAdmin)
                && Objects.equals(this.starredUrl, user6.starredUrl)
                && Objects.equals(this.subscriptionsUrl, user6.subscriptionsUrl)
                && Objects.equals(this.type, user6.type)
                && Objects.equals(this.url, user6.url)
                && Objects.equals(this.userViewType, user6.userViewType);
    }
