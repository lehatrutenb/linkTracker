 ...
 */
@Schema(name = "review-dismissed-issue-event", description = "Review Dismissed Issue Event")
@JsonTypeName("review-dismissed-issue-event")
@Generated(
...
public class ReviewDismissedIssueEvent {
    ...
    public ReviewDismissedIssueEvent id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, reviewDismissedIssueEvent.id)
                && Objects.equals(this.nodeId, reviewDismissedIssueEvent.nodeId)
                && Objects.equals(this.url, reviewDismissedIssueEvent.url)
                && Objects.equals(this.actor, reviewDismissedIssueEvent.actor)
