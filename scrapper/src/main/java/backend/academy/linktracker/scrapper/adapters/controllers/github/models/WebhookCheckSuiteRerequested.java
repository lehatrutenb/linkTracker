 ...
 */
@JsonTypeName("webhook-check-suite-rerequested")
@Generated(
...
public class WebhookCheckSuiteRerequested {
    ...
    public WebhookCheckSuiteRerequested(
            ActionEnum action,
            WebhookCheckSuiteRerequestedCheckSuite checkSuite,
    ...
    public WebhookCheckSuiteRerequested enterprise(EnterpriseWebhooks enterprise) {
    ...
    public WebhookCheckSuiteRerequested organization(OrganizationSimpleWebhooks organization) {
    ...
    public WebhookCheckSuiteRerequested repository(RepositoryWebhooks repository) {
        this.repository = repository;
        return this;
    }
