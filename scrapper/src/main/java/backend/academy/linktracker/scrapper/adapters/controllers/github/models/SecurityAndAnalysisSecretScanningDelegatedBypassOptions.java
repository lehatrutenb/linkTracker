 ...
 */
@JsonTypeName("security_and_analysis_secret_scanning_delegated_bypass_options")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class SecurityAndAnalysisSecretScanningDelegatedBypassOptions {

    @Valid
    private List<@Valid CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptionsReviewersInner>
            reviewers = new ArrayList<>();

    public SecurityAndAnalysisSecretScanningDelegatedBypassOptions reviewers(
    ...
    public SecurityAndAnalysisSecretScanningDelegatedBypassOptions addReviewersItem(
    ...
    public boolean equals(Object o) {
        ...
        SecurityAndAnalysisSecretScanningDelegatedBypassOptions
                securityAndAnalysisSecretScanningDelegatedBypassOptions =
                        (SecurityAndAnalysisSecretScanningDelegatedBypassOptions) o;
        return Objects.equals(this.reviewers, securityAndAnalysisSecretScanningDelegatedBypassOptions.reviewers);
    }
    ...
    public String toString() {
        ...
        sb.append("class SecurityAndAnalysisSecretScanningDelegatedBypassOptions {\n");
