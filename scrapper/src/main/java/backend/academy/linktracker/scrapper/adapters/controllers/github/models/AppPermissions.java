 ...
 */
@Schema(name = "App_permissions", description = "The set of permissions for the GitHub app")
@JsonTypeName("App_permissions")
@Generated(
...
public class AppPermissions {
    ...
    public AppPermissions organizationSelfHostedRunners(
