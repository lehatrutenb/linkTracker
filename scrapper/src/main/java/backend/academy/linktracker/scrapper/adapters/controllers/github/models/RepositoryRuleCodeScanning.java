 ...
 */
@Schema(
        name = "repository-rule-code-scanning",
        description =
                "Choose which tools must provide code scanning results before the reference is updated. When configured, code scanning must be enabled and have results for both the commit and the reference being updated.")
...
public class RepositoryRuleCodeScanning implements OrgRules, RepositoryRule {
     ...
     */
    public RepositoryRuleCodeScanning(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleCodeScanning type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleCodeScanning repositoryRuleCodeScanning = (RepositoryRuleCodeScanning) o;
        return Objects.equals(this.type, repositoryRuleCodeScanning.type)
                && Objects.equals(this.parameters, repositoryRuleCodeScanning.parameters);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleCodeScanning {\n");
