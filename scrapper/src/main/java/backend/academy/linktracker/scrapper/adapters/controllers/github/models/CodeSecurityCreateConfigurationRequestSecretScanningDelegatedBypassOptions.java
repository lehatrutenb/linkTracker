 ...
 */
@Schema(
        name = "code_security_create_configuration_request_secret_scanning_delegated_bypass_options",
        description = "Feature options for secret scanning delegated bypass")
@JsonTypeName("code_security_create_configuration_request_secret_scanning_delegated_bypass_options")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions {

    @Valid
    private List<@Valid CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptionsReviewersInner>
            reviewers = new ArrayList<>();

    public CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions reviewers(
    ...
    public CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions addReviewersItem(
    ...
    public boolean equals(Object o) {
        ...
        CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions
                codeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions =
                        (CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions) o;
        return Objects.equals(
                this.reviewers, codeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions.reviewers);
    }
    ...
    public String toString() {
        ...
        sb.append("class CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions {\n");
