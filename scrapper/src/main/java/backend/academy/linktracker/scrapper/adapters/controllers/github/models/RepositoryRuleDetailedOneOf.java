 ...
 */
@JsonTypeName("repository_rule_detailed_oneOf")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class RepositoryRuleDetailedOneOf implements RepositoryRuleDetailed {
    ...
    public RepositoryRuleDetailedOneOf() {
        super();
    }
     ...
     */
    public RepositoryRuleDetailedOneOf(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleDetailedOneOf type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RepositoryRuleDetailedOneOf rulesetSourceType(RulesetSourceTypeEnum rulesetSourceType) {
    ...
    public RepositoryRuleDetailedOneOf rulesetSource(String rulesetSource) {
    ...
    public RepositoryRuleDetailedOneOf rulesetId(Long rulesetId) {
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleDetailedOneOf repositoryRuleDetailedOneOf = (RepositoryRuleDetailedOneOf) o;
        return Objects.equals(this.type, repositoryRuleDetailedOneOf.type)
                && Objects.equals(this.rulesetSourceType, repositoryRuleDetailedOneOf.rulesetSourceType)
                && Objects.equals(this.rulesetSource, repositoryRuleDetailedOneOf.rulesetSource)
                && Objects.equals(this.rulesetId, repositoryRuleDetailedOneOf.rulesetId);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleDetailedOneOf {\n");
