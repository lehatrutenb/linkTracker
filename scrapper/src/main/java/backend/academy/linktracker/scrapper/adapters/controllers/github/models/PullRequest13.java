 ...
 * PullRequest13
 */
@JsonTypeName("Pull_Request_13")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class PullRequest13 {
    ...
    public PullRequest13 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest13 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public PullRequest13 additions(Long additions) {
    ...
    public PullRequest13 assignee(User assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public PullRequest13 assignees(List<@Valid User2> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest13 addAssigneesItem(User2 assigneesItem) {
    ...
    public PullRequest13 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest13 autoMerge(PullRequestAutoMerge1 autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public PullRequest13 base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public PullRequest13 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public PullRequest13 changedFiles(Long changedFiles) {
    ...
    public PullRequest13 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public PullRequest13 comments(Long comments) {
    ...
    public PullRequest13 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest13 commits(Long commits) {
    ...
    public PullRequest13 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest13 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest13 deletions(Long deletions) {
    ...
    public PullRequest13 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest13 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest13 head(WebhookPullRequestReviewCommentDeletedPullRequestHead head) {
        this.head = head;
        return this;
    }
    ...
    public PullRequest13 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest13 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest13 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest13 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest13 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest13 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest13 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest13 mergeable(Boolean mergeable) {
    ...
    public PullRequest13 mergeableState(String mergeableState) {
    ...
    public PullRequest13 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public PullRequest13 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public PullRequest13 mergedBy(User mergedBy) {
    ...
    public PullRequest13 milestone(Milestone1 milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public PullRequest13 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest13 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest13 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest13 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest13 requestedReviewers(List<PullRequest3RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest13 addRequestedReviewersItem(PullRequest3RequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest13 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest13 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public PullRequest13 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest13 reviewComments(Long reviewComments) {
    ...
    public PullRequest13 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest13 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest13 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest13 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest13 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest13 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest13 user(User1 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest13 pullRequest13 = (PullRequest13) o;
        return Objects.equals(this.links, pullRequest13.links)
                && Objects.equals(this.activeLockReason, pullRequest13.activeLockReason)
                && Objects.equals(this.additions, pullRequest13.additions)
                && Objects.equals(this.assignee, pullRequest13.assignee)
                && Objects.equals(this.assignees, pullRequest13.assignees)
                && Objects.equals(this.authorAssociation, pullRequest13.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest13.autoMerge)
                && Objects.equals(this.base, pullRequest13.base)
                && Objects.equals(this.body, pullRequest13.body)
                && Objects.equals(this.changedFiles, pullRequest13.changedFiles)
                && Objects.equals(this.closedAt, pullRequest13.closedAt)
                && Objects.equals(this.comments, pullRequest13.comments)
                && Objects.equals(this.commentsUrl, pullRequest13.commentsUrl)
                && Objects.equals(this.commits, pullRequest13.commits)
                && Objects.equals(this.commitsUrl, pullRequest13.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest13.createdAt)
                && Objects.equals(this.deletions, pullRequest13.deletions)
                && Objects.equals(this.diffUrl, pullRequest13.diffUrl)
                && Objects.equals(this.draft, pullRequest13.draft)
                && Objects.equals(this.head, pullRequest13.head)
                && Objects.equals(this.htmlUrl, pullRequest13.htmlUrl)
                && Objects.equals(this.id, pullRequest13.id)
                && Objects.equals(this.issueUrl, pullRequest13.issueUrl)
                && Objects.equals(this.labels, pullRequest13.labels)
                && Objects.equals(this.locked, pullRequest13.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest13.maintainerCanModify)
                && Objects.equals(this.mergeable, pullRequest13.mergeable)
                && Objects.equals(this.mergeableState, pullRequest13.mergeableState)
                && Objects.equals(this.merged, pullRequest13.merged)
                && Objects.equals(this.mergedAt, pullRequest13.mergedAt)
                && Objects.equals(this.mergedBy, pullRequest13.mergedBy)
                && Objects.equals(this.milestone, pullRequest13.milestone)
                && Objects.equals(this.nodeId, pullRequest13.nodeId)
                && Objects.equals(this.number, pullRequest13.number)
                && Objects.equals(this.patchUrl, pullRequest13.patchUrl)
                && Objects.equals(this.rebaseable, pullRequest13.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest13.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest13.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest13.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest13.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest13.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest13.state)
                && Objects.equals(this.statusesUrl, pullRequest13.statusesUrl)
                && Objects.equals(this.title, pullRequest13.title)
                && Objects.equals(this.updatedAt, pullRequest13.updatedAt)
                && Objects.equals(this.url, pullRequest13.url)
                && Objects.equals(this.user, pullRequest13.user);
    }
