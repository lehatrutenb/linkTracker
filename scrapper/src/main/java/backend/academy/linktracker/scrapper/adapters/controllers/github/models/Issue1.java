 ...
 */
@Schema(name = "Issue_1", description = "The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.")
...
public class Issue1 {
    ...
    private JsonNullable<User5> assignee = JsonNullable.<User5>undefined();
    ...
    private JsonNullable<App12> performedViaGithubApp = JsonNullable.<App12>undefined();
    ...
    public Issue1 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = JsonNullable.of(activeLockReason);
        return this;
    }
    ...
    public Issue1 assignee(User5 assignee) {
    ...
    public JsonNullable<User5> getAssignee() {
        return assignee;
    }

    public void setAssignee(JsonNullable<User5> assignee) {
        this.assignee = assignee;
    }

    public Issue1 assignees(List<@Valid User5> assignees) {
        this.assignees = assignees;
        return this;
    }

    public Issue1 addAssigneesItem(User5 assigneesItem) {
    ...
    public Issue1 labels(List<@Valid Label1> labels) {
        this.labels = labels;
        return this;
    }

    public Issue1 addLabelsItem(Label1 labelsItem) {
        if (this.labels == null) {
    ...
    public Issue1 performedViaGithubApp(App12 performedViaGithubApp) {
    ...
    public JsonNullable<App12> getPerformedViaGithubApp() {
        return performedViaGithubApp;
    }

    public void setPerformedViaGithubApp(JsonNullable<App12> performedViaGithubApp) {
        this.performedViaGithubApp = performedViaGithubApp;
    }

    public Issue1 pullRequest(WebhooksIssuePullRequest pullRequest) {
    ...
    public Issue1 pinnedComment(NullableIssueComment pinnedComment) {
    ...
    public Issue1 state(StateEnum state) {
    ...
    public Issue1 stateReason(String stateReason) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.activeLockReason, issue1.activeLockReason)
                && equalsNullable(this.assignee, issue1.assignee)
                ...
                && equalsNullable(this.type, issue1.type)
