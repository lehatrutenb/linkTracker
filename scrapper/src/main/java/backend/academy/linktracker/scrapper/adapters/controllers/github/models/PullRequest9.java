 ...
 * PullRequest9
 */
@JsonTypeName("Pull_Request_9")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class PullRequest9 {
    ...
    public PullRequest9 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest9 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public PullRequest9 additions(Long additions) {
    ...
    public PullRequest9 assignee(User4 assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public PullRequest9 assignees(List<@Valid User4> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest9 addAssigneesItem(User4 assigneesItem) {
    ...
    public PullRequest9 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest9 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public PullRequest9 base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public PullRequest9 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public PullRequest9 changedFiles(Long changedFiles) {
    ...
    public PullRequest9 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public PullRequest9 comments(Long comments) {
    ...
    public PullRequest9 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest9 commits(Long commits) {
    ...
    public PullRequest9 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest9 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest9 deletions(Long deletions) {
    ...
    public PullRequest9 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest9 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest9 head(PullRequestBase head) {
        this.head = head;
        return this;
    }
    ...
    public PullRequest9 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest9 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest9 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest9 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest9 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest9 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest9 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest9 mergeable(Boolean mergeable) {
    ...
    public PullRequest9 mergeableState(String mergeableState) {
    ...
    public PullRequest9 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public PullRequest9 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public PullRequest9 mergedBy(User mergedBy) {
    ...
    public PullRequest9 milestone(Milestone milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public PullRequest9 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest9 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest9 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest9 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest9 requestedReviewers(List<PullRequest3RequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest9 addRequestedReviewersItem(PullRequest3RequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest9 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest9 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public PullRequest9 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest9 reviewComments(Long reviewComments) {
    ...
    public PullRequest9 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest9 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest9 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest9 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest9 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest9 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest9 user(User3 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest9 pullRequest9 = (PullRequest9) o;
        return Objects.equals(this.links, pullRequest9.links)
                && Objects.equals(this.activeLockReason, pullRequest9.activeLockReason)
                && Objects.equals(this.additions, pullRequest9.additions)
                && Objects.equals(this.assignee, pullRequest9.assignee)
                && Objects.equals(this.assignees, pullRequest9.assignees)
                && Objects.equals(this.authorAssociation, pullRequest9.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest9.autoMerge)
                && Objects.equals(this.base, pullRequest9.base)
                && Objects.equals(this.body, pullRequest9.body)
                && Objects.equals(this.changedFiles, pullRequest9.changedFiles)
                && Objects.equals(this.closedAt, pullRequest9.closedAt)
                && Objects.equals(this.comments, pullRequest9.comments)
                && Objects.equals(this.commentsUrl, pullRequest9.commentsUrl)
                && Objects.equals(this.commits, pullRequest9.commits)
                && Objects.equals(this.commitsUrl, pullRequest9.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest9.createdAt)
                && Objects.equals(this.deletions, pullRequest9.deletions)
                && Objects.equals(this.diffUrl, pullRequest9.diffUrl)
                && Objects.equals(this.draft, pullRequest9.draft)
                && Objects.equals(this.head, pullRequest9.head)
                && Objects.equals(this.htmlUrl, pullRequest9.htmlUrl)
                && Objects.equals(this.id, pullRequest9.id)
                && Objects.equals(this.issueUrl, pullRequest9.issueUrl)
                && Objects.equals(this.labels, pullRequest9.labels)
                && Objects.equals(this.locked, pullRequest9.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest9.maintainerCanModify)
                && Objects.equals(this.mergeable, pullRequest9.mergeable)
                && Objects.equals(this.mergeableState, pullRequest9.mergeableState)
                && Objects.equals(this.merged, pullRequest9.merged)
                && Objects.equals(this.mergedAt, pullRequest9.mergedAt)
                && Objects.equals(this.mergedBy, pullRequest9.mergedBy)
                && Objects.equals(this.milestone, pullRequest9.milestone)
                && Objects.equals(this.nodeId, pullRequest9.nodeId)
                && Objects.equals(this.number, pullRequest9.number)
                && Objects.equals(this.patchUrl, pullRequest9.patchUrl)
                && Objects.equals(this.rebaseable, pullRequest9.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest9.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest9.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest9.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest9.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest9.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest9.state)
                && Objects.equals(this.statusesUrl, pullRequest9.statusesUrl)
                && Objects.equals(this.title, pullRequest9.title)
                && Objects.equals(this.updatedAt, pullRequest9.updatedAt)
                && Objects.equals(this.url, pullRequest9.url)
                && Objects.equals(this.user, pullRequest9.user);
    }
