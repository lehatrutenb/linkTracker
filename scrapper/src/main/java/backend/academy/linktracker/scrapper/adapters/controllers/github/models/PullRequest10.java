 ...
 * PullRequest10
 */
@JsonTypeName("Pull_Request_10")
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2026-03-23T19:30:01.508827706Z[Etc/UTC]",
        comments = "Generator version: 7.21.0-SNAPSHOT")
public class PullRequest10 {
    ...
    private PullRequest10Head head;
    ...
    public PullRequest10 links(WebhooksPullRequest5Links links) {
        this.links = links;
        return this;
    }
    ...
    public PullRequest10 activeLockReason(ActiveLockReasonEnum activeLockReason) {
        this.activeLockReason = activeLockReason;
        return this;
    }
    ...
    public PullRequest10 additions(Long additions) {
    ...
    public PullRequest10 assignee(User4 assignee) {
        this.assignee = assignee;
        return this;
    }
    ...
    public PullRequest10 assignees(List<@Valid User5> assignees) {
        this.assignees = assignees;
        return this;
    }

    public PullRequest10 addAssigneesItem(User5 assigneesItem) {
    ...
    public PullRequest10 authorAssociation(AuthorAssociationEnum authorAssociation) {
        this.authorAssociation = authorAssociation;
        return this;
    }
    ...
    public PullRequest10 autoMerge(PullRequestAutoMerge autoMerge) {
        this.autoMerge = autoMerge;
        return this;
    }
    ...
    public PullRequest10 base(PullRequestBase base) {
        this.base = base;
        return this;
    }
    ...
    public PullRequest10 body(String body) {
        this.body = body;
        return this;
    }
    ...
    public PullRequest10 changedFiles(Long changedFiles) {
    ...
    public PullRequest10 closedAt(OffsetDateTime closedAt) {
        this.closedAt = closedAt;
        return this;
    }
    ...
    public PullRequest10 comments(Long comments) {
    ...
    public PullRequest10 commentsUrl(URI commentsUrl) {
        this.commentsUrl = commentsUrl;
        return this;
    }
    ...
    public PullRequest10 commits(Long commits) {
    ...
    public PullRequest10 commitsUrl(URI commitsUrl) {
        this.commitsUrl = commitsUrl;
        return this;
    }
    ...
    public PullRequest10 createdAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public PullRequest10 deletions(Long deletions) {
    ...
    public PullRequest10 diffUrl(URI diffUrl) {
        this.diffUrl = diffUrl;
        return this;
    }
    ...
    public PullRequest10 draft(Boolean draft) {
        this.draft = draft;
        return this;
    }
    ...
    public PullRequest10 head(PullRequest10Head head) {
        this.head = head;
        return this;
    }
    ...
    @JsonProperty("head")
    public PullRequest10Head getHead() {
        return head;
    }

    public void setHead(PullRequest10Head head) {
        this.head = head;
    }

    public PullRequest10 htmlUrl(URI htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public PullRequest10 id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PullRequest10 issueUrl(URI issueUrl) {
        this.issueUrl = issueUrl;
        return this;
    }
    ...
    public PullRequest10 labels(List<@Valid Label> labels) {
        this.labels = labels;
        return this;
    }

    public PullRequest10 addLabelsItem(Label labelsItem) {
        if (this.labels == null) {
    ...
    public PullRequest10 locked(Boolean locked) {
        this.locked = locked;
        return this;
    }
    ...
    public PullRequest10 maintainerCanModify(Boolean maintainerCanModify) {
    ...
    public PullRequest10 mergeable(Boolean mergeable) {
    ...
    public PullRequest10 mergeableState(String mergeableState) {
    ...
    public PullRequest10 merged(Boolean merged) {
        this.merged = merged;
        return this;
    }
    ...
    public PullRequest10 mergedAt(OffsetDateTime mergedAt) {
        this.mergedAt = mergedAt;
        return this;
    }
    ...
    public PullRequest10 mergedBy(User mergedBy) {
    ...
    public PullRequest10 milestone(Milestone milestone) {
        this.milestone = milestone;
        return this;
    }
    ...
    public PullRequest10 nodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public PullRequest10 number(Long number) {
        this.number = number;
        return this;
    }
    ...
    public PullRequest10 patchUrl(URI patchUrl) {
        this.patchUrl = patchUrl;
        return this;
    }
    ...
    public PullRequest10 rebaseable(Boolean rebaseable) {
    ...
    public PullRequest10 requestedReviewers(List<PullRequestRequestedReviewersInner> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
        return this;
    }

    public PullRequest10 addRequestedReviewersItem(PullRequestRequestedReviewersInner requestedReviewersItem) {
    ...
    public PullRequest10 requestedTeams(List<@Valid Team> requestedTeams) {
        this.requestedTeams = requestedTeams;
        return this;
    }

    public PullRequest10 addRequestedTeamsItem(Team requestedTeamsItem) {
    ...
    public PullRequest10 reviewCommentUrl(String reviewCommentUrl) {
        this.reviewCommentUrl = reviewCommentUrl;
        return this;
    }
    ...
    public PullRequest10 reviewComments(Long reviewComments) {
    ...
    public PullRequest10 reviewCommentsUrl(URI reviewCommentsUrl) {
        this.reviewCommentsUrl = reviewCommentsUrl;
        return this;
    }
    ...
    public PullRequest10 state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public PullRequest10 statusesUrl(URI statusesUrl) {
        this.statusesUrl = statusesUrl;
        return this;
    }
    ...
    public PullRequest10 title(String title) {
        this.title = title;
        return this;
    }
    ...
    public PullRequest10 updatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public PullRequest10 url(URI url) {
        this.url = url;
        return this;
    }
    ...
    public PullRequest10 user(User3 user) {
        this.user = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PullRequest10 pullRequest10 = (PullRequest10) o;
        return Objects.equals(this.links, pullRequest10.links)
                && Objects.equals(this.activeLockReason, pullRequest10.activeLockReason)
                && Objects.equals(this.additions, pullRequest10.additions)
                && Objects.equals(this.assignee, pullRequest10.assignee)
                && Objects.equals(this.assignees, pullRequest10.assignees)
                && Objects.equals(this.authorAssociation, pullRequest10.authorAssociation)
                && Objects.equals(this.autoMerge, pullRequest10.autoMerge)
                && Objects.equals(this.base, pullRequest10.base)
                && Objects.equals(this.body, pullRequest10.body)
                && Objects.equals(this.changedFiles, pullRequest10.changedFiles)
                && Objects.equals(this.closedAt, pullRequest10.closedAt)
                && Objects.equals(this.comments, pullRequest10.comments)
                && Objects.equals(this.commentsUrl, pullRequest10.commentsUrl)
                && Objects.equals(this.commits, pullRequest10.commits)
                && Objects.equals(this.commitsUrl, pullRequest10.commitsUrl)
                && Objects.equals(this.createdAt, pullRequest10.createdAt)
                && Objects.equals(this.deletions, pullRequest10.deletions)
                && Objects.equals(this.diffUrl, pullRequest10.diffUrl)
                && Objects.equals(this.draft, pullRequest10.draft)
                && Objects.equals(this.head, pullRequest10.head)
                && Objects.equals(this.htmlUrl, pullRequest10.htmlUrl)
                && Objects.equals(this.id, pullRequest10.id)
                && Objects.equals(this.issueUrl, pullRequest10.issueUrl)
                && Objects.equals(this.labels, pullRequest10.labels)
                && Objects.equals(this.locked, pullRequest10.locked)
                && Objects.equals(this.maintainerCanModify, pullRequest10.maintainerCanModify)
                && Objects.equals(this.mergeable, pullRequest10.mergeable)
                && Objects.equals(this.mergeableState, pullRequest10.mergeableState)
                && Objects.equals(this.merged, pullRequest10.merged)
                && Objects.equals(this.mergedAt, pullRequest10.mergedAt)
                && Objects.equals(this.mergedBy, pullRequest10.mergedBy)
                && Objects.equals(this.milestone, pullRequest10.milestone)
                && Objects.equals(this.nodeId, pullRequest10.nodeId)
                && Objects.equals(this.number, pullRequest10.number)
                && Objects.equals(this.patchUrl, pullRequest10.patchUrl)
                && Objects.equals(this.rebaseable, pullRequest10.rebaseable)
                && Objects.equals(this.requestedReviewers, pullRequest10.requestedReviewers)
                && Objects.equals(this.requestedTeams, pullRequest10.requestedTeams)
                && Objects.equals(this.reviewCommentUrl, pullRequest10.reviewCommentUrl)
                && Objects.equals(this.reviewComments, pullRequest10.reviewComments)
                && Objects.equals(this.reviewCommentsUrl, pullRequest10.reviewCommentsUrl)
                && Objects.equals(this.state, pullRequest10.state)
                && Objects.equals(this.statusesUrl, pullRequest10.statusesUrl)
                && Objects.equals(this.title, pullRequest10.title)
                && Objects.equals(this.updatedAt, pullRequest10.updatedAt)
                && Objects.equals(this.url, pullRequest10.url)
                && Objects.equals(this.user, pullRequest10.user);
    }
