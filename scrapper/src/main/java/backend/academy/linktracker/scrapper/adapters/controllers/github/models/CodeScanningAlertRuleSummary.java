...
public class CodeScanningAlertRuleSummary {
    ...
    public boolean equals(Object o) {
        ...
        return equalsNullable(this.id, codeScanningAlertRuleSummary.id)
                && Objects.equals(this.name, codeScanningAlertRuleSummary.name)
                && equalsNullable(this.severity, codeScanningAlertRuleSummary.severity)
                && equalsNullable(this.securitySeverityLevel, codeScanningAlertRuleSummary.securitySeverityLevel)
                ...
                && equalsNullable(this.tags, codeScanningAlertRuleSummary.tags)
                && equalsNullable(this.help, codeScanningAlertRuleSummary.help)
                && equalsNullable(this.helpUri, codeScanningAlertRuleSummary.helpUri);
    }
