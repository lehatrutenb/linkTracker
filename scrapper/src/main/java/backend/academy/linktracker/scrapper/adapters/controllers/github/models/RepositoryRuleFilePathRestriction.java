 ...
 */
@Schema(
        name = "repository-rule-file-path-restriction",
        description =
                "Prevent commits that include changes in specified file and folder paths from being pushed to the commit graph. This includes absolute paths that contain file names.")
...
public class RepositoryRuleFilePathRestriction implements OrgRules, RepositoryRule {
     ...
     */
    public RepositoryRuleFilePathRestriction(TypeEnum type) {
        this.type = type;
    }

    public RepositoryRuleFilePathRestriction type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        RepositoryRuleFilePathRestriction repositoryRuleFilePathRestriction = (RepositoryRuleFilePathRestriction) o;
        return Objects.equals(this.type, repositoryRuleFilePathRestriction.type)
                && Objects.equals(this.parameters, repositoryRuleFilePathRestriction.parameters);
    }
    ...
    public String toString() {
        ...
        sb.append("class RepositoryRuleFilePathRestriction {\n");
