...
public class ScrapperLinkUpdatesRepositorySelfManagedImpl implements ScrapperLinkUpdatesRepository {
    ...
    public void addLinkUpdate(EventID eventID, LinkUpdate linkUpdate) {
        var entity = new LinkUpdateEntity(linkUpdate);
        client.sql("INSERT INTO event (id,event_id,event_owner_id_type,url,description) VALUES (:id,:event_id,:event_owner_id_type,:url,:description)")
        ...
        linkUpdate.botChatIDS().forEach(botChatID ->
            client.sql("INSERT INTO link_update_bot_chats_mapping (link_update_id,bot_chat_id) VALUES (:link_update_id,:bot_chat_id")
                .param("link_update_id", entity.getId().toString())
