...
class TgBotWithScrapperIntegrationTest implements WithAssertions {
    @RegisterExtension
    static StatelessApplicationTestExtension tgBot = new StatelessApplicationTestExtension(
        BotApplication.class,
        "--server.port=0"
        );
    @RegisterExtension
    static StatelessApplicationTestExtension scrapper = new StatelessApplicationTestExtension(
    ...
    static void configConnections() {
        scrapper.addProperties("test-config", Map.of("app.telegram.link.tracker.api-path", "http://localhost:" + tgBot.getServerPort()));
        scrapper.refreshScope();

        tgBot.addProperties("test-config", Map.of("app.scrapper.api-path", "http://localhost:" + scrapper.getServerPort()));
        tgBot.refreshScope();
    }
    ...
    void trackSendsInvalidURLReceivesErrReply(String invalidURL) {
        ...
        assertThat(responses)
            .hasSize(3)
            .containsOnlyOnce(TrackMessageHandler._INVALID_URL_REPLY);
    }
    ...
    void trackSendsReceivesReply(String validURL) {
        ...
        assertThat(responses)
            .hasSize(3)
            .containsExactly(TrackMessageHandler._BASIC_TRACK_REPLY,TrackMessageHandler._BASIC_URL_REPLY,TrackMessageHandler._BASIC_TAGS_REPLY);
    }
    ...
    void trackSendsTwiceReceivesErrReply(String validURL) {
        ...
        testUtils.writeMessageToBot("track_command_resieved", "url_resieved", new TelegramBotTestUtils.Message(2, validURL));
        testUtils.writeMessageToBot("url_resieved", "tags_resieved", new TelegramBotTestUtils.Message(3, "-"));
        testUtils.writeMessageToBot("tags_resieved", "track_command_resieved2", new TelegramBotTestUtils.Message(4, "/track"));
        testUtils.writeMessageToBot("track_command_resieved2", "url_resieved2", new TelegramBotTestUtils.Message(5, validURL));
        ...
        assertThat(responses)
            .hasSize(6)
            .containsOnlyOnce(TrackMessageHandler._URL_ALREADY_TRACKED_REPLY);
    }
    ...
    void listSendsReceivesReply() {
        ...
        testUtils.writeMessageToBot(STARTED, "track_command_resieved", new TelegramBotTestUtils.Message(1, "/track"));
        testUtils.writeMessageToBot("track_command_resieved", "url_resieved", new TelegramBotTestUtils.Message(2, url1));
        testUtils.writeMessageToBot("url_resieved", "tags_resieved", new TelegramBotTestUtils.Message(3, "-"));
        testUtils.writeMessageToBot("tags_resieved", "track_command_resieved2", new TelegramBotTestUtils.Message(4, "/track"));
        testUtils.writeMessageToBot("track_command_resieved2", "url_resieved2", new TelegramBotTestUtils.Message(5, url2));
        testUtils.writeMessageToBot("url_resieved2", "tags_resieved2", new TelegramBotTestUtils.Message(6, "-"));
        testUtils.writeMessageToBot("tags_resieved2", "list_command_resieved", new TelegramBotTestUtils.Message(7, "/list"));
    ...
    void listWithTagsSendsReceivesFilteredReply() {
        ...
        testUtils.writeMessageToBot(STARTED, "track_command_resieved", new TelegramBotTestUtils.Message(1, "/track"));
        testUtils.writeMessageToBot("track_command_resieved", "url_resieved", new TelegramBotTestUtils.Message(2, url1));
        testUtils.writeMessageToBot("url_resieved", "tags_resieved", new TelegramBotTestUtils.Message(3, tagStackOverflowToList));
        testUtils.writeMessageToBot("tags_resieved", "track_command_resieved2", new TelegramBotTestUtils.Message(4, "/track"));
        testUtils.writeMessageToBot("track_command_resieved2", "url_resieved2", new TelegramBotTestUtils.Message(5, url2));
        testUtils.writeMessageToBot("url_resieved2", "tags_resieved2", new TelegramBotTestUtils.Message(6, tagGithub));
        testUtils.writeMessageToBot("tags_resieved2", "list_command_resieved", new TelegramBotTestUtils.Message(7, "/list " + tagStackOverflowToList));
        testUtils.repeatLastMessage("list_command_resieved", "list_command_resieved", 8);
        var responses = testUtils.waitAndGetBotResponses(7);
    ...
    void trackSendsReceivesReplyInSenderChat() {
        ...
        stubFor(get(urlMatching(".*/stack-overflow-api/.*/questions/.*/answers.*"))
            .willReturn(
                aResponse().withStatus(200).withHeader("Content-Type", APPLICATION_JSON_VALUE)
    ...
    void trackSendsNotReceivesReplyInNotSenderChat() {
        ...
        testUtils.writeMessageToBot(STARTED, "start_command_resieved", new TelegramBotTestUtils.Message(2, 1, "/start"));
        testUtils.writeMessageToBot("start_command_resieved", "track_command_resieved", new TelegramBotTestUtils.Message(1,2, "/track"));
        testUtils.writeMessageToBot("track_command_resieved", "url_resieved", new TelegramBotTestUtils.Message(1, 3, url));
